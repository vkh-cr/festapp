...
cPS(d,e,f,g,h){var x=null,w=A.jn(A.bX(x,x,x,x,x,x,A.aW(R.Dw,h,x,x),x,x,x,new B.b4Z(e),x,x,x,x,x),d)
return A.a([w,A.jn(A.bX(x,x,x,x,x,x,A.aW(N.j2,g,x,x),x,x,x,new B.b5_(f),x,x,x,x,x),!d)],y.p)},
b4Z:function b4Z(d){this.a=d},
b5_:function b5_(d){this.a=d},
bhH(){var x=A.v_("companions",null)
if(x instanceof A.Po)return x.e
return null},
b9K(d,e,f){return B.dc8(d,e,f)},
dc8(d,e,f){var x=0,w=A.l(y.v)
var $async$b9K=A.h(function(g,h){if(g===1)return A.i(h,w)
while(true)switch(x){case 0:x=2
return A.d(B.PP(d,e,A.bUt(null,null,null,null,null,null,null,f.a,f.b,null,null,null,null,null)),$async$b9K)
case 2:return A.j(null,w)}})
return A.k($async$b9K,w)},
b9L(d,e,f){return B.dc9(d,e,f)},
dc9(d,e,f){var x=0,w=A.l(y.v)
var $async$b9L=A.h(function(g,h){if(g===1)return A.i(h,w)
while(true)switch(x){case 0:x=2
return A.d(A.CW(d,e,A.bUt(null,null,null,null,null,null,null,f.a,f.b,null,null,null,null,null)),$async$b9L)
case 2:return A.j(null,w)}})
return A.k($async$b9L,w)},
b9I(d){return B.dc6(d)},
dc6(d){var x=0,w=A.l(y.v),v,u,t,s
var $async$b9I=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:u=$.cNp()
t=A.dd()
s=$.fM
s=(s==null?null:s.e).c
s.toString
...
PP(d,e,f){return B.dcE(d,e,f)},
dcE(d,e,f){var x=0,w=A.l(y.v),v,u,t,s,r,q,p,o,n,m,l
...
t=y.b
x=3
return A.d($.iP().dm("sign_user_to_event",A.z(["ev",e,"usr",l],u,t),t),$async$PP)
case 3:s=h
t=J.a0(s)
...
BV(d){return this.b5j(d)},
b5j(d){var x=0,w=A.l(y.v),v,u=this,t
...
H3(d){return this.bul(d)},
bul(d){var x=0,w=A.l(y.v),v,u=this,t
...
H4(d){return this.bum(d)},
bum(d){var x=0,w=A.l(y.v),v=this,u
...
x=J.v(t,e)
t=A.a([],y.u)
if(x.afn(u.a.c))t.push(M.Ok)
t.push(O.fz)
t.push(A.bh(A.O(x.b,v,v,v,v,v,v,v,v,v,v,v,v,v),1,v))
if(!x.afn(u.a.c)){w=this.b?new B.c2m(u,x):v
t.push(A.dz(!1,E.bv(D.bJ1,v),v,v,v,v,v,v,w,v,v))}if(x.afn(u.a.c))t.push(A.dz(!1,E.bv(D.adZ,v),v,v,v,v,v,v,new B.c2n(u,x),v,v))
...
x(B.act.prototype,"gb3V","Mm",0)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.anA,A.jh)
x(B.qy,A.J)
x(B.act,A.N)
w(A.cU,[B.c2i,B.c2j,B.c2k,B.c2l,B.c2m,B.c2n,B.c2o,B.c2q,B.b4Z,B.b5_])
x(B.c2p,A.er)})()
A.c7(b.typeUniverse,JSON.parse('{"anA":{"jh":["CH"]},"qy":{"J":[],"e":[]},"act":{"N":["qy"]}}'))
var y={x:A.E("X<~>"),y:A.E("u<n0>"),p:A.E("u<Bf>"),u:A.E("u<e>"),w:A.E("m"),q:A.E("VG"),r:A.E("kl"),b:A.E("@"),v:A.E("~")};(function constants(){D.aiS=new A.ab(0,480,0,1/0)
D.O2=new A.aB(58615,"MaterialIcons",null,!1)
D.bJ1=new A.cw("Sign in someone",null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.bJ9=new A.cw("If you have a child, partner or friend without a phone, you can sign them in as a companion. They will need a festival band to enter the event. Maximal number of companions is {max_companions}.",null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.adZ=new A.cw("Sign out someone",null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.bJE=new A.cw("Create Companion",null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.ae1=new A.cw("Companions",null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_8",e:"endPart",h:b})})($__dart_deferred_initializers__,"cchvk3z2SIqlwyqF1ui/Hy9Kiyg=");