...
this.b=e},
b2S(d,e){return B.d8Z(d,e)},
d8Z(d,e){var x=0,w=A.l(y.b),v,u
var $async$b2S=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:u=y.b
x=3
return A.d($.dC().dn("set_user_password_token",A.z(["token",d,"password",e],y.w,u),u),$async$b2S)
case 3:v=g
x=1
break
case 1:return A.j(v,w)}})
return A.k($async$b2S,w)}},D,E,I,F,K,L,M,N,O,P,Q,R
J=c[1]
A=c[0]
C=c[2]
G=c[215]
...
UC(d){return this.b23(d)},
b23(d){var x=0,w=A.l(y.v),v=this,u,t
...
t=y.F
x=4
return A.d(A.atQ(B.b2S(u,v.e.a.a).aH(new B.co3(v,d),t),new B.co4(d),t,y.E),$async$UC)
...
break
case 5:x=7
return A.d(I.Ov("1+"+u.h(d,"email"),v.a.e.a.a),$async$$1)
case 7:u=v.b
...
while(true)switch(x){case 0:v=u.a.UC(u.b)
x=1
break
case 1:return A.j(v,w)}})
