...
d7K(d,e,f,g){throw A.n(A.aH("Process.runSync"))},
aCE:function aCE(){},
...
bPU:function bPU(){},
doI(d){var w,v=null
try{v=C.ajU.bP1("xdg-user-dir",A.a([d],x.x),E.as)}catch(w){throw w}return D.bak(v.gbR4().od(0,"\n").h(0,0))},
bXJ:function bXJ(){},
Q_(){var w=0,v=A.k(x.w),u,t=2,s=[],r,q,p,o,n,m,l,k,j,i,h
var $async$Q_=A.f(function(d,e){if(d===1){s.push(e)
...
break
case 11:w=14
return A.d(B.ctD(),$async$Q_)
case 14:o=e
j=o==null?null:J.cvD(o)
w=12
break
case 13:w=$.cCQ()?15:17
break
...
o=m==null?null:m.a
w=21
return A.d(A.dG(o,x.w),$async$Q_)
case 21:j=e
...
return A.j($async$Q_,v)},
d3P(d){if(E.e.n(d,"."))return d
else{if(d.length!==0)return"."+d
return""}},
cxs(d,e,f,g,h){var w=0,v=A.k(x.o),u
var $async$cxs=A.f(function(i,j){if(i===1)return A.h(j,v)
while(true)switch(w){case 0:u=A.cN("Either filePath or link or file must be provided")
throw A.n(u)
return A.i(null,v)}})
return A.j($async$cxs,v)},
ctz(){var w=0,v=A.k(x.D),u,t
var $async$ctz=A.f(function(d,e){if(d===1)return A.h(e,v)
while(true)switch(w){case 0:$.cCN()
w=3
return A.d(F.a4d.dE("getApplicationDocumentsDirectory",null,!1,x.v),$async$ctz)
case 3:t=e
if(t==null)throw A.n(D.d5T("Unable to get application documents directory"))
u=D.bak(t)
w=1
break
case 1:return A.i(u,v)}})
return A.j($async$ctz,v)},
ctD(){var w=0,v=A.k(x.i),u,t
var $async$ctD=A.f(function(d,e){if(d===1)return A.h(e,v)
while(true)switch(w){case 0:$.cCN()
if(!F.aiM.gbH4())A.a7(A.aH("Functionality only available on macOS"))
w=3
return A.d(F.a4d.dE("getDownloadsDirectory",null,!1,x.v),$async$ctD)
case 3:t=e
if(t==null){u=null
w=1
break}u=D.bak(t)
...
h=null
d=d
if(f===C.bmE&&j==null)throw A.n(A.cN("customMimeType is required when mimeType is MimeType.custom"))
q=B.d3P(e)
p=i!=null||h!=null
w=!p?3:4
break
...
break
case 5:w=8
return A.d(B.cxs(null,i,h,null,null),$async$AZ)
case 8:w=6
break
case 7:a2=o
case 6:d=a2
...
l=f.d
if(l.length===0){l=j
l.toString}l=new B.bBu(new A.aqe(a0,n,q,l),new B.bw3())
r.c=l
w=17
...
B.bPU.prototype={}
B.bXJ.prototype={
bP1(d,e,f){return B.d7K(d,e,C.ajh,f)}}
var z=a.updateTypes([]);(function inheritance(){var w=a.inherit,v=a.inheritMany
w(B.aCE,A.p4)
v(A.E,[B.aqf,B.bw2,B.bBu,B.bPU,B.bXJ])
w(B.bw3,B.bw2)
w(B.Rk,A.dY)
v(D.axT,[B.bvI,B.bvJ])})()
A.bk(b.typeUniverse,JSON.parse('{"aCE":{"p4":[],"oX":["m","C<l>"]}}'))
var y={a:"Something went wrong, please report the issue https://www.github.com/incrediblezayed/file_saver/issues"}
var x={D:A.A("Hm"),g:A.A("b7"),x:A.A("r<m>"),v:A.A("m"),o:A.A("dv"),i:A.A("Hm?"),w:A.A("m?")};(function constants(){C.ajh=new B.aCE()
C.ajU=new B.bXJ()
C.ev=new A.ap(10,0,10,0)
C.bOU=new B.Rk("Other","application/octet-stream",20,"other")
C.bmE=new B.Rk("Custom","",31,"custom")})();(function lazyInitializers(){var w=a.lazyFinal
w($,"dw9","cUf",()=>{$.Gj()
return!1})
w($,"dwa","cUg",()=>{$.Gj()
return!1})})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_250",e:"endPart",h:b})})($__dart_deferred_initializers__,"gp+471t6fblBihk6Jukz1U0/kCE=");