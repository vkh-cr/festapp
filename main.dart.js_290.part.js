...
default:return"???"}},
cX3(d){return d+";"+B.bq9(d)},
cAO(d,e,f,g,h,i,j,k,l,m){return new B.fV(g,d,m,k,l,f,i,j,e,h)},
cAP(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.f7(v.i(d,x)):null,s=v.i(d,w)!=null?A.f7(v.i(d,w)):null,r=v.i(d,"price")!=null?A.lt(J.ap(v.i(d,"price"))):null,q=v.i(d,"state"),p=v.i(d,"data"),o=v.i(d,"occasion"),n=v.i(d,"payment_info")
return B.cAO(t,v.i(d,"currency_code"),p,u,v.i(d,"note_hidden"),o,n,r,q,s)},
...
_.ax=_.at=_.Q=null},
bqa:function bqa(){},
cDo(d,e,f,g,h,i,j,k){return new B.hl(e,d,j,i,f,g)},
...
x=2
return A.c($.Ai().e1("delete_order",A.y(["order_id",d.a],y.g,v),v),$async$b4E)
case 2:u=f
v=J.a2(u)
...
t=J
x=2
return A.c($.Ai().e1("update_order_note_hidden",A.y(["order_id",d,"new_note_hidden",e],y.g,v),v),$async$b4U)
...
if(!(k==null)){u=A.X(k)
t=u.h("dO<1,t?>")
t=A.H(new A.dO(new A.af(k,new B.aZx(w),u.h("af<1>")),new B.aZy(),t),!0,t.h("w.E"))
v=t}}if(v==null)s=l
else{k=A.X(v)
u=k.h("dO<1,e>")
u=new A.af(new A.dO(new A.af(v,new B.aZz(m),k.h("af<1>")),new B.aZA(m),u),new B.aZB(),u.h("af<w.E>")).cb(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
...
n=A.aO(l.aF8())
m=l.z
return A.lA(A.y(["id",g,"order_symbol",i,"price",h,"state",x,"amount",w,"paid",v,"returned",u,"variable_symbol",r,"deadline",t,"created_at",s,"data",q,"email",p,"ticket_products",o,"note",n,"note_hidden",A.aO(m==null?"":m),"orders_history",A.aO(""),"transactions",A.aO("")],y.g,y.d),!1,y.b)},
...
l=A.aO(l==null?0:l)
x=n.b
x=A.aO(x!=null?A.ii("yyyy-MM-dd",m).dK(x):"")
w=n.d
w=A.aO(w==null?"":w)
v=n.e
if(v==null)v="ordered"
...
p=A.aO(p)
o=n.x
return A.lA(A.y(["id",l,"created_at",x,"ticket_symbol",w,"state",v,"note",u,"note_hidden",t,"order_symbol",q,"data",s,"ticket_products",r,"spot",p,"price",A.aO(o!=null?C.oc(d,o,m,0):"")],y.g,y.d),!1,y.b)},
...
gbo(d){return this.a}}
var z=a.updateTypes(["x(mT)","x(hl)","t?(mT)","x(fV)","e(e)"])
B.aZv.prototype={
...
x(B,"cIy","cX3",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.iD,A.E)
w(A.bC,[B.aZv,B.aZw,B.aZx,B.aZy,B.aZz,B.aZA,B.aZu,B.aZB,B.aZC,B.bqa,B.bEL])
w(A.i5,[B.fV,B.hl])})()
A.bo(b.typeUniverse,JSON.parse('{"fV":{"i5":[]},"hl":{"i5":[]}}'))
var y={g:A.z("e"),d:A.z("fW"),b:A.z("@"),f:A.z("~")};(function lazyInitializers(){var x=a.lazyFinal
x($,"dhe","M2",()=>$.hq().gmT(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_290",e:"endPart",h:b})})($__dart_deferred_initializers__,"7IoZJ6m+hDZW2g+/eLlxWL7Fej0=");