...
cjQ(d){var x=J.a2(d)
return new B.ip(x.i(d,"x"),x.i(d,"y"),x.i(d,"id"),x.i(d,"group"),x.i(d,"order_product_ticket"),x.i(d,"type"),x.i(d,"state"),x.i(d,"title"),null,x.i(d,"product"),null)},
...
default:return"???"}},
cTB(d){return d+";"+B.boN(d)},
cwE(d,e,f,g,h,i,j,k,l,m){return new B.fS(g,d,m,k,l,f,i,j,e,h)},
cwF(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.fG(v.i(d,x)):null,s=v.i(d,w)!=null?A.fG(v.i(d,w)):null,r=v.i(d,"price")!=null?A.nH(J.au(v.i(d,"price"))):null,q=v.i(d,"state"),p=v.i(d,"data"),o=v.i(d,"occasion"),n=v.i(d,"payment_info")
return B.cwE(t,v.i(d,"currency_code"),p,u,v.i(d,"note_hidden"),o,n,r,q,s)},
...
_.ax=_.at=_.Q=null},
boO:function boO(){},
czq(d,e,f,g,h,i,j,k){return new B.hb(e,d,j,i,f,g)},
czr(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.fG(v.i(d,x)):null,s=v.i(d,w)!=null?A.fG(v.i(d,w)):null,r=v.i(d,"ticket_symbol"),q=v.i(d,"state"),p=v.i(d,"occasion")
return B.czq(t,u,v.i(d,"note"),v.i(d,"note_hidden"),p,q,r,s)},
...
bEy:function bEy(){},
b3h(d){var x=0,w=A.l(y.f),v,u
var $async$b3h=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.c($.Ad().e3("delete_order",A.y(["order_id",d.a],y.g,v),v),$async$b3h)
case 2:u=f
v=J.a2(u)
if(!J.m(v.i(u,"code"),200))throw A.f(A.cA("Deleting order failed: "+A.o(v.i(u,"code"))+": "+A.o(v.i(u,"message"))))
return A.j(null,w)}})
return A.k($async$b3h,w)},
b3x(d,e){var x=0,w=A.l(y.f),v,u,t
var $async$b3x=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.c($.Ad().e3("update_order_note_hidden",A.y(["order_id",d,"new_note_hidden",e],y.g,v),v),$async$b3x)
...
t=J
x=2
return A.c($.Lz().e3("update_ticket_note_hidden",A.y(["ticket_id",d,"new_note_hidden",e],y.g,v),v),$async$b3N)
case 2:if(!u.m(t.u(g,"code"),200))throw A.f(A.cA("Saving of note has failed."))
return A.j(null,w)}})
...
x=k==null?l:A.e9(k,new B.aYf(m))}if(x!=null){k=m.as
if(k==null)w=l
else{k=k.as
w=k==null?l:A.e9(k,new B.aYg(x))}if(w!=null){k=m.as
v=l
if(!(k==null)){k=k.ax
if(!(k==null)){u=A.X(k)
t=u.h("dj<1,r?>")
t=A.J(new A.dj(new A.ai(k,new B.aYh(w),u.h("ai<1>")),new B.aYi(),t),!0,t.h("v.E"))
v=t}}if(v==null)s=l
else{k=A.X(v)
u=k.h("dj<1,e>")
u=new A.ai(new A.dj(new A.ai(v,new B.aYj(m),k.h("ai<1>")),new B.aYk(m),u),new B.aYl(),u.h("ai<v.E>")).c5(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:D.b.lQ(k,new B.aYm(x))}k=r==null
q=k?l:r.aEP()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a00()+q:""
...
p=m.at
p=A.aT(p!=null?new A.R(p,new B.boO(),A.X(p).h("R<1,e>")).c5(0," | "):"")
o=A.aT(m.aEP())
n=m.z
return A.li(A.y(["id",i,"order_symbol",k,"price",j,"state",x,"amount",w,"paid",v,"returned",u,"variable_symbol",r,"deadline",t,"data",s,"email",q,"ticket_products",p,"note",o,"note_hidden",A.aT(n==null?"":n),"orders_history",A.aT(""),"transactions",A.aT("")],y.g,y.e),!1,y.b)},
eS(){var x=0,w=A.l(y.f),v=this
var $async$eS=A.h(function(d,e){if(d===1)return A.i(e,w)
while(true)switch(x){case 0:x=2
return A.c(B.b3h(v),$async$eS)
...
s=A.aT(r?s.a00():"")
r=n.z
r=A.aT(r!=null?new A.R(r,new B.bEy(),A.X(r).h("R<1,e>")).c5(0," | "):"")
p=n.y
if(p!=null){o=p.z
o=o==null?m:o.b
if(o==null)o=""
...
p=A.aT(p)
o=n.x
return A.li(A.y(["id",l,"created_at",x,"ticket_symbol",w,"state",v,"note",u,"note_hidden",t,"order_symbol",q,"data",s,"ticket_products",r,"spot",p,"price",A.aT(o!=null?C.o6(d,o,m,0):"")],y.g,y.e),!1,y.b)},
...
x=w==null?null:D.b.lQ(w,new B.aYe(d))}w=x==null?null:x.d
return w==null?"":w},
$S:953}
B.aYe.prototype={
...
x(B,"cwH","cTB",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.ip,A.E)
w(A.bF,[B.aYf,B.aYg,B.aYh,B.aYi,B.aYj,B.aYk,B.aYe,B.aYl,B.aYm,B.boO,B.bEy])
w(A.iP,[B.fS,B.hb])})()
A.bl(b.typeUniverse,JSON.parse('{"fS":{"iP":[]},"hb":{"iP":[]}}'))
var y={e:A.z("fY"),g:A.z("e"),b:A.z("@"),f:A.z("~")};(function lazyInitializers(){var x=a.lazyFinal
x($,"dcW","Lz",()=>$.hl().gmN(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_274",e:"endPart",h:b})})($__dart_deferred_initializers__,"t9CXEYX8nJwrivX9oX1o5fAGh4U=");