...
default:return"???"}},
cML(d){return d+";"+B.bm6(d)},
cq4(d,e,f,g,h,i,j,k,l,m){return new B.h8(g,d,m,k,l,f,i,j,e,h)},
cq5(d){var x="created_at",w="updated_at",v=J.a1(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.ft(v.i(d,x)):null,s=v.i(d,w)!=null?A.ft(v.i(d,w)):null,r=v.i(d,"price")!=null?A.ov(J.as(v.i(d,"price"))):null,q=v.i(d,"state"),p=v.i(d,"data"),o=v.i(d,"occasion"),n=v.i(d,"payment_info")
return B.cq4(t,v.i(d,"currency_code"),p,u,v.i(d,"note_hidden"),o,n,r,q,s)},
...
_.z=m
_.ax=_.Q=null},
cfQ(d){var x="created_at",w="updated_at",v=J.a1(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.ft(v.i(d,x)):null,s=v.i(d,w)!=null?A.ft(v.i(d,w)):null,r=v.i(d,"title"),q=v.i(d,"is_hidden"),p=v.i(d,"description"),o=v.i(d,"price")!=null?A.ov(J.as(v.i(d,"price"))):null
...
_.z=n
_.Q=o},
csM(d,e,f,g,h,i,j,k){return new B.ih(e,d,j,i,f,g)},
csN(d){var x="created_at",w="updated_at",v=J.a1(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.ft(v.i(d,x)):null,s=v.i(d,w)!=null?A.ft(v.i(d,w)):null,r=v.i(d,"ticket_symbol"),q=v.i(d,"state"),p=v.i(d,"occasion")
return B.csM(t,u,v.i(d,"note"),v.i(d,"note_hidden"),p,q,r,s)},
...
bBe:function bBe(){},
b_Q(d){var x=0,w=A.l(y.f),v,u
var $async$b_Q=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.c($.i5().fE("delete_order",A.y(["order_id",d.a],y.g,v),v),$async$b_Q)
case 2:u=f
v=J.a1(u)
...
t=J
x=2
return A.c($.i5().fE("update_ticket_note_hidden",A.y(["ticket_id",d,"new_note_hidden",e],y.g,v),v),$async$b0p)
case 2:if(!u.m(t.t(g,"code"),200))throw A.f(A.cW("Saving of note has failed."))
return A.j(null,w)}})
return A.k($async$b0p,w)},
b0o(d,e){var x=0,w=A.l(y.f),v,u,t
var $async$b0o=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.c($.i5().fE("update_order_note_hidden",A.y(["order_id",d,"new_note_hidden",e],y.g,v),v),$async$b0o)
case 2:if(!u.m(t.t(g,"code"),200))throw A.f(A.cW("Saving of note has failed."))
return A.j(null,w)}})
return A.k($async$b0o,w)}},C
J=c[1]
A=c[0]
D=c[2]
...
x=k==null?l:A.du(k,new B.aW9(m))}if(x!=null){k=m.as
if(k==null)w=l
else{k=k.as
w=k==null?l:A.du(k,new B.aWa(x))}if(w!=null){k=m.as
v=l
if(!(k==null)){k=k.ax
if(!(k==null)){u=A.V(k)
t=u.h("d_<1,r?>")
t=A.H(new A.d_(new A.ag(k,new B.aWb(w),u.h("ag<1>")),new B.aWc(),t),!0,t.h("v.E"))
v=t}}if(v==null)s=l
else{k=A.V(v)
u=k.h("d_<1,e>")
u=new A.ag(new A.d_(new A.ag(v,new B.aWd(m),k.h("ag<1>")),new B.aWe(m),u),new B.aWf(),u.h("ag<v.E>")).bZ(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:D.b.kz(k,new B.aWg(x))}k=r==null
q=k?l:r.aD1()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a_2()+q:""
...
q=A.bi(o.aD1())
p=o.z
return A.mn(A.y(["id",k,"order_symbol",m,"price",l,"state",x,"amount",w,"paid",v,"returned",u,"variable_symbol",r,"deadline",t,"data",s,"note",q,"note_hidden",A.bi(p==null?"":p),"orders_history",A.bi("")],y.g,y.e),!1,y.b)},
fg(){var x=0,w=A.l(y.f),v=this
var $async$fg=A.h(function(d,e){if(d===1)return A.i(e,w)
while(true)switch(x){case 0:x=2
return A.c(B.b_Q(v),$async$fg)
...
s=A.bi(r?s.a_2():"")
r=n.z
r=A.bi(r!=null?new A.O(r,new B.bBe(),A.V(r).h("O<1,e>")).bZ(0," | "):"")
p=n.y
if(p!=null){o=p.z
o=o==null?null:o.b
if(o==null)o=""
...
p=A.bi(p)
o=n.x
return A.mn(A.y(["id",m,"created_at",x,"ticket_symbol",w,"state",v,"note",u,"note_hidden",t,"order_symbol",q,"data",s,"ticket_products",r,"spot",p,"price",A.bi(o!=null?C.Dv(d,o):"")],y.g,y.e),!1,y.b)},
...
x=w==null?null:D.b.kz(w,new B.aW8(d))}w=x==null?null:x.d
return w==null?"":w},
$S:924}
B.aW8.prototype={
...
x(B,"cq7","cML",6)})();(function inheritance(){var x=a.inheritMany
x(A.B,[B.iq,B.iX])
x(A.bH,[B.aW9,B.aWa,B.aWb,B.aWc,B.aWd,B.aWe,B.aW8,B.aWf,B.aWg,B.bBe])
x(A.iw,[B.h8,B.ih])})()
A.br(b.typeUniverse,JSON.parse('{"h8":{"iw":[]},"ih":{"iw":[]}}'))
var y={e:A.w("fO"),g:A.w("e"),b:A.w("@"),f:A.w("~")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_206",e:"endPart",h:b})})($__dart_deferred_initializers__,"JWwc8cB26MW7n/DGzd2wbzDOdmI=");