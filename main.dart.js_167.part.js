...
break}r=s
o=J.b39(r,y.y)
o=A.lC(o,new B.bgG(),o.$ti.i("x.E"),y.b)
n=A.A(o,A.t(o).i("x.E"))
q=n
v=q
x=1
...
l=t.pop()
p=A.ah(l)
A.cI("Failed to fetch available platforms: "+A.o(p))
o=A.cJ("Failed to fetch available platforms: "+A.o(p))
throw A.p(o)
x=6
break
case 3:x=2
...
R=c[141]
B.EM.prototype={
K(){var x=A.a([],y.B),w=$.a8()
return new B.agp(x,new A.bQ(C.ah,w),A.a([new A.Ag(w),new A.Ag(w),new A.Ag(w)],y.z))}}
B.agp.prototype={
b_(){var x=this
x.c3()
if(!x.w){x.w=!0
...
o=u.pop()
r=A.ah(o)
A.cI("Failed to load platforms: "+A.o(r))
p=t.c
if(p!=null)A.bi(p,A.n("Failed to load installation options.",null,null),C.aQ)
x=5
break
case 2:x=1
break
...
v=y.w
v=A.n("Install {title} to get notifications, offline functionality, and a quick launch icon.",s,A.w(["title","Festapp"],v,v))
u=y.u
u=A.a([A.bj(A.ad(A.a([w,D.bEd,A.aX(E.bR(A.E(v,s,s,s,s,s,s,s,A.ab(s,s,A.B(d).ax.a===C.q?$.dz():C.p,s,s,s,s,s,s,s,s,16,s,s,s,s,s,!0,s,s,s,s,s,s,s,s),s,s,s,s,s),s),1,s)],u),C.i,s,C.bg,C.h,0,s),s,s),L.o0],u)
if(q!=null&&q.length!==0)u.push(t.aEg(d,A.n("Install for Apple",s,s),D.aAY,q,0))
w=A.n("Install for Android",s,s)
u.push(t.aEh(d,w,D.az7,x,1,x==null||x.length===0?A.n("Open this website on your Android phone in a browser like Chrome or Edge and hit the Install Now button.",s,s):s))
u.push(t.aEg(d,A.n("Install for PC/Mac",s,s),D.azi,s,2))
w=new A.cs(C.aV,s,s,new A.W(K.O5,new A.cD(new A.ac(0,720,0,1/0),A.a9(u,C.i,C.f,C.h,0,s,C.l),s),s),s)}return O.eO(r,s,w,s,s,s,s)},
aEh(d,e,f,g,h,i){var x,w,v,u,t,s,r=this,q=null,p=g!=null&&g.length!==0,o=r.Q[h],n=r.x,m=!0
if(!(n==="ios"&&h===0))if(!(n==="android"&&h===1))n=n==="web"&&h===2
else n=m
else n=m
m=y.u
x=A.ad(A.a([A.aB(f,q,q,24),C.h0,A.E(e,q,q,q,q,q,q,q,C.cc,q,q,q,q,q)],m),C.i,q,C.f,C.h,0,q)
w=A.a([],m)
...
D.auV=new A.J9(D.ai7,null,C.ot,C.Q,C.el)
D.az7=new A.at(57477,"MaterialIcons",null,!1)
D.azi=new A.at(57795,"MaterialIcons",null,!1)
D.aAY=new A.at(984254,"MaterialIcons",null,!1)
D.bEd=new A.ao(22,null,null,null)
