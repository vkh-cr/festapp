...
rg -q 'CSM Fixture' "$TMP_ROOT/csmostrava2026/web/delete-account/index.html"
rg -q 'fixturecsm.supabase.co/functions/v1/confirm-account-deletion' "$TMP_ROOT/csmostrava2026/web/delete-account/index.html"
rg -q 'HM Fixture' "$TMP_ROOT/hvezdamorska/web/delete-account/index.html"
rg -q 'fixturehm.supabase.co/functions/v1/confirm-account-deletion' "$TMP_ROOT/hvezdamorska/web/delete-account/index.html"
! rg -q 'fixturecsm|csmostrava2026|fixture_csm|CSM Fixture' "$TMP_ROOT/hvezdamorska/lib/app_config.dart" "$TMP_ROOT/hvezdamorska/web_client/src/app_config.js" "$TMP_ROOT/hvezdamorska/web/index.html" "$TMP_ROOT/hvezdamorska/web/delete-account/index.html"
! rg -q 'fixturehm|fixture_hm|HM Fixture' "$TMP_ROOT/csmostrava2026/lib/app_config.dart" "$TMP_ROOT/csmostrava2026/web_client/src/app_config.js" "$TMP_ROOT/csmostrava2026/web/index.html" "$TMP_ROOT/csmostrava2026/web/delete-account/index.html"
