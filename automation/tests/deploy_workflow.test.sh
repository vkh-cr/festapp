...
if grep -F -q 'cavfotofest|csmostrava2026|doobiscup|festapp|festapptickets|festivalslunovrat|hvezdamorska' \
...
for tenant in cavfotofest doobiscup festapptickets hvezdamorska; do
