...
this.b=e},
djj(d){return A.cTH(d)},
I3(d){return B.dcl(d)},
dcl(d){var x=0,w=A.l(y.H),v,u,t,s,r,q,p,o,n,m,l
...
l.toString
x=2
return A.d(m.dc("occasion",l).bQ7(0,"created_at").aHf(1).QY(),$async$I3)
case 2:u=f
x=u!=null?3:5
break
case 3:x=6
return A.d(n.c1("user_news").ir(0,"user").dc("news_id",v),$async$I3)
case 6:t=f
s=A.a([],y.t)
...
x=7
return A.d(n.c1("user_news").aL5(s),$async$I3)
case 7:x=4
break
case 5:x=8
return A.d(n.c1("user_news").j_(0).dc("news_id",v),$async$I3)
case 8:case 4:x=9
return A.d(n.c1("news").j_(0).dc("id",v),$async$I3)
case 9:return A.j(null,w)}})
return A.k($async$I3,w)},
bbg(d){return B.dco(d)},
dco(d){var x=0,w=A.l(y.H),v
var $async$bbg=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.z
x=2
return A.d($.C3().c1("news").eT(0,A.z(["message",d.b],v,v)).dc("id",d.d),$async$bbg)
case 2:return A.j(null,w)}})
return A.k($async$bbg,w)},
aqX(d,e,f,g,h,i,j){return B.dcm(d,e,f,g,h,i,j)},
dcm(d,e,f,g,h,i,j){var x=0,w=A.l(y.z),v,u,t,s,r,q,p,o
...
aqY(d){return B.dcn(d)},
dcn(d){var x=0,w=A.l(y.H),v,u,t,s
...
while(true)switch(x){case 0:u=B
x=2
return A.d(X.lA("newsOffline",B.dDf(),y.x),$async$of)
...
x=J.eM(this.d)?new A.a2(O.MO,A.ah(A.a([A.aW(D.ayV,A.C(d).ay,v,64),C.a2,A.P(A.Yk("No news messages yet",v,v,v,v),v,v,v,v,v,v,v,v,C.b0,v,v,v,v)],y.p),C.j,C.bl,C.i,0,v,C.m),v):new A2.EI(new B.chX(this),v)
w=A.j_()
return Z.fa(t,u,new A.cq(C.aX,v,v,new A.cE(new A.ab(0,720,0,1/0),x,v),v),v,v,A.jm(U.a1F(S.hn,V.qO,new B.chY(this,d),v),w),v,v)}}
B.wR.prototype={
I(){return"ContextMenuChoice."+this.b}}
var z=a.updateTypes(["X<~>(wR)","B<mQ<wR>>(H)","vn(A<m,@>)"])
B.chZ.prototype={
...
t=u.c
t.toString
if(G.aFj(t,!1).f.gaAc()===C.b.dt($.all(),"news")){u.M2()
...
if(w!==0)v.push(C.hh)
v.push(new A.eO(new B.chW(x,w,d,e),null))
...
B.chU.prototype={
$1(d){var x=y.B
return A.a([F.nK(E.bw(W.Ii,null),!0,48,D.asI,x),F.nK(E.bw(D.bIX,null),!0,48,D.M_,x)],y.h)},
$S:z+1}
B.chY.prototype={
$0(){return this.a.btQ(this.b)},
$S:0};(function installTearOffs(){var x=a._static_1
x(B,"dDf","djj",2)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.Eo,A.J)
x(B.aQH,A.O)
w(A.cL,[B.chZ,B.ci_,B.ci0,B.chY])
w(A.c8,[B.chS,B.chW,B.chV,B.chT,B.chU])
x(B.chX,A.eg)
x(B.wR,A.eT)})()
A.c5(b.typeUniverse,JSON.parse('{"Eo":{"J":[],"e":[]},"aQH":{"O":["Eo"]}}'))
var y=(function rtii(){var x=A.D
return{B:x("wR"),_:x("X<@>"),t:x("u<A<m,@>>"),o:x("u<vn>"),h:x("u<mQ<wR>>"),p:x("u<e>"),a:x("A<m,@>"),x:x("vn"),P:x("aF"),K:x("G"),N:x("m"),g:x("ki"),z:x("@"),X:x("G?"),H:x("~")}})();(function constants(){D.M_=new B.wR(0,"delete")
D.asI=new B.wR(1,"edit")
D.avr=new A.am(16,8,16,0)
D.ays=new A.aB(58652,"MaterialIcons",null,!1)
D.ayV=new A.aB(61075,"MaterialIcons",null,!1)
D.azx=new A.d2(T.NX,null,null,null,null)
D.bIX=new A.cs("Delete",null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_332",e:"endPart",h:b})})($__dart_deferred_initializers__,"Fq0tSDGZsx/PeQ3wq1s6pw+po7k=");