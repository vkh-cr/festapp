...
dkR(d,e){var x,w,v,u,t,s,r,q
for(x=y.t,w=1;w<40;++w){v=C.cUy(w,d)
u=new C.a6v(A.a([],x))
for(t=v.length,s=0,r=0;r<t;++r)s+=v[r].b
for(r=0;r<1;++r){q=e[r]
u.qQ(0,4,4)
u.qQ(0,q.b.length,C.d__(4,w))
q.jq(0,u)}if(u.b<=s*8)break}return w},
cZj(d,e,f){var x,w,v,u,t,s,r,q=C.cUy(d,e),p=new C.a6v(A.a([],y.t))
for(x=0;x<f.length;++x){w=f[x]
p.qQ(0,4,4)
p.qQ(0,w.b.length,C.d__(4,d))
w.jq(0,p)}for(v=q.length,u=0,x=0;x<v;++x)u+=q[x].b
t=u*8
v=p.b
if(v>t)throw A.n(new C.a3j("Input too long. "+v+" > "+t))
if(v+4<=t)p.qQ(0,0,4)
for(;D.c.au(p.b,8)!==0;)p.aJl(!1)
for(s=0;!0;s=r){if(p.b>=t)break
r=s+1
p.qQ(0,(s&1)===0?236:17,8)}return C.dv7(p,q)},
dv7(d,e){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h=y.T,g=A.bU(e.length,null,!1,h),f=A.bU(e.length,null,!1,h)
...
dvF(d){var x,w=y.t,v=C.aBo(A.a([1],w),0)
...
dwY(d){var x,w,v,u,t,s,r,q,p,o,n,m,l,k=d.a
...
_.d=g
_.e=h},
cUy(d,e){var x,w,v,u,t,s,r=C.dwf(d,e),q=r.length/3|0,p=A.a([],y.x)
for(x=0;x<q;++x){w=x*3
v=r[w]
u=r[w+1]
t=r[w+2]
...
aBm:function aBm(){},
aBl:function aBl(){},
dkT(d,e,f){var x,w,v,u,t,s=A.bM("qrCode")
try{if(f!==-1){s.si9(C.cUw(f,e))
v=s.aG()
u=D.bK.ci(d)
v.e.push(new C.Ta(u))
v.d=null}else{v=C.cUw(C.dkR(e,A.a([new C.Ta(D.bK.ci(d))],y.v)),e)
v.e.push(new C.Ta(D.bK.ci(d)))
v.d=null
s.si9(v)}v=s.aG()
return new C.a6y(B.GG,v,null)}catch(t){v=A.ai(t)
if(v instanceof C.a3j){x=v
return new C.a6y(B.bxz,null,x)}else if(y.L.b(v)){w=v
return new C.a6y(B.bxA,null,w)}else throw t}},
...
_.c=_.a=null},
aTW:function aTW(){},
d0v(d){return d>=1?$.b0_()[d]:A.a7(A.cd("glog("+d+")",null))},
dv8(){var x,w=new Uint8Array(256)
...
return w},
dyY(d){var x,w=d<<10>>>0
for(x=w;C.NT(x)-C.NT(1335)>=0;)x=(x^D.c.f4(1335,C.NT(x)-C.NT(1335)))>>>0
return((w|x)^21522)>>>0},
dyZ(d){var x,w=d<<12>>>0
for(x=w;C.NT(x)-C.NT(7973)>=0;)x=(x^D.c.f4(7973,C.NT(x)-C.NT(7973)))>>>0
return(w|x)>>>0},
NT(d){var x
for(x=0;d!==0;){++x
...
x=A.a([B.ad1],p)
if(A.fm("entry_code",r))x.push(A.ar(r,S.b4R(d,T.NZ,A.r("Show my code",r),new C.czj(s,d)),D.k,r,r,r,r,r,r,r,R.CB,r,r,r))
...
x.push(A.ar(r,A8.mb(!0,!0,!0,r,D.v,r,D.r,new C.czk(s),w+1,r,r,r,A9.dQ,r,r,!1,D.I,!0),D.k,r,r,new A.b4(r,r,new A.eN(D.y,D.y,new A.bb(D.cA,1,D.B,-1),D.y),r,r,r,r,D.L),r,r,r,r,R.CB,r,r,r))}x.push(B.ad1)
w=A.r("Name",r)
v=s.d
u=r
if(v==null)v=u
...
v.toString
v=A1.tg(A.at(A.a([Ae.Oe,U.fy,A.P(v,r,r,r,r,r,r,r,L.nE,r,r,r,r,r),U.fy],p),D.j,D.f,D.i,0,r),r)}x.push(new A.a2(H.bk,A.ah(A.a([w,Ag.dt,A.ar(D.cZ,A.dl(!1,v,r,r,r,r,r,r,t,r,r),D.k,r,r,r,r,r,r,r,r,r,r,r)],p),D.bh,D.f,D.i,0,r,D.m),r))}x.push(D.a2)
p=A.j_()||A.iN()||P.bFn()||A.mV()
...
return new A.a2(H.bk,A.fB(!0,D.aR,!1,x,!0,D.v,x,A.fS(),x,x,x,x,x,x,2,A.ch(x,x,x,B.av0,x,x,x,x,!0,x,x,x,x,x,x,x,x,x,D.Dj,x,x,x,x,x,x,x,x,x,x,x,B.bFT,e,x,x,x,x,x,x,x,x,d,!0,!0,x,x,x,x,x,x,x,x,x,x,x,x,x),D.r,!0,x,!0,x,!1,new C.alW(!1,!0,!0,!0,x,x,w,v),D.aL,x,x,x,x,x,x,x,1,x,x,!1,"\u2022",x,x,x,x,x,!1,x,x,!0,x,!0,x,D.b2,x,x,D.aO,D.aM,x,x,x,x,x,x,x,!0,D.H,x,D.b4,x,x,x,x),x)},
Nf(){var x=0,w=A.l(y.H),v=this,u,t
var $async$Nf=A.h(function(d,e){if(d===1)return A.i(e,w)
while(true)switch(x){case 0:x=2
return A.d(Ac.a0e(),$async$Nf)
...
case 2:u=e
x=3
return A.d(A.a5q("user_info",u),$async$aZ)
case 3:x=4
...
while(true)switch(x){case 0:x=2
return A.d(A.xD("user_info",A.al9(),null,y.U),$async$jE)
case 2:u=e
v.Ow(u)
v.A(new C.czq(v,u))
return A.j(null,w)}})
...
return w==null?x.d=C.cZj(x.a,x.b,x.e):w}}
C.aBn.prototype={
...
u[t]=(t&1)===0}},
bts(d,e){var x,w,v,u,t,s,r=C.dyY((this.c<<3|d)>>>0)
...
btt(d){var x,w,v,u,t,s=C.dyZ(this.b)
...
this.a.toString
x=u.a
w=new C.a6x(x,u.b,!0,d,v,B.als,B.alr,u,new C.bAd(A.a([],y.q),A.I(y.N,y.Z)),v,v)
w.z=x
w.bhC()
this.a.toString
return new C.afQ(e,D.C,D.m7,A.i3(v,v,!1,v,w,D.a_),"qr code",v)},
b6Y(d,e,f){var x,w=null,v=this.a
v.toString
x=A.ar(w,w,D.k,w,w,w,w,w,w,w,w,w,w,w)
return new C.afQ(v.x,D.C,D.m7,x,"qr code",w)}}
C.afQ.prototype={
...
t.m(0,B.ab1.j(0)+":"+s,w)
s=u.I()
t.m(0,B.ab2.j(0)+":"+s,new A.nk(D.cH,D.c2,D.eG,D.f6,D.dF))}},
...
i===$&&A.b()
i=J.b8(i.a.height())
x.zX(w,D.N.Qm(new A.U(o,i),new A.a4(0,0,o,i)),D.N.Qm(a3,new A.a4(s,p,s+t,p+q)),e)}},
...
C.bGZ.prototype={
bBY(d){return A.hq(D.Mr,new C.bH0(this,null),y.K)},
bBZ(d,e){var x={}
x.a=e
...
return V.fa(W.iE(A.a([new A.a2(D.el,A.bW(w,w,w,w,w,w,A.aW(B.axU,D.p,w,w),w,w,w,new C.cz7(u,t),w,w,w,w,w),w)],s),w,w,!0,D.C,w,1,w,w,0,!1,w,!1,w,w,v,w,!0,w,w,w,w,w,w,w,w,w,1,w,!0),D.l,A.bG(new C.a7P(A.ar(w,A.ah(A.a([G.eb,A.P("["+x.c+"]",w,w,w,w,w,w,w,B.adO,w,w,w,w,w),G.eb,new C.a6w(x.d,-1,250,w),G.eb,A.P("["+t+"]",w,w,w,w,w,w,w,B.adO,w,w,w,w,w),G.eb],s),D.j,D.bl,D.U,0,w,D.m),D.k,D.l,w,w,w,w,w,w,w,w,w,w),u,w),w,w),w,w,w,w,w)},
$S:1223}
C.cz6.prototype={
...
if(t==null){x=1
break}x=4
return A.d(new N.asw().Be(t,"png",B.bqA,u.b),$async$$0)
...
s=S.b4R(d,T.NZ,A.r("Show Code",o),new C.cze(x,d,v))
q=Ad.bQ6(v.e,d)
p=y.p
return new A.a2(A6.eQ,A.ah(A.a([A4.iB,A.ar(o,A.Db(A.a([B.bCM,new A.cE(B.aiS,Z.cJc(A.bG(E.bw(A.P("Companion's events will appear here.",o,o,o,o,o,o,o,A.al(o,o,A.y1(d),o,o,o,o,o,o,o,o,o,o,o,o,o,o,!0,o,o,o,o,o,o,o,o),o,o,o,o,o),o),o,o),q,0.3,o,new C.czf(x,d),o,o),o),A3.ad4,A.ah(A.a([A.dl(!1,E.bw(A.P("Delete companion",o,o,o,o,o,o,o,o,o,o,o,o,o),o),o,o,o,o,o,o,new C.czg(x,d,v),o,o)],p),D.j,D.bl,D.i,0,o,D.m)],p),o,D.j,!1,o,D.qI,r,t,s),D.k,o,o,new A.b4(w,o,o,u,o,o,o,D.L),o,o,o,o,o,o,o,o)],p),D.j,D.f,D.i,0,o,D.m),o)},
$S:50}
C.cze.prototype={
$0(){var x=this.c
...
t.toString
x=5
return A.d(A0.amG(J.v(t,"email")).aH(new C.czd(u,s),y.P),$async$$0)
...
v(A.eg,[C.czk,C.cmn])
u(C.alW,A.fO)
v(A.G,[C.aSa,C.Ta,C.a3j,C.bCl,C.bCi,C.aBn,C.aBp,C.bAd,C.cko,C.aBm,C.aBl,C.a6y,C.bGZ])
u(C.a6v,C.aSa)
u(C.afQ,A.ac)
u(C.a6x,A.rZ)
v(A.eT,[C.KW,C.QC,C.bCk,C.bCj,C.a6z])
u(C.aDk,C.aTW)
x(C.aSa,A.a3)
w(C.aTW,A.er)})()
A.c5(b.typeUniverse,JSON.parse('{"Gi":{"J":[],"e":[]},"aXt":{"O":["Gi"]},"alW":{"fO":[],"ay":[]},"a6v":{"a3":["x"],"B":["x"],"b_":["x"],"y":["x"],"a3.E":"x","y.E":"x"},"Ta":{"cUx":[]},"a3j":{"bc":[]},"a6w":{"J":[],"e":[]},"aSb":{"O":["a6w"]},"afQ":{"ac":[],"e":[]},"a6x":{"ay":[]},"a7P":{"J":[],"e":[]},"aDk":{"O":["a7P"]}}'))
var y=(function rtii(){var x=A.D
return{l:x("dv"),L:x("bc"),I:x("X<eH?>"),J:x("u<fO>"),S:x("u<B<f>>"),Q:x("u<B<x?>>"),q:x("u<Kf>"),v:x("u<cUx>"),x:x("u<aBp>"),p:x("u<e>"),t:x("u<f>"),z:x("aS<O<J>>"),w:x("hs"),P:x("aF"),o:x("tw"),Z:x("Kf"),A:x("a78"),N:x("m"),U:x("es"),B:x("@"),b:x("eH?"),n:x("a2L?"),T:x("B<f>?"),X:x("G?"),K:x("dL?"),u:x("x?"),H:x("~")}})();(function constants(){var x=a.makeConstList
...
B.aBz=A.a(x([B.Dh,B.No,B.Di]),A.D("u<QC>"))
...
B.aIs=A.a(x([D.Ug,B.aEu,B.aEv,B.aEy,B.aEF,B.aEL,B.aEw,B.aEx,B.aEz,B.aED,B.aEG,B.aEK,B.aEM,B.aEA,B.aEB,B.aEC,B.aEH,B.aEI,B.aEJ,B.aEN,B.aEa,B.aKH,B.aNI,B.aIo,B.aLu,B.aHm,B.aGF,B.aQt,B.aMl,B.aPm,B.aL_,B.aQ3,B.aFt,B.aP3,B.aKX,B.aLL,B.aJc,B.aLi,B.aBC,B.aHn]),y.S)
...
B.ab0=new C.KW(0,"finderPatternOuter")
B.ab1=new C.KW(1,"finderPatternInner")
B.ab2=new C.KW(2,"finderPatternDot")
B.z4=new C.KW(3,"codePixel")
B.bxw=new C.KW(4,"codePixelEmpty")
B.GG=new C.a6z(0,"valid")
B.bxz=new C.a6z(1,"contentTooLong")
B.bxA=new C.a6z(2,"error")
...
x($,"dNy","b_V",()=>C.dv8())})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_325",e:"endPart",h:b})})($__dart_deferred_initializers__,"D6+xFjb6X4jCaT4HX4sIo1+Fwss=");