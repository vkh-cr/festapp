...
case 3:return C.aPN
case 4:return D.ZR}},
bZf(d,e){var x=0,w=A.l(y.a),v,u
var $async$bZf=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:if(e===C.ak1||e===C.ak2)u=!(d.gi4()==="https"||d.gi4()==="http")
else u=!1
if(u)throw A.d(A.es(d,"url","To use an in-app web view, you must provide an http(s) URL."))
v=$.c6b().Mq(d.k(0),new A.all(B.cKv(e),new A.akv(!0,!0,D.eL),null))
x=1
break
...
while(true)switch(x){case 0:v=$.c6b().ars(d.k(0))
x=1
break
case 1:return A.j(v,w)}})
...
C.b6X=new B.aQX()
C.b7b=new B.bxb()
C.ak0=new B.M2(0,"platformDefault")
C.ak1=new B.M2(1,"inAppWebView")
C.ak2=new B.M2(2,"inAppBrowserView")
C.ak3=new B.M2(3,"externalApplication")
C.aPN=new A.Gc(3,"externalApplication")})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_127",e:"endPart",h:b})})($__dart_deferred_initializers__,"vNiUnn2/wJeZ2VeyoJ2a8BukAHs=");