...
CREATE TABLE public.occasions_hidden (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  secret TEXT NULL,
...
CREATE TABLE eshop.bank_accounts (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
...
CREATE TABLE public.occasions (
  ...
  CONSTRAINT places_organization_fkey FOREIGN KEY (organization) REFERENCES public.organizations (id)
) TABLESPACE pg_default;
...
CREATE TABLE public.information_hidden (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  data JSONB NULL,
  occasion BIGINT NOT NULL DEFAULT '1'::bigint,
...
CREATE TABLE eshop.payment_info (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
...
CREATE TABLE eshop.bank_account_requests (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
...
CREATE TABLE eshop.unit_bank_accounts (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
...
CREATE TABLE eshop.bank_account_users (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  bank_account BIGINT NOT NULL,
  "user" UUID NOT NULL,
...
CREATE TABLE eshop.planned_changes (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE eshop.product_types (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  title TEXT NULL,
...
CREATE TABLE eshop.order_product_ticket (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  "order" BIGINT NULL,
  product BIGINT NULL,
...
CREATE TABLE public.email_templates (
  ...
  CONSTRAINT email_templates_organization_fkey FOREIGN KEY (organization) REFERENCES public.organizations (id),
  CONSTRAINT public_email_templates_occasion_fkey FOREIGN KEY (occasion) REFERENCES public.occasions (id)
) TABLESPACE pg_default;
...
CREATE TABLE public.log_app_config (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  organization BIGINT NOT NULL,
...
CREATE TABLE public.event_users_saved (
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
...
CREATE TABLE public.occasion_users (
  occasion BIGINT NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  "user" UUID NOT NULL,
