import{T as a,L as n,A as c}from"./index-C4Zvh7uT.js";class h{constructor(e){this.container=e,this.element=document.createElement("div"),this.element.className="settings-widget",this.render(),this.container.appendChild(this.element)}render(){this.element.innerHTML="",this.element.style.cssText=`
            display: flex;
