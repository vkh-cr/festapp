import{AuthService as c}from"./auth_service-Br-4UwHv.js";import{R as g,e as f,C as s,A as u}from"./index-4K3q8Xpu.js";import{ToastHelper as h}from"./toast-C66ajYTo.js";class p extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){const e=`
            :host {
                position: fixed;
                top: 0;
                left: 0;
