import"./index-DbFwXZiH.js";import{P as r}from"./public_order_strings-0E9VaVZd.js";class x{static render(l,u,e,a,d){const n=a.communicationTone,b=a.visibleFields.some(o=>o.type==="ticket");let t,i,s="check_circle",c="success-color";if(u)t=r.successTitle(n,b),i=r.paymentInfo(n);else if(e&&e.code===1017){const o=e.product&&e.product.title||"";t=r.productUnavailable(o),i=r.chooseDifferentVariant(n),s="error",c="error-color"}else{const o=e&&e.code||0;t=r.orderFailed,i=r.orderError(o),s="error",c="error-color"}l.innerHTML=`
        ...
        `;const p=l.querySelector(".btn-back-to-form");p&&(p.onclick=()=>{d&&d()})}}export{x as OrderResult};
