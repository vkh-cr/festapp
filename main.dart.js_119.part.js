...
x=3
return A.d($.dL().dn("set_user_password_token",A.z(["token",d,"password",e],y.w,u),u),$async$b33)
case 3:v=g
x=1
break
case 1:return A.j(v,w)}})
return A.k($async$b33,w)}},D,E,G,F,H,I,K,L,M,N,O,P,Q,R
J=c[1]
A=c[0]
C=c[2]
...
R=c[202]
B.Fc.prototype={
M(){return new B.aTu(new A.aS(null,y.o),new A.co(C.aw,$.a9()))}}
B.aTu.prototype={
l(){this.ai()},
...
s=A.ub()
u=A.bB("token=(?<token>[^&]+)",!0,!1,!1).rU(s.j(0))
if(u!=null)try{r=u.ag2("token")
r.toString
v.f=r}catch(p){r=A.ai(p)
if(y.g.b(r)){t=r
r=v.c
r.toString
A.bJ(r,J.ar(t),C.ad)}else throw p}return A.j(null,w)}})
...
t=y.F
x=4
return A.d(A.atO(B.b33(u,v.e.a.a).aI(new B.coR(v,d),t),new B.coS(d),t,y.E),$async$UK)
case 4:case 3:return A.j(null,w)}})
return A.k($async$UK,w)},
B(d){var x=null,w=L.bw(D.bJi,x),v=y.w
return P.f9(Q.iE(x,x,x,!0,x,x,1,!0,x,x,!1,x,!1,x,x,I.uD(x,new B.coT(d)),x,!0,x,x,x,x,x,w,x,x,x,1,x,!0),x,new A.cl(C.N,x,x,new A.cF(new A.aa(0,720,0,1/0),A.dE(A.v7(x,x,new E.yO(A.af(A.a([A.O(A.q("Welcome in {name}!",A.z(["name","Festapp"],v,v)),x,x,x,x,x,x,x,M.Ij,x,x,x,x,x),C.a1,A.O(A.q("Create a new password to continue.",x),x,x,x,x,x,x,x,R.hZ,x,x,x,x,x),N.ad9,new A.a0(O.CI,new K.Km(A.q("New Password",x),this.e,"newPassword",x),x),C.a1,H.HI(C.dl,d,50,!0,A.q("Change Password",x),new B.coU(this,d),C.m,250)],y.u),C.j,C.f,C.i,0,x,C.l),x),this.d,x),x,C.t,x,x,x,C.I),x),x),x,x,x,x,x)}}
var z=a.updateTypes([])
B.coR.prototype={
...
break
case 2:A.bJ(v.b,A.q("Token is not valid.",null),C.bb)
x=3
break
case 4:x=J.p(u.h(d,"code"),200)?5:6
break
case 5:x=7
return A.d(G.Oy("1+"+u.h(d,"email"),v.a.e.a.a),$async$$1)
case 7:u=v.b
A.bJ(u,A.q("Password has been changed.",null),C.ad)
F.aCV(u)
case 6:case 3:return A.j(null,w)}})
return A.k($async$$1,w)},
$S:84}
B.coS.prototype={
$2(d,e){A.bJ(this.a,J.ar(d),C.ad)},
$S:458}
B.coT.prototype={
...
while(true)switch(x){case 0:v=u.a.UK(u.b)
x=1
break
case 1:return A.j(v,w)}})
