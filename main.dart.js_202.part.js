...
if(s.gdt().d==null)A.Y(A.d1("User must be logged in."))
r=A
x=3
return A.c(s.bY("user_info").hV(0).cE("id",s.gdt().c.a).kP(0),$async$SS)
case 3:s=r.Cp(e)
$.kR=s
r=s
x=4
return A.c(A.UB(),$async$SS)
case 4:r.Q=e
s=$.kR.Q
s.toString
u=A.eZ(s,new B.aRA())
