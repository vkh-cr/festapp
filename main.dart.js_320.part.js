...
VP(){var x=0,w=A.l(y.d),v,u,t,s,r
...
r=A
x=3
return A.c(s.bX("user_info").iC(0).cn("id",s.gdH().c.a).lm(0),$async$VP)
case 3:s=r.zq(e)
$.mo=s
r=s
x=4
return A.c(A.XG(),$async$VP)
case 4:r.Q=e
s=$.mo.Q
s.toString
u=A.e9(s,new B.aX1())
...
var y={d:A.z("ea")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_320",e:"endPart",h:b})})($__dart_deferred_initializers__,"bSgMZVBHonQD8LHrTOflS+ZXLKk=");