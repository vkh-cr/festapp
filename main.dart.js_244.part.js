...
default:return"???"}},
dry(d){return d+";"+B.aAM(d)},
d08(d,e,f,g,h,i,j,k,l,m,n){return new B.hE(h,d,n,l,m,f,j,k,g,e,i)},
bCq(d){var x=null,w="created_at",v="updated_at",u="data",t=J.a1(d),s=t.h(d,"id"),r=t.h(d,w)!=null?A.ea(t.h(d,w)):x,q=t.h(d,v)!=null?A.ea(t.h(d,v)):x,p=t.h(d,"price")!=null?A.kP(J.aq(t.h(d,"price"))):x,o=t.h(d,"currency_code"),n=t.h(d,"state"),m=t.h(d,u)!=null?J.u(t.h(d,u),"form"):x,l=t.h(d,u),k=t.h(d,"occasion"),j=t.h(d,"payment_info")
return B.d08(r,o,l,m,s,t.h(d,"note_hidden"),k,j,p,n,q)},
...
bCr:function bCr(){},
d2J(d,e,f,g,h,i,j,k){return new B.hG(e,d,j,i,f,g)},
cQP(d){var x="created_at",w="updated_at",v=J.a1(d),u=v.h(d,"id"),t=v.h(d,x)!=null?A.ea(v.h(d,x)):null,s=v.h(d,w)!=null?A.ea(v.h(d,w)):null,r=v.h(d,"ticket_symbol"),q=v.h(d,"state"),p=v.h(d,"occasion")
return B.d2J(t,u,v.h(d,"note"),v.h(d,"note_hidden"),p,q,r,s)},
...
bSB:function bSB(){},
cXY(d){var x,w,v,u,t,s,r,q=y.w,p=A.J(q,y.q)
...
q.toString
r=new A.I(q,new B.bjk(),A.R(q).i("I<1,l>")).bv(0," | ")}else r=""
t.m(0,s,new A.hd(new A.hu(),r))}return t},
bjk:function bjk(){},
bd4(d){return B.dk8(d)},
dk8(d){var x=0,w=A.k(y.v),v,u
var $async$bd4=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.d($.Cr().cI("delete_order",A.w(["order_id",d.a],y.w,v),v),$async$bd4)
case 2:u=f
v=J.a1(u)
if(!J.q(v.h(u,"code"),200))throw A.p(A.cy("Deleting order failed: "+A.o(v.h(u,"code"))+": "+A.o(v.h(u,"message"))))
return A.i(null,w)}})
return A.j($async$bd4,w)},
bdm(d,e){return B.dkf(d,e)},
dkf(d,e){var x=0,w=A.k(y.v),v,u,t
var $async$bdm=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.Cr().cI("update_order_note_hidden",A.w(["order_id",d,"new_note_hidden",e],y.w,v),v),$async$bdm)
case 2:if(!u.q(t.u(g,"code"),200))throw A.p(A.cy("Saving of note has failed."))
return A.i(null,w)}})
return A.j($async$bdm,w)},
bdG(d,e){return B.dkt(d,e)},
dkt(d,e){var x=0,w=A.k(y.v),v,u,t
var $async$bdG=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.OH().cI("update_ticket_note_hidden",A.w(["ticket_id",d,"new_note_hidden",e],y.w,v),v),$async$bdG)
case 2:if(!u.q(t.u(g,"code"),200))throw A.p(A.cy("Saving of note has failed."))
return A.i(null,w)}})
return A.j($async$bdG,w)}},D,F
J=c[1]
A=c[0]
E=c[2]
C=c[99]
...
b7(){var x,w,v=this,u=A.J(y.w,y.b)
u.m(0,"x",v.a)
u.m(0,"y",v.b)
u.m(0,"type",v.f)
u.m(0,"title",v.w)
...
x=k==null?l:A.cz(k,new B.b5s(m))}if(x!=null){k=m.as
if(k==null)w=l
else{k=k.as
w=k==null?l:A.cz(k,new B.b5t(x))}if(w!=null){k=m.as
v=l
if(!(k==null)){k=k.ax
if(!(k==null)){u=A.R(k)
t=u.i("d8<1,m?>")
k=A.B(new A.d8(new A.a8(k,new B.b5u(w),u.i("a8<1>")),new B.b5v(),t),t.i("x.E"))
v=k}}if(v==null)s=l
else{k=A.R(v)
u=k.i("d8<1,l>")
u=new A.a8(new A.d8(new A.a8(v,new B.b5w(m),k.i("a8<1>")),new B.b5x(m),u),new B.b5y(),u.i("a8<x.E>")).bv(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:E.b.fN(k,new B.b5z(x))}k=r==null
q=k?l:r.aLA()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a3g()+q:""
...
pf(a0){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i=this,h=null,g="yyyy-MM-dd",f=i.a,e=f==null,d=A.aC(e?0:f)
f=A.aC(e?0:f)
e=i.d
...
t=A.aC(t)
s=i.b
s=A.aC(s!=null?A.hj(g,h).cR(s):"")
q=A.aC(i.a3g())
p=i.f
p=A.aC(p==null?h:J.u(p,"email"))
o=i.ax
o=A.aC(o!=null?new A.I(o,new B.bCr(),A.R(o).i("I<1,l>")).bv(0," | "):"")
n=A.aC(i.aLA())
m=i.z
m=A.aC(m==null?"":m)
l=A.aC("")
...
gbi(d){return this.a}}
B.hG.prototype={
b7(){return A.w(["state",this.e,"note_hidden",this.w],y.w,y.b)},
pf(d){var x,w,v,u,t,s,r,q,p,o,n,m=this,l=null,k=m.a
k=A.aC(k==null?0:k)
x=m.b
x=A.aC(x!=null?A.hj("yyyy-MM-dd",l).cR(x):"")
w=m.d
w=A.aC(w==null?"":w)
v=m.e
if(v==null)v="ordered"
...
s=A.aC(r?s.a3g():"")
r=m.z
r=A.aC(r!=null?new A.I(r,new B.bSB(),A.R(r).i("I<1,l>")).bv(0," | "):"")
p=m.y
if(p!=null){o=p.z
o=o==null?l:o.b
if(o==null)o=""
...
x=w==null?null:E.b.fN(w,new B.b5r(d))}w=x==null?null:x.d
return w==null?"":w},
$S:1245}
B.b5r.prototype={
...
B.bjk.prototype={
$1(d){return d.kH()},
$S:185};(function installTearOffs(){var x=a._static_1
x(B,"d8h","dry",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.jh,A.K)
w(A.cj,[B.b5s,B.b5t,B.b5u,B.b5v,B.b5w,B.b5x,B.b5r,B.b5y,B.b5z,B.bCr,B.bSB,B.bjk])
w(A.ij,[B.hE,B.hG])})()
A.cf(b.typeUniverse,JSON.parse('{"hE":{"ij":[]},"hG":{"ij":[]}}'))
var y={E:A.E("v<dZ>"),q:A.E("D<dZ>"),w:A.E("l"),d:A.E("hd"),b:A.E("@"),v:A.E("~")};(function constants(){var x=a.makeConstList
D.n0=A.a(x(["spot","food","others"]),A.E("v<l>"))})();(function lazyInitializers(){var x=a.lazyFinal
x($,"dP9","OH",()=>$.hL().gmo(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_244",e:"endPart",h:b})})($__dart_deferred_initializers__,"K+rxCFKfUNvDJVHL2R1ItXxWDCU=");