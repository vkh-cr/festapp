...
this.b=e},
dr5(d){return A.d_T(d)},
Ip(d){return B.djT(d)},
djT(d){var x=0,w=A.k(y.H),v,u,t,s,r,q,p,o,n,m,l
var $async$Ip=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:n=$.Cr()
m=n.cc("news").jR(0,"id")
l=d.a
l.toString
v=d.d
m=A.ms(m.ps(m.qo("created_at","lt."+l.j(0))),m.$ti.c).aJd("id",v)
l=A.d6()
l.toString
x=2
...
s.push(A.w(["user",q,"news_id",p,"occasion",o],m,l))}n=$.Cr()
x=7
...
bcU(d){return B.djW(d)},
djW(d){var x=0,w=A.k(y.H),v
var $async$bcU=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:v=y.z
x=2
return A.d($.Cr().cc("news").eY(0,A.w(["message",d.b],v,v)).dv("id",d.d),$async$bcU)
case 2:return A.i(null,w)}})
return A.j($async$bcU,w)},
arR(d,e,f,g,h,i,j){return B.djU(d,e,f,g,h,i,j)},
djU(d,e,f,g,h,i,j){var x=0,w=A.k(y.z),v,u,t,s,r,q,p,o
var $async$arR=A.f(function(k,l){if(k===1)return A.h(l,w)
...
r=$.dC().gdq().c
x=5
return A.d(t.jn(0,A.w(["occasion",s,"message",u,"created_by",(r==null?null:r.r).a],y.N,y.K)).iE(0),$async$arR)
case 5:case 4:x=i?6:7
break
case 6:for(t=H.YG(A1.YE(g),"p"),s=t.length,q="",p=0;p<t.length;t.length===s||(0,A.M)(t),++p){r=new A.dd("")
new H.aMU(r).bp(t[p])
r=r.a
o=(r.charCodeAt(0)==0?r:r)+"\n"
if(C.d.bg(o).length===0)continue
q+=o}q=C.d.bg(q)
t=$.Cr().cc("log_notifications")
s=A.d6()
s.toString
x=8
return A.d(t.jn(0,A.w(["occasion",s,"to",j,"content",q,"heading",e==null?f:e,"organization",1],y.N,y.X)),$async$arR)
case 8:A.bi(d,A.n("Message has been sent.",null),C.a3)
x=1
break
case 7:if(h)A.bi(d,A.n("Message has been created.",null),C.a3)
case 1:return A.i(v,w)}})
return A.j($async$arR,w)},
arS(d){return B.djV(d)},
djV(d){var x=0,w=A.k(y.H),v,u,t,s
var $async$arS=A.f(function(e,f){if(e===1)return A.h(f,w)
...
t.toString
x=2
return A.d(u.dv("occasion",t),$async$arS)
case 2:v=v.cc("user_news")
s=s.gdq().c
x=3
return A.d(v.jn(0,A.w(["user",(s==null?null:s.r).a,"news_id",d,"occasion",A.d6()],y.N,y.X)).iE(0),$async$arS)
case 3:return A.i(null,w)}})
return A.j($async$arS,w)}},D,W,X,Y,Z,A_,H,A0,A1,A2,A3
J=c[1]
A=c[0]
C=c[2]
I=c[175]
...
while(true)switch(x){case 0:u=B
x=2
return A.d(A_.li("newsOffline",B.dL5(),y.x),$async$y3)
case 2:v.u(new u.cne(v,e))
return A.i(null,w)}})
...
t=Z.iv(v,v,v,!0,v,v,1,v,v,v,!1,v,!1,v,v,new V.Le(v,v),v,!0,v,v,v,v,v,E.bC(A.F("News",v,v,v,v,v,v,v,A.af(v,v,new A.bw(t.a,t.b,t.c,0.8).bq(),v,v,v,v,v,v,v,v,v,v,v,v,v,v,!0,v,v,v,v,v,v,v,v),v,v,v,v,v),v),v,v,v,1,v,!0)
x=J.ey(this.d)?new A.Z(M.Nk,A.ac(A.a([A.aK(U.OC,A.C(d).ay,v,64),C.a_,A.F(A.YM("No news messages yet",v,v,v,v),v,v,v,v,v,v,v,v,C.b_,v,v,v,v)],y.p),C.j,C.bm,C.h,0,v,C.l),v):new A2.F2(new B.cna(this),v)
w=A.hF()
return X.eZ(t,u,new A.ci(C.aU,v,v,new A.cE(new A.aa(0,720,0,1/0),x,v),v),v,v,A.jx(R.a26(P.hC,S.r2,new B.cnb(this,d),v),w),v,v)}}
B.xe.prototype={
...
t=u.c
t.toString
if(G.yg(t,!1).f.gZb()===C.b.di($.OI(),"news")){u.Ml()
...
if(w!==0)v.push(C.fp)
v.push(new A.eL(new B.cn9(x,w,d,e),null))
...
if(A.hF())w.push(O.tZ(q,q,q,D.aAq,new B.cn7(),C.o,new B.cn8(p,n,d),C.aq,q,q,q,y.B))
...
x=6
return A.d(L.fj(s,!1).f.i8(u,y.X).aJ(new B.cn6(t,s),y.P),$async$$1)
case 6:case 3:x=7
return A.d(v.a.aU(),$async$$1)
...
x(B,"dL5","dr5",2)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.EI,A.L)
x(B.aRL,A.N)
w(A.d0,[B.cnc,B.cnd,B.cne,B.cnb])
w(A.cj,[B.cn5,B.cn9,B.cn8,B.cn6,B.cn7])
x(B.cna,A.ez)
x(B.xe,A.fm)})()
A.cf(b.typeUniverse,JSON.parse('{"EI":{"L":[],"e":[]},"aRL":{"N":["EI"]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_303",e:"endPart",h:b})})($__dart_deferred_initializers__,"3rbBbhWPfj0tkWT9MGYH534jbPs=");