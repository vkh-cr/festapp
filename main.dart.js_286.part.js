...
L=c[110]
B.a5M.prototype={
L(){var x=null,w=A.c(["Orders","Tickets"],y.h)
if(A.dN("blueprint",x))w.push("Blueprint")
w.push("Form")
w.push("Products")
if(A.dN("services",x))w.push("Inventory pools")
w.push("Report")
...
u.toString
x=4
return A.f(G.R6(u,"login",y.a),$async$b_)
case 4:case 3:v.bL()
return A.n(null,w)}})
