...
this.$ti=d},bnB:function bnB(d){this.a=d},
cIN(d,e){return new B.xw(e,d)},
...
u.toString
x=2
return A.c(o.cg("occasion",u).azf(0,"created_at").ayd(1).H0(),$async$EL)
case 2:t=f
x=t!=null?3:5
break
case 3:x=6
return A.c(p.bU("user_news").fZ(0,"user").cg("news_id",n),$async$EL)
case 6:s=f
r=A.a([],y.t)
for(p=J.al(s),o=J.a1(t),u=y.N,q=y.z;p.q();)r.push(A.y(["user",J.t(p.gK(p),"user"),"news_id",o.i(t,"id")],u,q))
p=$.zc()
x=7
return A.c(p.bU("user_news").Zv(r).hP(0),$async$EL)
case 7:x=4
break
case 5:x=8
return A.c(p.bU("user_news").kg(0).cg("news_id",n),$async$EL)
case 8:case 4:x=9
return A.c(p.bU("news").kg(0).cg("id",n),$async$EL)
case 9:return A.j(null,w)}})
return A.k($async$EL,w)},
b_B(d){var x=0,w=A.l(y.H),v
var $async$b_B=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.z
x=2
return A.c($.zc().bU("news").ej(0,A.y(["message",d.b],v,v)).cg("id",d.d),$async$b_B)
...
s.toString
x=5
return A.c(t.jx(0,A.y(["occasion",s,"message",u,"created_by",$.dQ().gdw().c.a],y.N,y.K)).hP(0),$async$aj2)
case 5:case 4:x=i?6:7
break
case 6:for(t=I.aQh(U.c8F(g),"p"),s=t.length,r="",q=0;q<t.length;t.length===s||(0,A.O)(t),++q){p=new A.cP("")
new I.bHX(p).b7(t[q])
p=p.a
...
case 8:A.bZ(d,A.G("Message has been sent.",null),C.af)
x=1
break
case 7:if(h)A.bZ(d,A.G("Message has been created.",null),C.af)
...
v=$.zc()
u=v.bU("user_news").kg(0).cg("user",s.gdw().c.a)
t=$.dE
t.toString
x=2
return A.c(u.cg("occasion",t),$async$aj3)
case 2:x=3
return A.c(v.bU("user_news").jx(0,A.y(["user",s.gdw().c.a,"news_id",d,"occasion",$.dE],y.N,y.X)).hP(0),$async$aj3)
...
v=v.gB(0)
s=H.cnR(t,new A.a_(0,0,0+v.a,0+v.b))
v=q.a
v.toString
t=q.c
t.toString
...
o=q.c
o.toString
E.cuM(C.f,x.a,p,o,x.d,p,r,x.c,p,s,p,x.e,x.b,x.f,!1,q.$ti.h("1?")).aJ(0,new B.bnB(q),y.H)}},
...
while(true)switch(x){case 0:u=B
x=2
return A.c(V.n6("newsOffline",B.cIL(),y.x),$async$n7)
case 2:v.E(new u.bU1(v,e))
return A.j(null,w)}})
return A.k($async$n7,w)},
bl(){var x=0,w=A.l(y.H),v=this
var $async$bl=A.h(function(d,e){if(d===1)return A.i(e,w)
while(true)switch(x){case 0:x=2
return A.c(v.n7(),$async$bl)
case 2:x=3
return A.c(v.Xf(),$async$bl)
case 3:x=4
return A.c(A.t7("newsOffline",v.d),$async$bl)
case 4:v.Jb()
return A.j(null,w)}})
return A.k($async$bl,w)},
A(d){var x,w,v=null,u=A.I(d).ax.a===C.x?$.ka():$.ze(),t=G.br(D.b1e,v)
t=M.jL(v,!0,v,v,v,v,v,W.bnv(),v,t)
x=L.m9(!0,v,new B.bTZ(this),J.b0(this.d),v,v,v,!1,C.H,!1)
w=A.om()
return F.fK(t,u,new A.cX(C.aN,v,v,new A.dj(new A.aa(0,820,0,1/0),x,v),v),v,v,A.h4(A.ckt(Q.m8,!1,new B.bU_(this,d)),w),v)}}
B.rB.prototype={
...
s.toString
r=$.dQ().gdw().d
w.push(new A.ag(D.ah4,A.aE(q,A.aZ(A.a([new A.ag(Y.ca,new H.n_(s,18,!0,q),q),A.h4(new A.ag(C.aC,A.ba(A.a([F.c0(D.ajE,A.I(d).ch,q,16),R.a1S,A.a6(C.c.k(o.e),q,q,q,q,q,q,q,A.bd(q,q,A.I(d).ch,q,q,q,q,q,q,q,q,q,q,q,C.ar,q,q,!0,q,q,q,q,q,q,q,q),q,q,q,q,q),N.j0],x),C.i,C.dK,C.k,q),q),r!=null)],x),C.i,C.j,C.k,q,C.u),C.f,q,q,new A.bF(u.ax.k2,q,q,t,q,q,q,C.S),q,q,q,q,q,q,q),q))
...
case 5:A.bZ(s,A.G("Message has been removed.",null),C.af)
x=3
break
...
u.b=A.bn(d)
x=4
return A.c(B.b_B(u),$async$$1)
case 4:A.bZ(v.b,A.G("Message has been changed.",null),C.af)
case 3:return A.j(null,w)}})
return A.k($async$$1,w)},
$S:72}
B.bTX.prototype={
$1(d){var x=y.B
return A.a([E.ccB(G.br(T.Ct,null),!0,48,D.aeT,x),E.ccB(G.br(D.b1q,null),!0,48,D.FC,x)],y.h)},
$S:z+2}
B.bU_.prototype={
$0(){return this.a.bfO(this.b)},
$S:0};(function installTearOffs(){var x=a._instance_0u,w=a._static_1
x(B.On.prototype,"gaHF","aHG",0)
w(B,"cIL","cIM",3)})();(function inheritance(){var x=a.inheritMany,w=a.inherit
x(A.F,[B.Om,B.xw])
x(A.L,[B.On,B.aHb])
x(A.bL,[B.bnB,B.bTV,B.bTY,B.bTW,B.bTX])
x(A.cl,[B.bU0,B.bU1,B.bU_])
w(B.bTZ,A.dd)
w(B.rB,A.eb)})()
A.bD(b.typeUniverse,JSON.parse('{"Om":{"F":[],"d":[]},"On":{"L":["Om<1>"]},"xw":{"F":[],"d":[]},"aHb":{"L":["xw"]}}'))
...
D.b1e=new A.c4("News",null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.b1q=new A.c4("Delete",null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_286",e:"endPart",h:b})})($__dart_deferred_initializers__,"H+ZcyN/3SC5KdfDjTDyKGcgNwP0=");