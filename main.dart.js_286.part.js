...
default:return"???"}},
cXH(d){return d+";"+B.bq9(d)},
cAK(d,e,f,g,h,i,j,k,l,m){return new B.fV(g,d,m,k,l,f,i,j,e,h)},
cAL(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.f7(v.i(d,x)):null,s=v.i(d,w)!=null?A.f7(v.i(d,w)):null,r=v.i(d,"price")!=null?A.lr(J.ap(v.i(d,"price"))):null,q=v.i(d,"state"),p=v.i(d,"data"),o=v.i(d,"occasion"),n=v.i(d,"payment_info")
return B.cAK(t,v.i(d,"currency_code"),p,u,v.i(d,"note_hidden"),o,n,r,q,s)},
...
_.ax=_.at=_.Q=null},
bqa:function bqa(){},
cDm(d,e,f,g,h,i,j,k){return new B.hl(e,d,j,i,f,g)},
cDn(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.f7(v.i(d,x)):null,s=v.i(d,w)!=null?A.f7(v.i(d,w)):null,r=v.i(d,"ticket_symbol"),q=v.i(d,"state"),p=v.i(d,"occasion")
return B.cDm(t,u,v.i(d,"note"),v.i(d,"note_hidden"),p,q,r,s)},
...
x=2
return A.c($.Ah().e1("delete_order",A.y(["order_id",d.a],y.g,v),v),$async$b4E)
case 2:u=f
v=J.a2(u)
...
t=J
x=2
return A.c($.Ah().e1("update_order_note_hidden",A.y(["order_id",d,"new_note_hidden",e],y.g,v),v),$async$b4U)
...
t=J
x=2
return A.c($.M2().e1("update_ticket_note_hidden",A.y(["ticket_id",d,"new_note_hidden",e],y.g,v),v),$async$b59)
case 2:if(!u.m(t.v(g,"code"),200))throw A.l(A.cT("Saving of note has failed."))
return A.i(null,w)}})
...
qn(d){var x,w,v,u,t,s,r,q,p,o,n,m,l=this,k=null,j="yyyy-MM-dd",i=l.a,h=i==null,g=A.aP(h?0:i)
i=A.aP(h?0:i)
h=l.d
...
t=A.aP(t)
s=l.b
s=A.aP(s!=null?A.ih(j,k).dK(s):"")
q=A.aP(l.a01())
p=l.f
p=A.aP(p==null?k:J.v(p,"email"))
o=l.at
o=A.aP(o!=null?new A.O(o,new B.bqa(),A.X(o).h("O<1,e>")).cb(0," | "):"")
n=A.aP(l.aF7())
m=l.z
return A.ly(A.y(["id",g,"order_symbol",i,"price",h,"state",x,"amount",w,"paid",v,"returned",u,"variable_symbol",r,"deadline",t,"created_at",s,"data",q,"email",p,"ticket_products",o,"note",n,"note_hidden",A.aP(m==null?"":m),"orders_history",A.aP(""),"transactions",A.aP("")],y.g,y.d),!1,y.b)},
...
l=A.aP(l==null?0:l)
x=n.b
x=A.aP(x!=null?A.ih("yyyy-MM-dd",m).dK(x):"")
w=n.d
w=A.aP(w==null?"":w)
v=n.e
if(v==null)v="ordered"
...
s=A.aP(r?s.a01():"")
r=n.z
r=A.aP(r!=null?new A.O(r,new B.bEL(),A.X(r).h("O<1,e>")).cb(0," | "):"")
p=n.y
if(p!=null){o=p.z
o=o==null?m:o.b
if(o==null)o=""
...
p=A.aP(p)
o=n.x
return A.ly(A.y(["id",l,"created_at",x,"ticket_symbol",w,"state",v,"note",u,"note_hidden",t,"order_symbol",q,"data",s,"ticket_products",r,"spot",p,"price",A.aP(o!=null?C.oc(d,o,m,0):"")],y.g,y.d),!1,y.b)},
...
gbo(d){return this.a}}
var z=a.updateTypes(["x(mS)","x(hl)","t?(mS)","x(fV)","e(e)"])
B.aZv.prototype={
...
x(B,"cAM","cXH",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.iD,A.E)
w(A.bC,[B.aZv,B.aZw,B.aZx,B.aZy,B.aZz,B.aZA,B.aZu,B.aZB,B.aZC,B.bqa,B.bEL])
w(A.i4,[B.fV,B.hl])})()
A.bl(b.typeUniverse,JSON.parse('{"fV":{"i4":[]},"hl":{"i4":[]}}'))
var y={g:A.z("e"),d:A.z("fW"),b:A.z("@"),f:A.z("~")};(function lazyInitializers(){var x=a.lazyFinal
x($,"dh9","M2",()=>$.hE().gmS(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_286",e:"endPart",h:b})})($__dart_deferred_initializers__,"3kcH1JG6UyXfxXKIBon9oR9Dg+w=");