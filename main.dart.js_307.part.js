...
this.b=e},
dha(d){return A.cRB(d)},
HR(d){return B.dac(d)},
dac(d){var x=0,w=A.l(y.H),v,u,t,s,r,q,p,o,n,m,l
var $async$HR=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:n=$.BU()
m=n.c0("news").ik(0,"id")
l=d.a
l.toString
v=d.d
m=A.mc(m.pf(m.qb("created_at","lt."+l.j(0))),m.$ti.c).aHj("id",v)
l=A.dn()
l.toString
x=2
return A.d(m.da("occasion",l).bOD(0,"created_at").aGB(1).QD(),$async$HR)
case 2:u=f
x=u!=null?3:5
break
case 3:x=6
return A.d(n.c0("user_news").ik(0,"user").da("news_id",v),$async$HR)
case 6:t=f
s=A.a([],y.t)
...
x=7
return A.d(n.c0("user_news").ahj(s),$async$HR)
case 7:x=4
break
case 5:x=8
return A.d(n.c0("user_news").iU(0).da("news_id",v),$async$HR)
case 8:case 4:x=9
return A.d(n.c0("news").iU(0).da("id",v),$async$HR)
case 9:return A.j(null,w)}})
return A.k($async$HR,w)},
bav(d){return B.daf(d)},
daf(d){var x=0,w=A.l(y.H),v
var $async$bav=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.z
x=2
return A.d($.BU().c0("news").eO(0,A.z(["message",d.b],v,v)).da("id",d.d),$async$bav)
case 2:return A.j(null,w)}})
return A.k($async$bav,w)},
aqj(d,e,f,g,h,i,j){return B.dad(d,e,f,g,h,i,j)},
dad(d,e,f,g,h,i,j){var x=0,w=A.l(y.z),v,u,t,s,r,q,p,o
var $async$aqj=A.h(function(k,l){if(k===1)return A.i(l,w)
...
s.toString
x=5
return A.d(t.jb(0,A.z(["occasion",s,"message",u,"created_by",$.dU().gds().c.a],y.N,y.K)).ix(0),$async$aqj)
case 5:case 4:x=i?6:7
break
case 6:for(t=G.XM(Z.XK(g),"p"),s=t.length,r="",q=0;q<t.length;t.length===s||(0,A.N)(t),++q){p=new A.di("")
new G.aLb(p).bn(t[q])
p=p.a
...
s.toString
x=8
return A.d(t.jb(0,A.z(["occasion",s,"to",j,"content",r,"heading",e==null?f:e,"organization",1],y.N,y.X)),$async$aqj)
...
aqk(d){return B.dae(d)},
dae(d){var x=0,w=A.l(y.H),v,u,t,s
var $async$aqk=A.h(function(e,f){if(e===1)return A.i(f,w)
...
t.toString
x=2
return A.d(u.da("occasion",t),$async$aqk)
case 2:x=3
return A.d(v.c0("user_news").jb(0,A.z(["user",s.gds().c.a,"news_id",d,"occasion",A.dn()],y.N,y.X)).ix(0),$async$aqk)
case 3:return A.j(null,w)}})
return A.k($async$aqk,w)}},D,X,Y,Z,G,A_,A0,A1
J=c[1]
A=c[0]
C=c[2]
H=c[179]
...
break
case 2:x=$.dU().gds().d!=null&&J.jm(v.d)&&!J.ik(v.d).f?4:5
break
case 4:x=6
return A.d(B.aqk(J.ik(v.d).d),$async$LH)
case 6:u=v.a.c
if(u!=null)u.$0()
v.e=!0
case 5:case 3:return A.j(null,w)}})
return A.k($async$LH,w)},
bso(d){I.iy(d,"newsForm",y.X).aH(new B.cgm(this,d),y.P)},
a01(){var x=0,w=A.l(y.H),v=this,u
var $async$a01=A.h(function(d,e){if(d===1)return A.i(e,w)
while(true)switch(x){case 0:u=B
x=2
return A.d(A.a_A(),$async$a01)
case 2:v.A(new u.cgt(v,e))
return A.j(null,w)}})
...
while(true)switch(x){case 0:u=B
x=2
return A.d(V.ma("newsOffline",B.dAY(),y.x),$async$o6)
case 2:v.A(new u.cgu(v,e))
return A.j(null,w)}})
...
t=Y.iE(v,v,v,!0,v,v,1,v,v,v,!1,v,!1,v,v,new U.Ky(v,v),v,!0,v,v,v,v,v,E.bv(A.R("News",v,v,v,v,v,v,v,A.an(v,v,new A.bl(t.a,t.b,t.c,0.8).bk(),v,v,v,v,v,v,v,v,v,v,v,v,v,v,!0,v,v,v,v,v,v,v,v),v,v,v,v,v),v),v,v,v,1,v,!0)
x=J.fp(this.d)?new A.a3(L.MA,A.ah(A.a([A.b1(D.ays,A.D(d).ay,v,64),C.a5,A.R(A.XR("No news messages yet",v,v,v,v),v,v,v,v,v,v,v,v,C.b0,v,v,v,v)],y.p),C.j,C.bl,C.i,0,v,C.m),v):new X.Eq(new B.cgr(this),v)
w=A.iZ()
return S.f6(t,u,new A.cA(C.aW,v,v,new A.cI(new A.ab(0,720,0,1/0),x,v),v),v,v,A.ji(R.a15(P.hm,new B.cgs(this,d),v),w),v,v)}}
B.wC.prototype={
I(){return"ContextMenuChoice."+this.b}}
var z=a.updateTypes(["Y<~>(wC)","B<mL<wC>>(I)","v9(A<m,@>)"])
B.cgm.prototype={
...
if(w!==0)v.push(C.hg)
v.push(new A.eY(new B.cgq(x,w,d,e),null))
...
if(A.iZ())w.push(O.Ah(q,q,D.az4,new B.cgo(),new B.cgp(p,n,d),C.at,q,q,y.B))
...
break
case 2:x=5
return A.d(B.HR(t),$async$$1)
case 5:A.bK(s,A.r("Message has been removed.",null),C.ac)
x=3
break
case 4:u=N.qC(A.z(["content",t.b],y.N,y.z),A.dn())
x=6
return A.d(K.ft(s,!1).f.ir(u,y.X).aH(new B.cgn(t,s),y.P),$async$$1)
case 6:case 3:x=7
return A.d(v.a.aY(),$async$$1)
...
B.cgo.prototype={
$1(d){var x=y.B
return A.a([F.pF(E.bv(T.I5,null),!0,48,D.asi,x),F.pF(E.bv(D.bIv,null),!0,48,D.LN,x)],y.h)},
$S:z+1}
B.cgs.prototype={
$0(){return this.a.bso(this.b)},
$S:0};(function installTearOffs(){var x=a._static_1
x(B,"dAY","dha",2)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.zZ,A.J)
x(B.aQ0,A.O)
w(A.c8,[B.cgm,B.cgq,B.cgp,B.cgn,B.cgo])
w(A.cQ,[B.cgt,B.cgu,B.cgs])
x(B.cgr,A.el)
x(B.wC,A.fb)})()
A.c5(b.typeUniverse,JSON.parse('{"zZ":{"J":[],"e":[]},"aQ0":{"O":["zZ"]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_307",e:"endPart",h:b})})($__dart_deferred_initializers__,"sU8dB4IwvKpTDdO4SufRoKwxW0g=");