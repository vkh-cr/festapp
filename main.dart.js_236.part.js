...
while(true)switch(x){case 0:x=2
return A.c(A.pF("user_info",A.bu1(),null,y.p),$async$Yo)
case 2:t=f
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_236",e:"endPart",h:b})})($__dart_deferred_initializers__,"+INdrdgwaK3XMyjHoK66kGJhOus=");