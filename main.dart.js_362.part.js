...
this.b=e},
d6p(d){return A.cJr(d)},
Hb(d){var x=0,w=A.k(y.H),v,u,t,s,r,q,p,o,n,m,l
...
l.toString
x=2
return A.d(m.ct("occasion",l).bLp(0,"created_at").aEJ(1).PZ(),$async$Hb)
case 2:u=f
x=u!=null?3:5
break
case 3:x=6
return A.d(n.bU("user_news").hx(0,"user").ct("news_id",v),$async$Hb)
case 6:t=f
s=A.a([],y.t)
...
x=7
return A.d(n.bU("user_news").aga(s),$async$Hb)
case 7:x=4
break
case 5:x=8
return A.d(n.bU("user_news").iL(0).ct("news_id",v),$async$Hb)
case 8:case 4:x=9
return A.d(n.bU("news").iL(0).ct("id",v),$async$Hb)
case 9:return A.i(null,w)}})
return A.j($async$Hb,w)},
b7j(d){var x=0,w=A.k(y.H),v
var $async$b7j=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:v=y.z
x=2
return A.d($.B5().bU("news").eS(0,A.z(["message",d.b],v,v)).ct("id",d.d),$async$b7j)
case 2:return A.i(null,w)}})
return A.j($async$b7j,w)},
aoA(d,e,f,g,h,i,j){var x=0,w=A.k(y.z),v,u,t,s,r,q,p,o
var $async$aoA=A.f(function(k,l){if(k===1)return A.h(l,w)
...
s.toString
x=5
return A.d(t.jk(0,A.z(["occasion",s,"message",u,"created_by",$.e6().gdH().c.a],y.N,y.K)).im(0),$async$aoA)
...
s.toString
x=8
return A.d(t.jk(0,A.z(["occasion",s,"to",j,"content",r,"heading",e==null?f:e,"organization",1],y.N,y.X)),$async$aoA)
case 8:A.bI(d,A.u("Message has been sent.",null),C.a8)
x=1
break
case 7:if(h)A.bI(d,A.u("Message has been created.",null),C.a8)
case 1:return A.i(v,w)}})
return A.j($async$aoA,w)},
aoB(d){var x=0,w=A.k(y.H),v,u,t,s
var $async$aoB=A.f(function(e,f){if(e===1)return A.h(f,w)
...
t.toString
x=2
return A.d(u.ct("occasion",t),$async$aoB)
case 2:x=3
return A.d(v.bU("user_news").jk(0,A.z(["user",s.gdH().c.a,"news_id",d,"occasion",A.dl()],y.N,y.X)).im(0),$async$aoB)
case 3:return A.i(null,w)}})
return A.j($async$aoB,w)}},D,A1,E,A2,A3,G
J=c[1]
A=c[0]
C=c[2]
H=c[195]
...
while(true)switch(x){case 0:u=B
x=2
return A.d(V.mm("newsOffline",B.dpx(),y.x),$async$nX)
...
A(d){var x,w,v=this,u=null,t=A.D(d).ax.a===C.t?$.ix():$.q0(),s=E.bl(D.bFa,u)
s=M.ii(u,u,u,!0,u,u,1,u,u,u,!1,u,!1,u,u,A0.bwE(),u,!0,u,u,u,u,u,s,u,u,u,1,u)
x=J.fk(v.d)?new A.a6(P.Lr,A.aj(A.a([A.bq(D.auK,A.D(d).ay,u,64),A_.a2,A.U(A.WY("No news messages yet",u,u,u,u),u,u,u,u,u,u,u,u,C.b1,u,u,u,u)],y.p),C.i,C.bs,C.h,u,C.m),u):I.lM(!0,u,new B.c9n(v),J.bv(v.d),u,u,u,!1,C.J,!1)
w=A.j3()
return L.f5(s,t,new A.cC(C.aK,u,u,new A.cQ(new A.ac(0,720,0,1/0),x,u),u),u,u,A.iK(A.a06(u,T.fV,u,u,!1,new B.c9o(v,d),u),w),u,u)}}
B.wa.prototype={
J(){return"ContextMenuChoice."+this.b}}
var z=a.updateTypes(["T<~>(wa)","C<mp<wa>>(L)","uQ(B<m,@>)"])
B.c9j.prototype={
...
B.c9l.prototype={
$1(d){var x=y.B
return A.a([F.uY(E.bl(Y.H4,null),!0,48,D.aoE,x),F.uY(E.bl(D.bEM,null),!0,48,D.KE,x)],y.h)},
$S:z+1}
B.c9o.prototype={
$0(){return this.a.bp3(this.b)},
$S:0};(function installTearOffs(){var x=a._static_1
x(B,"dpx","d6p",2)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.zr,A.I)
x(B.aNW,A.M)
w(A.bF,[B.c9j,B.c9m,B.c9k,B.c9l])
w(A.cp,[B.c9p,B.c9q,B.c9o])
x(B.c9n,A.ds)
x(B.wa,A.dY)})()
A.bm(b.typeUniverse,JSON.parse('{"zr":{"I":[],"e":[]},"aNW":{"M":["zr"]}}'))
var y=(function rtii(){var x=A.A
return{B:x("wa"),_:x("T<@>"),t:x("r<B<m,@>>"),o:x("r<uQ>"),h:x("r<mp<wa>>"),p:x("r<e>"),a:x("B<m,@>"),x:x("uQ"),P:x("aC"),K:x("E"),N:x("m"),g:x("kV"),z:x("@"),X:x("E?"),H:x("~")}})();(function constants(){D.KE=new B.wa(0,"delete")
D.aoE=new B.wa(1,"edit")
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_362",e:"endPart",h:b})})($__dart_deferred_initializers__,"G+7G7nz89bkERLMNDA+hK8KD2qs=");