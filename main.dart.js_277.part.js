...
cvH(d){var x=J.a2(d)
return new B.iQ(x.h(d,"x"),x.h(d,"y"),x.h(d,"id"),x.h(d,"group"),x.h(d,"order_product_ticket"),x.h(d,"type"),x.h(d,"state"),x.h(d,"title"),null,x.h(d,"product"),null)},
...
default:return"???"}},
d6y(d){return d+";"+B.buU(d)},
cJs(d,e,f,g,h,i,j,k,l,m,n){return new B.hc(h,d,n,l,m,f,j,k,g,e,i)},
cJt(d){var x=null,w="created_at",v="updated_at",u="data",t=J.a2(d),s=t.h(d,"id"),r=t.h(d,w)!=null?A.f0(t.h(d,w)):x,q=t.h(d,v)!=null?A.f0(t.h(d,v)):x,p=t.h(d,"price")!=null?A.lh(J.ao(t.h(d,"price"))):x,o=t.h(d,"currency_code"),n=t.h(d,"state"),m=t.h(d,u)!=null?J.v(t.h(d,u),"form"):x,l=t.h(d,u),k=t.h(d,"occasion"),j=t.h(d,"payment_info")
return B.cJs(r,o,l,m,s,t.h(d,"note_hidden"),k,j,p,n,q)},
...
buV:function buV(){},
cM3(d,e,f,g,h,i,j,k){return new B.he(e,d,j,i,f,g)},
cM4(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.h(d,"id"),t=v.h(d,x)!=null?A.f0(v.h(d,x)):null,s=v.h(d,w)!=null?A.f0(v.h(d,w)):null,r=v.h(d,"ticket_symbol"),q=v.h(d,"state"),p=v.h(d,"occasion")
return B.cM3(t,u,v.h(d,"note"),v.h(d,"note_hidden"),p,q,r,s)},
...
bK2:function bK2(){},
cGs(d){var x,w,v,u,t,s,r,q=y.w,p=A.K(q,y.q)
...
q.toString
r=new A.Q(q,new B.bd5(),A.Z(q).i("Q<1,m>")).c4(0," | ")}else r=""
t.m(0,s,new A.h2(new A.hf(),r))}return t},
bd5:function bd5(){},
b7q(d){var x=0,w=A.k(y.v),v,u
var $async$b7q=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.d($.B5().dJ("delete_order",A.z(["order_id",d.a],y.w,v),v),$async$b7q)
case 2:u=f
v=J.a2(u)
if(!J.p(v.h(u,"code"),200))throw A.n(A.cN("Deleting order failed: "+A.o(v.h(u,"code"))+": "+A.o(v.h(u,"message"))))
return A.i(null,w)}})
return A.j($async$b7q,w)},
b7I(d,e){var x=0,w=A.k(y.v),v,u,t
var $async$b7I=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.B5().dJ("update_order_note_hidden",A.z(["order_id",d,"new_note_hidden",e],y.w,v),v),$async$b7I)
case 2:if(!u.p(t.v(g,"code"),200))throw A.n(A.cN("Saving of note has failed."))
return A.i(null,w)}})
return A.j($async$b7I,w)},
b8_(d,e){var x=0,w=A.k(y.v),v,u,t
var $async$b8_=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.Nb().dJ("update_ticket_note_hidden",A.z(["ticket_id",d,"new_note_hidden",e],y.w,v),v),$async$b8_)
case 2:if(!u.p(t.v(g,"code"),200))throw A.n(A.cN("Saving of note has failed."))
return A.i(null,w)}})
return A.j($async$b8_,w)}},D,F,C
J=c[1]
A=c[0]
E=c[2]
...
x=k==null?l:A.dK(k,new B.b0H(m))}if(x!=null){k=m.as
if(k==null)w=l
else{k=k.as
w=k==null?l:A.dK(k,new B.b0I(x))}if(w!=null){k=m.as
v=l
if(!(k==null)){k=k.ax
if(!(k==null)){u=A.Z(k)
t=u.i("dy<1,l?>")
t=A.H(new A.dy(new A.ai(k,new B.b0J(w),u.i("ai<1>")),new B.b0K(),t),!0,t.i("y.E"))
v=t}}if(v==null)s=l
else{k=A.Z(v)
u=k.i("dy<1,m>")
u=new A.ai(new A.dy(new A.ai(v,new B.b0L(m),k.i("ai<1>")),new B.b0M(m),u),new B.b0N(),u.i("ai<y.E>")).c4(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:E.b.fj(k,new B.b0O(x))}k=r==null
q=k?l:r.aHZ()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a1l()+q:""
...
if(x)return!1
w=A.cF(A.bA(F.Lf()),A.bL(F.Lf()),A.cL(F.Lf()),0,0,0,0,0)
x=this.ay.w
x.toString
return w.jn(A.cF(A.bA(x),A.bL(x),A.cL(x),0,0,0,0,0))},
...
oJ(a0){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i=this,h=null,g="yyyy-MM-dd",f=i.a,e=f==null,d=A.aA(e?0:f)
f=A.aA(e?0:f)
e=i.d
...
o=i.ax
o=A.aA(o!=null?new A.Q(o,new B.buV(),A.Z(o).i("Q<1,m>")).c4(0," | "):"")
n=A.aA(i.aHZ())
m=i.z
m=A.aA(m==null?"":m)
l=A.aA("")
...
j=i.Q
j=j==null?h:j.ax
return A.kT(A.z(["id",d,"order_symbol",f,"price",e,"state",x,"amount",w,"paid",v,"returned",u,"variable_symbol",r,"deadline",t,"created_at",s,"data",q,"email",p,"ticket_products",o,"note",n,"note_hidden",m,"orders_history",l,"transactions",k,"forms",A.aA(j==null?"":j)],y.w,y.d),!1,y.b)},
ep(){var x=0,w=A.k(y.v),v=this
var $async$ep=A.f(function(d,e){if(d===1)return A.h(e,w)
while(true)switch(x){case 0:x=2
return A.d(B.b7q(v),$async$ep)
...
oJ(d){var x,w,v,u,t,s,r,q,p,o,n,m=this,l=null,k=m.a
k=A.aA(k==null?0:k)
x=m.b
...
s=A.aA(r?s.a1l():"")
r=m.z
r=A.aA(r!=null?new A.Q(r,new B.bK2(),A.Z(r).i("Q<1,m>")).c4(0," | "):"")
p=m.y
if(p!=null){o=p.z
o=o==null?l:o.b
if(o==null)o=""
...
u.toString
x=2
return A.d(B.b8_(t,u),$async$eL)
case 2:return A.i(null,w)}})
return A.j($async$eL,w)},
lk(){var x=this.d
return x==null?J.ao(this.a):x},
gbo(d){return this.a}}
var z=a.updateTypes(["x(nd)","x(he)","l?(nd)","x(hc)","m(m)"])
B.b0H.prototype={
...
x=w==null?null:E.b.fj(w,new B.b0G(d))}w=x==null?null:x.d
return w==null?"":w},
$S:1021}
B.b0G.prototype={
...
x(B,"cRp","d6y",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.iQ,A.E)
w(A.bN,[B.b0H,B.b0I,B.b0J,B.b0K,B.b0L,B.b0M,B.b0G,B.b0N,B.b0O,B.buV,B.bK2,B.bd5])
w(A.hL,[B.hc,B.he])})()
A.bt(b.typeUniverse,JSON.parse('{"hc":{"hL":[]},"he":{"hL":[]}}'))
...
x($,"dtg","Nb",()=>$.hE().gn5(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_277",e:"endPart",h:b})})($__dart_deferred_initializers__,"F/XZE4uRakX1zwXDufZeTGAgEsc=");