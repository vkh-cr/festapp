...
default:return"???"}},
d3I(d){return d+";"+B.btk(d)},
cGP(d,e,f,g,h,i,j,k,l,m,n){return new B.h9(h,d,n,l,m,f,j,k,g,e,i)},
cGQ(d){var x=null,w="created_at",v="updated_at",u="data",t=J.a1(d),s=t.h(d,"id"),r=t.h(d,w)!=null?A.f0(t.h(d,w)):x,q=t.h(d,v)!=null?A.f0(t.h(d,v)):x,p=t.h(d,"price")!=null?A.lc(J.am(t.h(d,"price"))):x,o=t.h(d,"currency_code"),n=t.h(d,"state"),m=t.h(d,u)!=null?J.v(t.h(d,u),"form"):x,l=t.h(d,u),k=t.h(d,"occasion"),j=t.h(d,"payment_info")
return B.cGP(r,o,l,m,s,t.h(d,"note_hidden"),k,j,p,n,q)},
h9:function h9(d,e,f,g,h,i,j,k,l,m,n){var _=this
_.a=d
_.b=e
_.c=f
_.d=g
...
btl:function btl(){},
cJr(d,e,f,g,h,i,j,k){return new B.hc(e,d,j,i,f,g)},
cJs(d){var x="created_at",w="updated_at",v=J.a1(d),u=v.h(d,"id"),t=v.h(d,x)!=null?A.f0(v.h(d,x)):null,s=v.h(d,w)!=null?A.f0(v.h(d,w)):null,r=v.h(d,"ticket_symbol"),q=v.h(d,"state"),p=v.h(d,"occasion")
return B.cJr(t,u,v.h(d,"note"),v.h(d,"note_hidden"),p,q,r,s)},
...
bIo:function bIo(){},
cDS(d){var x,w,v,u,t,s,r,q=y.w,p=A.K(q,y.q)
...
q.toString
r=new A.P(q,new B.bc3(),A.Z(q).i("P<1,m>")).c4(0," | ")}else r=""
t.m(0,s,new A.h0(new A.hd(),r))}return t},
bc3:function bc3(){},
b6x(d){var x=0,w=A.k(y.v),v,u
var $async$b6x=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.d($.AQ().dI("delete_order",A.z(["order_id",d.a],y.w,v),v),$async$b6x)
case 2:u=f
v=J.a1(u)
if(!J.p(v.h(u,"code"),200))throw A.n(A.cP("Deleting order failed: "+A.o(v.h(u,"code"))+": "+A.o(v.h(u,"message"))))
return A.i(null,w)}})
return A.j($async$b6x,w)},
b6P(d,e){var x=0,w=A.k(y.v),v,u,t
var $async$b6P=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.AQ().dI("update_order_note_hidden",A.z(["order_id",d,"new_note_hidden",e],y.w,v),v),$async$b6P)
case 2:if(!u.p(t.v(g,"code"),200))throw A.n(A.cP("Saving of note has failed."))
return A.i(null,w)}})
return A.j($async$b6P,w)},
b76(d,e){var x=0,w=A.k(y.v),v,u,t
var $async$b76=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.MZ().dI("update_ticket_note_hidden",A.z(["ticket_id",d,"new_note_hidden",e],y.w,v),v),$async$b76)
case 2:if(!u.p(t.v(g,"code"),200))throw A.n(A.cP("Saving of note has failed."))
return A.i(null,w)}})
return A.j($async$b76,w)}},D,F,C
J=c[1]
A=c[0]
E=c[2]
...
bl(){var x,w,v=this,u=A.K(y.w,y.b)
u.m(0,"x",v.a)
u.m(0,"y",v.b)
u.m(0,"type",v.f)
u.m(0,"title",v.w)
...
x=k==null?l:A.dI(k,new B.b_V(m))}if(x!=null){k=m.as
if(k==null)w=l
else{k=k.as
w=k==null?l:A.dI(k,new B.b_W(x))}if(w!=null){k=m.as
v=l
if(!(k==null)){k=k.ax
if(!(k==null)){u=A.Z(k)
t=u.i("dw<1,l?>")
t=A.H(new A.dw(new A.ah(k,new B.b_X(w),u.i("ah<1>")),new B.b_Y(),t),!0,t.i("y.E"))
v=t}}if(v==null)s=l
else{k=A.Z(v)
u=k.i("dw<1,m>")
u=new A.ah(new A.dw(new A.ah(v,new B.b_Z(m),k.i("ah<1>")),new B.b0_(m),u),new B.b00(),u.i("ah<y.E>")).c4(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:E.b.fg(k,new B.b01(x))}k=r==null
q=k?l:r.aGV()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a0U()+q:""
...
gbp(d){return this.c},
gdk(d){return this.w},
sGD(d){return this.as=d}}
B.h9.prototype={
bEW(){var x,w
if(this.e==="ordered"){x=this.ay
x=x==null||x.w==null}else x=!0
if(x)return!1
w=A.cD(A.bA(F.L0()),A.bK(F.L0()),A.cJ(F.L0()),0,0,0,0,0)
x=this.ay.w
x.toString
return w.jj(A.cD(A.bA(x),A.bK(x),A.cJ(x),0,0,0,0,0))},
...
o=i.ax
o=A.aA(o!=null?new A.P(o,new B.btl(),A.Z(o).i("P<1,m>")).c4(0," | "):"")
n=A.aA(i.aGV())
m=i.z
m=A.aA(m==null?"":m)
l=A.aA("")
...
u.toString
x=2
return A.d(B.b6P(t,u),$async$eK)
case 2:return A.i(null,w)}})
return A.j($async$eK,w)},
lj(){return"Order #"+A.o(this.a)},
...
s=A.aA(r?s.a0U():"")
r=m.z
r=A.aA(r!=null?new A.P(r,new B.bIo(),A.Z(r).i("P<1,m>")).c4(0," | "):"")
p=m.y
if(p!=null){o=p.z
o=o==null?l:o.b
if(o==null)o=""
...
u.toString
x=2
return A.d(B.b76(t,u),$async$eK)
case 2:return A.i(null,w)}})
return A.j($async$eK,w)},
lj(){var x=this.d
return x==null?J.am(this.a):x},
gbp(d){return this.a}}
var z=a.updateTypes(["x(n5)","x(hc)","l?(n5)","x(h9)","m(m)"])
B.b_V.prototype={
...
x=w==null?null:E.b.fg(w,new B.b_U(d))}w=x==null?null:x.d
return w==null?"":w},
$S:1016}
B.b_U.prototype={
...
x(B,"cON","d3I",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.iM,A.F)
w(A.bN,[B.b_V,B.b_W,B.b_X,B.b_Y,B.b_Z,B.b0_,B.b_U,B.b00,B.b01,B.btl,B.bIo,B.bc3])
w(A.hI,[B.h9,B.hc])})()
A.bt(b.typeUniverse,JSON.parse('{"h9":{"hI":[]},"hc":{"hI":[]}}'))
var y={E:A.A("r<eN>"),q:A.A("C<eN>"),w:A.A("m"),d:A.A("h0"),b:A.A("@"),v:A.A("~")};(function constants(){var x=a.makeConstList
D.mb=A.a(x(["spot","food","others"]),A.A("r<m>"))})();(function lazyInitializers(){var x=a.lazyFinal
x($,"dqg","MZ",()=>$.hB().gn3(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_277",e:"endPart",h:b})})($__dart_deferred_initializers__,"uLw7FPXU239o+B3jTse6HMz44DM=");