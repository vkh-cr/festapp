...
cxx(d,e,f,g,h,i,j,k,l,m){return new B.fQ(g,d,m,k,l,f,i,j,e,h)},
cxy(d){var x="created_at",w="updated_at",v=J.a3(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.fd(v.i(d,x)):null,s=v.i(d,w)!=null?A.fd(v.i(d,w)):null,r=v.i(d,"price")!=null?A.nL(J.av(v.i(d,"price"))):null,q=v.i(d,"state"),p=v.i(d,"data"),o=v.i(d,"occasion"),n=v.i(d,"payment_info")
return B.cxx(t,v.i(d,"currency_code"),p,u,v.i(d,"note_hidden"),o,n,r,q,s)},
...
x(B,"cxA","cUz",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.is,A.E)
...
x($,"ddU","LG",()=>$.hl().gmO(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_277",e:"endPart",h:b})})($__dart_deferred_initializers__,"HUWSD0nIoqdYFlrPtwSpHUPG4+8=");