...
this.b=e},
dhq(d){return A.cRQ(d)},
HS(d){return B.dat(d)},
dat(d){var x=0,w=A.l(y.H),v,u,t,s,r,q,p,o,n,m,l
...
l.toString
x=2
return A.d(m.d8("occasion",l).bOK(0,"created_at").aGK(1).QG(),$async$HS)
case 2:u=f
x=u!=null?3:5
break
case 3:x=6
...
baA(d){return B.daw(d)},
daw(d){var x=0,w=A.l(y.H),v
var $async$baA=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.z
x=2
return A.d($.BW().c_("news").eP(0,A.z(["message",d.b],v,v)).d8("id",d.d),$async$baA)
case 2:return A.j(null,w)}})
return A.k($async$baA,w)},
aqn(d,e,f,g,h,i,j){return B.dau(d,e,f,g,h,i,j)},
dau(d,e,f,g,h,i,j){var x=0,w=A.l(y.z),v,u,t,s,r,q,p,o
...
aqo(d){return B.dav(d)},
dav(d){var x=0,w=A.l(y.H),v,u,t,s
...
while(true)switch(x){case 0:u=B
x=2
return A.d(W.ma("newsOffline",B.dBb(),y.x),$async$o6)
case 2:v.A(new u.cgH(v,e))
return A.j(null,w)}})
...
B(d){var x,w,v=null,u=A.D(d).ax.a===C.q?$.ih():$.qi(),t=A.bq(C.av)
...
x=J.fp(this.d)?new A.a3(N.MA,A.ai(A.a([A.b1(D.ayv,A.D(d).ay,v,64),C.a5,A.R(A.XQ("No news messages yet",v,v,v,v),v,v,v,v,v,v,v,v,C.b0,v,v,v,v)],y.p),C.j,C.bl,C.i,0,v,C.m),v):new A0.Es(new B.cgD(this),v)
w=A.iZ()
return U.f8(t,u,new A.cA(C.aW,v,v,new A.cJ(new A.ab(0,720,0,1/0),x,v),v),v,v,A.ji(T.a17(R.hm,new B.cgE(this,d),v),w),v,v)}}
B.wD.prototype={
...
t=u.c
t.toString
if(G.aEG(t,!1).f.gazK()===C.b.dr($.akL(),"news")){u.LJ()
...
if(w!==0)v.push(C.hg)
v.push(new A.eZ(new B.cgC(x,w,d,e),null))
...
x=6
return A.d(M.fu(s,!1).f.ir(u,y.X).aH(new B.cgz(t,s),y.P),$async$$1)
case 6:case 3:x=7
return A.d(v.a.aY(),$async$$1)
...
$S:z+1}
B.cgE.prototype={
$0(){return this.a.bsx(this.b)},
$S:0};(function installTearOffs(){var x=a._static_1
x(B,"dBb","dhq",2)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.E8,A.J)
x(B.aQ4,A.O)
w(A.cM,[B.cgF,B.cgG,B.cgH,B.cgE])
w(A.c6,[B.cgy,B.cgC,B.cgB,B.cgz,B.cgA])
x(B.cgD,A.eh)
x(B.wD,A.eX)})()
A.c5(b.typeUniverse,JSON.parse('{"E8":{"J":[],"e":[]},"aQ4":{"O":["E8"]}}'))
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_328",e:"endPart",h:b})})($__dart_deferred_initializers__,"GnYCSUDJ2xnoNUgoo+Gnh1tscrs=");