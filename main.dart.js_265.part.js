...
default:return"???"}},
di3(d){return d+";"+B.bz3(d)},
cSg(d,e,f,g,h,i,j,k,l,m,n){return new B.hu(h,d,n,l,m,f,j,k,g,e,i)},
cSh(d){var x=null,w="created_at",v="updated_at",u="data",t=J.a1(d),s=t.h(d,"id"),r=t.h(d,w)!=null?A.eA(t.h(d,w)):x,q=t.h(d,v)!=null?A.eA(t.h(d,v)):x,p=t.h(d,"price")!=null?A.lF(J.as(t.h(d,"price"))):x,o=t.h(d,"currency_code"),n=t.h(d,"state"),m=t.h(d,u)!=null?J.v(t.h(d,u),"form"):x,l=t.h(d,u),k=t.h(d,"occasion"),j=t.h(d,"payment_info")
return B.cSg(r,o,l,m,s,t.h(d,"note_hidden"),k,j,p,n,q)},
...
bz4:function bz4(){},
cUR(d,e,f,g,h,i,j,k){return new B.hv(e,d,j,i,f,g)},
cUS(d){var x="created_at",w="updated_at",v=J.a1(d),u=v.h(d,"id"),t=v.h(d,x)!=null?A.eA(v.h(d,x)):null,s=v.h(d,w)!=null?A.eA(v.h(d,w)):null,r=v.h(d,"ticket_symbol"),q=v.h(d,"state"),p=v.h(d,"occasion")
return B.cUR(t,u,v.h(d,"note"),v.h(d,"note_hidden"),p,q,r,s)},
...
bON:function bON(){},
cPb(d){var x,w,v,u,t,s,r,q=y.w,p=A.H(q,y.q)
...
q.toString
r=new A.N(q,new B.bgA(),A.V(q).i("N<1,m>")).bQ(0," | ")}else r=""
t.m(0,s,new A.hi(new A.hw(),r))}return t},
bgA:function bgA(){},
baQ(d){return B.daV(d)},
daV(d){var x=0,w=A.l(y.v),v,u
var $async$baQ=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.d($.BW().ds("delete_order",A.z(["order_id",d.a],y.w,v),v),$async$baQ)
case 2:u=f
v=J.a1(u)
if(!J.p(v.h(u,"code"),200))throw A.n(A.cS("Deleting order failed: "+A.o(v.h(u,"code"))+": "+A.o(v.h(u,"message"))))
return A.j(null,w)}})
return A.k($async$baQ,w)},
bb7(d,e){return B.db2(d,e)},
db2(d,e){var x=0,w=A.l(y.v),v,u,t
var $async$bb7=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.BW().ds("update_order_note_hidden",A.z(["order_id",d,"new_note_hidden",e],y.w,v),v),$async$bb7)
case 2:if(!u.p(t.v(g,"code"),200))throw A.n(A.cS("Saving of note has failed."))
return A.j(null,w)}})
return A.k($async$bb7,w)},
bbp(d,e){return B.dbf(d,e)},
dbf(d,e){var x=0,w=A.l(y.v),v,u,t
var $async$bbp=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.NY().ds("update_ticket_note_hidden",A.z(["ticket_id",d,"new_note_hidden",e],y.w,v),v),$async$bbp)
case 2:if(!u.p(t.v(g,"code"),200))throw A.n(A.cS("Saving of note has failed."))
return A.j(null,w)}})
return A.k($async$bbp,w)}},D
J=c[1]
A=c[0]
E=c[2]
C=c[104]
...
bh(){var x,w,v=this,u=A.H(y.w,y.b)
u.m(0,"x",v.a)
u.m(0,"y",v.b)
u.m(0,"type",v.f)
u.m(0,"title",v.w)
...
bzY(d){var x,w,v,u,t,s,r,q,p,o,n,m=this,l=null,k=m.as
if(k==null)x=l
else{k=k.ax
x=k==null?l:A.dI(k,new B.b3y(m))}if(x!=null){k=m.as
if(k==null)w=l
else{k=k.as
w=k==null?l:A.dI(k,new B.b3z(x))}if(w!=null){k=m.as
v=l
if(!(k==null)){k=k.ax
if(!(k==null)){u=A.V(k)
t=u.i("dJ<1,f?>")
k=A.E(new A.dJ(new A.ag(k,new B.b3A(w),u.i("ag<1>")),new B.b3B(),t),t.i("y.E"))
v=k}}if(v==null)s=l
else{k=A.V(v)
u=k.i("dJ<1,m>")
u=new A.ag(new A.dJ(new A.ag(v,new B.b3C(m),k.i("ag<1>")),new B.b3D(m),u),new B.b3E(),u.i("ag<y.E>")).bQ(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:E.b.fs(k,new B.b3F(x))}k=r==null
q=k?l:r.aJS()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a28()+q:""
...
if(x)return!1
w=A.ct(A.br(F.vG()),A.bC(F.vG()),A.cv(F.vG()),0,0,0,0,0)
x=this.ay.w
x.toString
return w.fK(A.ct(A.br(x),A.bC(x),A.cv(x),0,0,0,0,0))},
...
o=i.ax
o=A.aD(o!=null?new A.N(o,new B.bz4(),A.V(o).i("N<1,m>")).bQ(0," | "):"")
n=A.aD(i.aJS())
m=i.z
m=A.aD(m==null?"":m)
l=A.aD("")
...
s=A.aD(r?s.a28():"")
r=m.z
r=A.aD(r!=null?new A.N(r,new B.bON(),A.V(r).i("N<1,m>")).bQ(0," | "):"")
p=m.y
if(p!=null){o=p.z
o=o==null?l:o.b
if(o==null)o=""
...
u.toString
x=2
return A.d(B.bbp(t,u),$async$eK)
case 2:return A.j(null,w)}})
return A.k($async$eK,w)},
lk(){var x=this.d
return x==null?J.as(this.a):x},
gbk(d){return this.a}}
var z=a.updateTypes(["x(nF)","x(hv)","f?(nF)","x(hu)","m(m)"])
B.b3y.prototype={
...
x=w==null?null:E.b.fs(w,new B.b3x(d))}w=x==null?null:x.d
return w==null?"":w},
$S:1193}
B.b3x.prototype={
...
B.bgA.prototype={
$1(d){return d.lk()},
$S:166};(function installTearOffs(){var x=a._static_1
x(B,"d_j","di3",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.j1,A.G)
w(A.c9,[B.b3y,B.b3z,B.b3A,B.b3B,B.b3C,B.b3D,B.b3x,B.b3E,B.b3F,B.bz4,B.bON,B.bgA])
w(A.i6,[B.hu,B.hv])})()
A.c5(b.typeUniverse,JSON.parse('{"hu":{"i6":[]},"hv":{"i6":[]}}'))
var y={E:A.C("u<eV>"),q:A.C("B<eV>"),w:A.C("m"),d:A.C("hi"),b:A.C("@"),v:A.C("~")};(function constants(){var x=a.makeConstList
D.mN=A.a(x(["spot","food","others"]),A.C("u<m>"))})();(function lazyInitializers(){var x=a.lazyFinal
x($,"dFn","NY",()=>$.hP().gmE(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_265",e:"endPart",h:b})})($__dart_deferred_initializers__,"uQMPKcwWac69LAQeN1u3mwcOhnU=");