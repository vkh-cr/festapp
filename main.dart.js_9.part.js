...
var $async$a_7=A.h(function(g,h){if(g===1)return A.i(h,w)
...
t=y.b
x=3
return A.d($.hN().dC("sign_user_to_event",A.z(["ev",e,"usr",l],u,t),t),$async$a_7)
case 3:s=h
t=J.a2(s)
...
x=1
break $async$outer
case 101:A.bG(d,A.r("Cannot sign in!",null)+" "+A.r("Event is full.",null),B.be)
x=1
break $async$outer
...
x=1
break $async$outer
case 105:A.bG(d,A.r("Cannot sign in!",null)+" "+A.r("There is already the maximum of men.",null),B.be)
x=1
break $async$outer
case 106:A.bG(d,A.r("Cannot sign in!",null)+" "+A.r("There is already the maximum of women.",null),B.be)
x=1
break $async$outer
default:A.bG(d,A.r("Cannot sign in!",null),B.be)
x=1
