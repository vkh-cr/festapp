...
avh(d,e,f){return new A.avg(e,f,d,null)},
...
if(C.e.lc(w.toLowerCase(),".svg"))y=new D.Lu(u,v,C.h3,new D.TT(w,x,x,x,x),x,!1,"Festapp logo",!1,x,x)
else y=E.a1N(w,x,v,x,u)
return B.iI(!1,x,!0,y,x,!0,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x)}}
var z=a.updateTypes([]);(function inheritance(){var y=a.inherit
y(A.avg,B.aa)})()
B.c4(b.typeUniverse,JSON.parse('{"avg":{"aa":[],"e":[]}}'))};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_38",e:"endPart",h:b})})($__dart_deferred_initializers__,"YKE6in1H8BasK9tHD7BrlkbAX7s=");