...
default:return"???"}},
cTI(d){return d+";"+B.boU(d)},
cwJ(d,e,f,g,h,i,j,k,l,m){return new B.fR(g,d,m,k,l,f,i,j,e,h)},
cwK(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.fd(v.i(d,x)):null,s=v.i(d,w)!=null?A.fd(v.i(d,w)):null,r=v.i(d,"price")!=null?A.nH(J.au(v.i(d,"price"))):null,q=v.i(d,"state"),p=v.i(d,"data"),o=v.i(d,"occasion"),n=v.i(d,"payment_info")
return B.cwJ(t,v.i(d,"currency_code"),p,u,v.i(d,"note_hidden"),o,n,r,q,s)},
...
_.ax=_.at=_.Q=null},
boV:function boV(){},
czv(d,e,f,g,h,i,j,k){return new B.hb(e,d,j,i,f,g)},
czw(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.fd(v.i(d,x)):null,s=v.i(d,w)!=null?A.fd(v.i(d,w)):null,r=v.i(d,"ticket_symbol"),q=v.i(d,"state"),p=v.i(d,"occasion")
return B.czv(t,u,v.i(d,"note"),v.i(d,"note_hidden"),p,q,r,s)},
...
bEA:function bEA(){},
b3o(d){var x=0,w=A.l(y.f),v,u
var $async$b3o=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.c($.Ae().e4("delete_order",A.y(["order_id",d.a],y.g,v),v),$async$b3o)
case 2:u=f
v=J.a2(u)
if(!J.m(v.i(u,"code"),200))throw A.f(A.cA("Deleting order failed: "+A.o(v.i(u,"code"))+": "+A.o(v.i(u,"message"))))
return A.j(null,w)}})
return A.k($async$b3o,w)},
b3E(d,e){var x=0,w=A.l(y.f),v,u,t
var $async$b3E=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.c($.Ae().e4("update_order_note_hidden",A.y(["order_id",d,"new_note_hidden",e],y.g,v),v),$async$b3E)
...
t=J
x=2
return A.c($.LB().e4("update_ticket_note_hidden",A.y(["ticket_id",d,"new_note_hidden",e],y.g,v),v),$async$b3U)
case 2:if(!u.m(t.u(g,"code"),200))throw A.f(A.cA("Saving of note has failed."))
return A.j(null,w)}})
return A.k($async$b3U,w)}},C
J=c[1]
A=c[0]
D=c[2]
...
x=k==null?l:A.e9(k,new B.aYl(m))}if(x!=null){k=m.as
if(k==null)w=l
else{k=k.as
w=k==null?l:A.e9(k,new B.aYm(x))}if(w!=null){k=m.as
v=l
if(!(k==null)){k=k.ax
if(!(k==null)){u=A.X(k)
t=u.h("dj<1,r?>")
t=A.J(new A.dj(new A.ai(k,new B.aYn(w),u.h("ai<1>")),new B.aYo(),t),!0,t.h("v.E"))
v=t}}if(v==null)s=l
else{k=A.X(v)
u=k.h("dj<1,e>")
u=new A.ai(new A.dj(new A.ai(v,new B.aYp(m),k.h("ai<1>")),new B.aYq(m),u),new B.aYr(),u.h("ai<v.E>")).c5(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:D.b.lQ(k,new B.aYs(x))}k=r==null
q=k?l:r.aER()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a01()+q:""
...
p=m.at
p=A.aT(p!=null?new A.R(p,new B.boV(),A.X(p).h("R<1,e>")).c5(0," | "):"")
o=A.aT(m.aER())
n=m.z
...
x=w==null?null:D.b.lQ(w,new B.aYk(d))}w=x==null?null:x.d
return w==null?"":w},
$S:954}
B.aYk.prototype={
...
x(B,"cwM","cTI",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.iq,A.E)
w(A.bF,[B.aYl,B.aYm,B.aYn,B.aYo,B.aYp,B.aYq,B.aYk,B.aYr,B.aYs,B.boV,B.bEA])
w(A.hB,[B.fR,B.hb])})()
A.bk(b.typeUniverse,JSON.parse('{"fR":{"hB":[]},"hb":{"hB":[]}}'))
var y={e:A.z("fX"),g:A.z("e"),b:A.z("@"),f:A.z("~")};(function lazyInitializers(){var x=a.lazyFinal
x($,"dd1","LB",()=>$.hl().gmN(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_275",e:"endPart",h:b})})($__dart_deferred_initializers__,"8IXQD5kiQ2NyuxLIH5gPkc/MM6w=");