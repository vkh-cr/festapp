...
default:return"???"}},
cWU(d){return d+";"+B.bqi(d)},
czS(d,e,f,g,h,i,j,k,l,m){return new B.fU(g,d,m,k,l,f,i,j,e,h)},
czT(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.f9(v.i(d,x)):null,s=v.i(d,w)!=null?A.f9(v.i(d,w)):null,r=v.i(d,"price")!=null?A.nR(J.ap(v.i(d,"price"))):null,q=v.i(d,"state"),p=v.i(d,"data"),o=v.i(d,"occasion"),n=v.i(d,"payment_info")
return B.czS(t,v.i(d,"currency_code"),p,u,v.i(d,"note_hidden"),o,n,r,q,s)},
...
_.ax=_.at=_.Q=null},
bqj:function bqj(){},
cCF(d,e,f,g,h,i,j,k){return new B.hi(e,d,j,i,f,g)},
cCG(d){var x="created_at",w="updated_at",v=J.a2(d),u=v.i(d,"id"),t=v.i(d,x)!=null?A.f9(v.i(d,x)):null,s=v.i(d,w)!=null?A.f9(v.i(d,w)):null,r=v.i(d,"ticket_symbol"),q=v.i(d,"state"),p=v.i(d,"occasion")
return B.cCF(t,u,v.i(d,"note"),v.i(d,"note_hidden"),p,q,r,s)},
...
brF(d){var x,w,v,u,t,s,r,q,p,o,n,m=this,l=null,k=m.as
if(k==null)x=l
else{k=k.ax
...
u=k.h("ds<1,e>")
u=new A.ac(new A.ds(new A.ac(v,new B.aZq(m),k.h("ac<1>")),new B.aZr(m),u),new B.aZs(),u.h("ac<w.E>")).c2(0,"\n")
s=u}if(s==null)s=""
k=m.as
if(k==null)r=l
else{k=k.at
r=k==null?l:D.b.lX(k,new B.aZt(x))}k=r==null
q=k?l:r.aF8()
if(q==null)q=""
if(q.length!==0)q="\n"+q
p=!k?"\n"+r.a06()+q:""
...
n=A.aR(l.aF8())
m=l.z
return A.lp(A.z(["id",g,"order_symbol",i,"price",h,"state",x,"amount",w,"paid",v,"returned",u,"variable_symbol",r,"deadline",t,"created_at",s,"data",q,"email",p,"ticket_products",o,"note",n,"note_hidden",A.aR(m==null?"":m),"orders_history",A.aR(""),"transactions",A.aR("")],y.g,y.e),!1,y.b)},
...
s=A.aR(r?s.a06():"")
r=n.z
r=A.aR(r!=null?new A.O(r,new B.bGJ(),A.X(r).h("O<1,e>")).c2(0," | "):"")
p=n.y
if(p!=null){o=p.z
o=o==null?m:o.b
if(o==null)o=""
...
p=A.aR(p)
o=n.x
return A.lp(A.z(["id",l,"created_at",x,"ticket_symbol",w,"state",v,"note",u,"note_hidden",t,"order_symbol",q,"data",s,"ticket_products",r,"spot",p,"price",A.aR(o!=null?C.oc(d,o,m,0):"")],y.g,y.e),!1,y.b)},
...
x=w==null?null:D.b.lX(w,new B.aZl(d))}w=x==null?null:x.d
return w==null?"":w},
$S:973}
B.aZl.prototype={
...
x(B,"czU","cWU",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.iB,A.E)
w(A.bB,[B.aZm,B.aZn,B.aZo,B.aZp,B.aZq,B.aZr,B.aZl,B.aZs,B.aZt,B.bqj,B.bGJ])
w(A.i4,[B.fU,B.hi])})()
A.bl(b.typeUniverse,JSON.parse('{"fU":{"i4":[]},"hi":{"i4":[]}}'))
var y={e:A.y("hg"),g:A.y("e"),b:A.y("@"),f:A.y("~")};(function lazyInitializers(){var x=a.lazyFinal
x($,"dgx","LZ",()=>$.hx().gmP(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_279",e:"endPart",h:b})})($__dart_deferred_initializers__,"1ZLFnce3FKoGqgOQmJ5c83fCjC8=");