...
jD(d,e,f,g){return new A.SQ(d,g,e,f,null,null)},
...
if(w===1)return A.byn(1,0)
if(w===-1)return A.byn(-1,0)
v=Math.cos(d)
if(v===-1)return A.byn(0,-1)
return A.byn(w,v)},
byn(d,e){var x=new Float64Array(16)
x[0]=e
x[1]=d
x[4]=-d
x[5]=e
...
A.aAD.prototype={
ut(d){this.z=y.h.a(d.$3(this.z,this.a.w,new A.bBP()))},
