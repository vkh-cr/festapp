...
$__dart_deferred_initializers__.current=function(a,b,c,$){var J,A,C,B={a0V:function a0V(d,e){this.a=d
this.b=e},
d2X(d){C.b.ep(d,new B.b8h())
return d},
yL(d){return B.d2Z(d)},
d2Z(d){var w=0,v=A.k(x.l),u,t,s,r
...
s.toString
w=6
return A.d(t.cD("occasion",s).adk(0,"type","eq",d),$async$yL)
case 6:r=f
w=4
break
...
s.toString
w=7
return A.d(t.cD("occasion",s).aGC("type.eq.,type.is.null"),$async$yL)
case 7:r=f
case 4:u=B.d2X(A.aZ(J.bY(r,new B.b8q(),x.b),!0,x.c))
w=1
break
...
b8h:function b8h(){},
b8q:function b8q(){},
bQM(d,e){var w,v,u,t,s,r,q,p=A.bC("\\d+|\\D+",!0,!1,!1),o=p.v8(0,d),n=x.g
o=A.lW(o,new B.bQN(),A.u(o).i("z.E"),n)
w=A.G(o,!0,A.u(o).i("z.E"))
o=p.v8(0,e)
n=A.lW(o,new B.bQO(),A.u(o).i("z.E"),n)
v=A.G(n,!0,A.u(n).i("z.E"))
u=0
while(!0){o=w.length
...
bQN:function bQN(){},
bQO:function bQO(){},
apc(){var w=0,v=A.k(x.i),u,t,s,r,q,p
var $async$apc=A.f(function(d,e){if(d===1)return A.h(e,v)
while(true)switch(w){case 0:q=$.u_().bU("occasions").hA(0,"data")
p=A.dh()
p.toString
w=3
return A.d(q.cD("id",p).Qm(),$async$apc)
case 3:t=e
if(t!=null){s=J.v(t,"data")
if(s!=null&&J.v(s,"game")!=null){q=J.v(s,"game")
p=J.a2(q)
r=p.h(q,"start")!=null?A.f4(p.h(q,"start")):null
u=new B.a0V(r,p.h(q,"end")!=null?A.f4(p.h(q,"end")):null)
w=1
break}}u=null
w=1
break
...
v=v==null?null:v.hK()
w=this.b
return A.A(["start",v,"end",w==null?null:w.hK()],x.g,x.b)}}
var z=a.updateTypes(["V<C<eC>>([m?])"])
B.b8h.prototype={
$2(d,e){var w,v,u=d.w
if(u==null)u=0
w=e.w
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_339",e:"endPart",h:b})})($__dart_deferred_initializers__,"oXwam37KIEy3828c2BOWuPsKAbo=");