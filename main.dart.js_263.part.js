...
bbW(d,e){return B.dcS(d,e)},
dcS(d,e){var x=0,w=A.l(y.C),v,u,t,s,r
var $async$bbW=A.h(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:s=y.z
x=3
return A.d($.O7().dn("scan_ticket",A.z(["scanned_id",d,"scanned_code",e],y.N,s),s),$async$bbW)
case 3:r=g
s=J.a1(r)
if(!J.p(s.h(r,"code"),200)){v=null
x=1
break}u=H.cWw(y.P.a(s.h(r,"ticket")))
if(s.a5(r,"order")&&s.h(r,"order")!=null)u.Q=H.cTW(s.h(r,"order"))
if(s.a5(r,"products")&&s.h(r,"products")!=null){t=J.bt(y.j.a(s.h(r,"products")),new B.bbX(),y.K)
t=A.E(t,t.$ti.i("a6.E"))
u.z=t}if(s.a5(r,"spot")&&s.h(r,"spot")!=null)u.y=H.cGd(s.h(r,"spot"))
v=u
x=1
break
case 1:return A.j(v,w)}})
return A.k($async$bbW,w)},
bc0(d,e){return B.dcX(d,e)},
...
s=J
x=3
return A.d($.O7().dn("update_ticket_to_used",A.z(["ticket_id",d,"scan_code",e],y.N,u),u),$async$bc0)
...
B.Fe.prototype={
M(){return new B.agL(D.aby,new A.cp(C.aw,$.a9()),E.cTs(F.Mj,A.a([C.nY],y.k)))}}
B.agL.prototype={
l(){this.x.l()
var x=this.r
x.a8$=$.a9()
...
u.toString
u.c=J.v(v.c.hx(y.u).f.r,0).a.wd(0,"scanCode")}$.yz().ajl("https://unpkg.com/@zxing/library@0.21.3")
A.cY(v.a.c)
v.OR()
return A.j(null,w)}})
...
if(r.e==null)return A.bG(new A.a2(F.MG,G.bw(D.bJw,q),q),q,q)
x=r.f
if(x===D.GR)w=V.j2
...
u=A.E(new A.N(u,new B.coV(),t),t.i("a6.E"))
...
t.toString
x=3
return A.d(B.bc0(s,t),$async$UO)
case 3:if(e){u.A(new B.coU(u))
E.qK()}else{E.qK()
E.qK()
u.c.af(y.q).f.ak9(M.cVE(null,null,null,null,null,C.v,null,G.bw(A.P("Failed to confirm ticket",null,null,null,null,null,null,null,null,null,null,null,null,null),null),null,N.Mv,null,null,null,null,null,null,null,null,null))}case 1:return A.j(v,w)}})
...
return{k:x("u<jG>"),p:x("u<e>"),j:x("B<@>"),P:x("A<m,@>"),K:x("eZ"),u:x("ri"),N:x("m"),q:x("GS"),y:x("x"),z:x("@"),C:x("hv?"),H:x("~")}})();(function constants(){D.GR=new B.TK(0,"valid")
D.abw=new B.TK(1,"invalid")
D.GS=new B.TK(2,"used")
D.aby=new B.TK(3,"nothing")
D.bJc=new A.cs("Confirm Ticket",null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.bJw=new A.cs("Point the camera at the attendee's code for an entry verification.",null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_263",e:"endPart",h:b})})($__dart_deferred_initializers__,"4B2g+riu78p5s40K6Fyn0EDKLsc=");