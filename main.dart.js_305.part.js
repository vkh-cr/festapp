...
this.b=e},
dqk(d){return A.d_5(d)},
In(d){return B.dj7(d)},
dj7(d){var x=0,w=A.k(y.H),v,u,t,s,r,q,p,o,n,m,l
...
case 6:t=f
s=A.a([],y.t)
for(n=J.aI(t),m=y.N,l=y.z,r=J.a0(u);n.q();){q=J.v(n.gL(n),"user")
p=r.h(u,"id")
o=$.fT
if(o==null)o=null
else{o=o.b
...
bcO(d){return B.dja(d)},
dja(d){var x=0,w=A.k(y.H),v
var $async$bcO=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:v=y.z
x=2
return A.d($.Cq().cb("news").eY(0,A.w(["message",d.b],v,v)).dv("id",d.d),$async$bcO)
case 2:return A.i(null,w)}})
return A.j($async$bcO,w)},
arN(d,e,f,g,h,i,j){return B.dj8(d,e,f,g,h,i,j)},
dj8(d,e,f,g,h,i,j){var x=0,w=A.k(y.z),v,u,t,s,r,q,p,o
var $async$arN=A.f(function(k,l){if(k===1)return A.h(l,w)
...
r=$.dB().gdn().c
x=5
return A.d(t.jn(0,A.w(["occasion",s,"message",u,"created_by",(r==null?null:r.r).a],y.N,y.K)).iD(0),$async$arN)
...
s.toString
x=8
return A.d(t.jn(0,A.w(["occasion",s,"to",j,"content",q,"heading",e==null?f:e,"organization",1],y.N,y.X)),$async$arN)
case 8:A.bl(d,A.n("Message has been sent.",null),C.a4)
x=1
break
case 7:if(h)A.bl(d,A.n("Message has been created.",null),C.a4)
case 1:return A.i(v,w)}})
return A.j($async$arN,w)},
arO(d){return B.dj9(d)},
dj9(d){var x=0,w=A.k(y.H),v,u,t,s
var $async$arO=A.f(function(e,f){if(e===1)return A.h(f,w)
...
t.toString
x=2
return A.d(u.dv("occasion",t),$async$arO)
case 2:v=v.cb("user_news")
s=s.gdn().c
x=3
return A.d(v.jn(0,A.w(["user",(s==null?null:s.r).a,"news_id",d,"occasion",A.d6()],y.N,y.X)).iD(0),$async$arO)
case 3:return A.i(null,w)}})
return A.j($async$arO,w)}},D,W,X,Y,Z,A_,H,A0,A1,A2,A3
J=c[1]
A=c[0]
C=c[2]
I=c[175]
...
break
case 4:x=6
return A.d(B.arO(J.h3(v.d).d),$async$Mk)
case 6:u=v.a.c
if(u!=null)u.$0()
v.e=!0
...
while(true)switch(x){case 0:u=B
x=2
return A.d(A_.le("newsOffline",B.dKk(),y.x),$async$y3)
...
B(d){var x,w,v=null,u=A.C(d).ax.a===C.q?$.ib():$.pj(),t=A.bI(C.au)
...
x=J.ex(this.d)?new A.a1(M.N9,A.ae(A.a([A.aM(U.Or,A.C(d).ay,v,64),C.Z,A.H(A.YL("No news messages yet",v,v,v,v),v,v,v,v,v,v,v,v,C.b_,v,v,v,v)],y.p),C.j,C.bm,C.i,0,v,C.m),v):new A2.F0(new B.cn1(this),v)
w=A.hE()
return X.eX(t,u,new A.cg(C.aU,v,v,new A.cF(new A.ab(0,720,0,1/0),x,v),v),v,v,A.jy(R.a25(P.hz,S.r_,new B.cn2(this,d),v),w),v,v)}}
B.x9.prototype={
...
t=u.c
t.toString
if(G.yd(t,!1).f.gZ8()===C.b.di($.OG(),"news")){u.Mk()
...
w.push(A.ar(W.iU,A.H(u,q,q,q,q,q,q,q,o,q,q,q,q,q),C.k,q,q,q,q,q,q,q,D.avQ,q,q,q))}o=n.c
if(o==null)o=""
if(n.f){u=p.c
u.toString
...
w.push(new A.a1(A0.fn,A.H(o,q,q,q,q,q,q,q,u,q,q,q,q,q),q))
u=A.bs(10)
o=A.C(d)
t=n.b
t.toString
...
s=$.dB().gdn().c
w.push(new A.a1(C.rT,A.ar(q,A.ae(A.a([new A.a1(A3.aQ,t,q),A.jy(new A.a1(C.aq,A.aq(A.a([A.aM(D.az0,A.C(d).ay,q,16),I.qa,A.H(C.c.j(n.e),q,q,q,q,q,q,q,A.af(q,q,A.C(d).ay,q,q,q,q,q,q,q,q,q,q,q,C.U,q,q,!0,q,q,q,q,q,q,q,q),q,q,q,q,q),C.hh],x),C.j,C.dd,C.i,0,q),q),s!=null)],x),C.j,C.f,C.i,0,q,C.m),C.k,q,q,new A.b3(o.ax.k2,q,q,u,q,q,q,C.L),q,q,q,q,q,q,q,q),q))
if(A.hE())w.push(O.tV(q,q,q,D.aA9,new B.cmZ(),C.o,new B.cn_(p,n,d),C.aq,q,q,q,y.B))
...
case 5:A.bl(s,A.n("Message has been removed.",null),C.a4)
x=3
break
case 4:u=N.pI(A.w(["content",t.b],y.N,y.z),A.d6())
x=6
...
case 4:A.bl(v.b,A.n("Message has been changed.",null),C.a4)
case 3:return A.i(null,w)}})
return A.j($async$$1,w)},
$S:120}
B.cmZ.prototype={
$1(d){var x=y.B
return A.a([F.mp(E.bC(T.IC,null),!0,48,D.at1,x),F.mp(E.bC(D.bJv,null),!0,48,D.Mj,x)],y.h)},
$S:z+1}
B.cn2.prototype={
...
return{B:x("x9"),_:x("X<@>"),t:x("u<A<l,@>>"),o:x("u<vI>"),h:x("u<n4<x9>>"),p:x("u<e>"),a:x("A<l,@>"),x:x("vI"),P:x("aE"),K:x("K"),N:x("l"),g:x("kv"),z:x("@"),X:x("K?"),H:x("~")}})();(function constants(){D.Mj=new B.x9(0,"delete")
D.at1=new B.x9(1,"edit")
D.avQ=new A.aj(16,8,16,0)
D.az0=new A.az(58652,"MaterialIcons",null,!1)
D.aA9=new A.cV(Q.Oh,null,null,null,null)
D.bJv=new A.cx("Delete",null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_305",e:"endPart",h:b})})($__dart_deferred_initializers__,"GG70jPi0DReR1BlL/JVWHLrSHn4=");