...
class _EventPageState extends State<EventPage> {
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                  Visibility(visible: showLoginLogoutButton() && !_participants.any((p)=>DataService.currentUserEmail()==p.email),
                      child: ElevatedButton(onPressed: () => signIn(), child: const Text("Přihlásit se"))),
                  Visibility(visible: showLoginLogoutButton() && _participants.any((p)=>DataService.currentUserEmail()==p.email),
                      child: ElevatedButton(onPressed: () => signOut(), child: const Text("Odhlásit se"))),
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: ElevatedButton(onPressed: () async {
                        ...
                        _queriedParticipants.removeWhere((q) => _participants.any((p) => p.email == q.email));
                        ...
                        showSearch(
                          ...
                          delegate: SearchPage<ParticipantModel>(
                            ...
                            suggestion: const Center(
                              child: Text("Najdi účastníka podle jména, příjmení nebo e-mailu."),
                            ),
                            ...
                            builder: (person) => ListTile(
                              ...
                              trailing: Column(
                                ...
                                children: [
                                  ElevatedButton(onPressed: () => signIn(person.email), child: const Text("Přihlásit")),
                                  Text(person.email),
                                ],
                              ),
                            ),
          ...
          Visibility(
              visible: DataService.isLoggedIn() && _event.maxParticipants != null,
              child: Container(alignment: Alignment.topLeft, padding: const EdgeInsets.all(8.0), child: const Text("Přihlášeni:"))),
          Expanded(
            ...
            itemBuilder: (BuildContext context, int index) {
              return Padding(
                ...
                child: Row(
                  children: [
                    IconButton(onPressed: () => signOutOther(_participants[index]), icon: const Icon(Icons.remove_circle_outline)),
  ...
  Future<void> signIn([String? email]) async {
    await DataService.signInToEvent(eventId, email);
    await loadData();
  }
