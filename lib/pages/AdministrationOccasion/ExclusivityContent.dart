...
class _ExclusivityContentState extends State<ExclusivityContent> {
  ...
  Widget build(BuildContext context) {
    return SingleTableDataGrid<ExclusiveGroupModel>(
      context,
      DbEvents.getAllExclusiveGroups, // Fetch exclusive groups
      ExclusiveGroupModel.fromPlutoJson, // Map JSON to ExclusiveGroupModel
      DataGridFirstColumn.delete, // Enable delete functionality for rows
