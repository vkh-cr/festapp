...
class ThemeConfig {
  ...
  static final fontFamily = "Cerebri-Sans";
  static ThemeData baseTheme() => ThemeData(
      ...
      colorScheme: ColorScheme.fromSwatch(
        ...
        surface: lllPrimary.changeColorSaturation(0.14).changeColorLightness(0.84),
  ...
  static Color logoBackgroundColor(BuildContext context) => isDarkMode(context) ? seed2 : seed2;
