...
class SingleTableDataGrid<T extends IPlutoRowModel> {
  ...
  SingleTableDataGrid(this.loadData, this.fromPlutoJson, {required this.columns, this.headerChildren});
  ...
  DataGrid() {
    return Container(
      ...
      child: Container(
        ...
        createHeader: (stateManager) => AdministrationHeader(stateManager: stateManager, fromPlutoJson: fromPlutoJson, loadData: reloadData, headerChildren: headerChildren,),
