...
class FeatureMetadata {
  static Map<String, Map<String, String>> _rawMetadata() => {
        ...
        FeatureConstants.form: {
          'title': 'Form'.tr(),
          'description':
              'Allows creating a form to reserve one or more seats at an event.'
                  .tr(),
        },
        FeatureConstants.companions: {
          'title': 'Companions'.tr(),
          'description':
              'Allows adding companions (partner, child, or friend without a phone) and signing them up for workshops.'
                  .tr(),
        },
        FeatureConstants.songbook: {
          'title': 'Songbook'.tr(),
          'description':
              'Displays a songbook and allows adding custom songs.'.tr(),
        },
        FeatureConstants.game: {
          'title': 'Game'.tr(),
          'description':
              'Allows defining teams, stations, and playing a game where team members enter a code to complete a station.'
                  .tr(),
        },
        FeatureConstants.userGroups: {
          'title': 'Groups'.tr(),
          'description':
              'Allows creating groups and scheduling meetings for them.'.tr(),
        },
        ...
        FeatureConstants.entryCode: {
          'title': 'Entry Code'.tr(),
          'description':
              'It is possible to verify users via QR code on workshops or other limited events.'
                  .tr(),
        },
        FeatureConstants.blueprint: {
          'title': 'Blueprint'.tr(),
          'description':
              'This feature lets you create a seating blueprint with a limited number of seats for the reservation form. For example, you can design a seating chart for a bus or a layout of a hall with assigned seats.'
                  .tr(),
        },
        ...
        FeatureConstants.workshops: {
          'title': 'Workshops'.tr(),
          'description':
              'Indicates the start time from when people can sign in for workshops.'
                  .tr(),
        },
        ScheduleFeature.metaSchedule: {
          'title': 'Schedule'.tr(),
          'description':
              'Allows customizing event schedule display settings.'.tr(),
        },
