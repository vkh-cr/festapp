...
class PlaceModel extends ITrinaRowModel {
  ...
  factory PlaceModel.fromJson(Map<String, dynamic> json) {
    return PlaceModel(
      ...
      description: json.containsKey(Tb.places.description)
          ? json[Tb.places.description]
          : null,
      type: json.containsKey(Tb.places.type) ? json[Tb.places.type] : null,
      isHidden: json.containsKey(Tb.places.is_hidden)
          ? json[Tb.places.is_hidden]
          : false,
  ...
  static PlaceModel fromPlutoJson(Map<String, dynamic> json) {
    return PlaceModel(
        ...
        description: json[Tb.places.description].isEmpty
            ...
            : json[Tb.places.description],
        type:
            json[Tb.places.type] == WithoutValue ? null : json[Tb.places.type],
  ...
  TrinaRow toTrinaRow(BuildContext context) {
    return TrinaRow(cells: {
      ...
      Tb.places.type: TrinaCell(value: type ?? WithoutValue),
