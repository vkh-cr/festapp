    ...
    this.oldPoint,
        ...
        child: showTitle
          ...
          children: [
            ...
            Positioned(
              top: 0, // Adjust as needed for vertical alignment with the pin
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: ThemeConfig.whiteColor(context)
                          .withOpacity(0.85), // Slightly transparent background
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          foreground: Paint()
                            ...
                            ..color = ThemeConfig.whiteColor(context), // Outline color
                        ),
                      ),
                      // Fill text
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          decoration: TextDecoration.none,
                          color: ThemeConfig.blackColor(context), // Fill color
                        ),
                      ),
                    ],
                  ),
