import 'package:fstapp/components/users/user_info_model.dart'
    as mailer_send_helper;

class MailerSendHelper {
  static Future<void> sendPassword(
      mailer_send_helper.UserInfoModel recipient, String password) async {
    ...
    //ToastHelper.Show(CommonStrings.credentialsEmailSent(email: recipient.email!));
    await Future.delayed(const Duration(milliseconds: 6000));
  }

  static List<Map<String, String>> _getSalutationPresalutation(
      mailer_send_helper.UserInfoModel user) {
    var presalutation = {
      "var": "presalutation",
      "value": user.sex == "male" ? "Milý" : "Milá"
    };
    var register = {
      "var": "register",
      "value": user.sex == "male" ? "registroval" : "registrovala"
    };
