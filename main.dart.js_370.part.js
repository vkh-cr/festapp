...
cFY(d,e,f){var x,w,v,u,t,s,r,q=C.cBu(d,e),p=new C.a39(A.a([],y.t))
...
r=s+1
p.qi(0,(s&1)===0?236:17,8)}return C.d6F(p,q)},
d6F(d,e){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h=y.T,g=A.bN(e.length,null,!1,h),f=A.bN(e.length,null,!1,h)
...
d76(d){var x,w=y.t,v=C.awP(A.a([1],w),0)
...
d8m(d){var x,w,v,u,t,s,r,q,p,o,n,m,l,k=d.a
...
_.d=g
_.e=h},
cBu(d,e){var x,w,v,u,t,s,r=C.d7G(d,e),q=r.length/3|0,p=A.a([],y.y)
for(x=0;x<q;++x){w=x*3
v=r[w]
u=r[w+1]
t=r[w+2]
...
_.at=m
_.a=n},
c4Q:function c4Q(d,e,f){var _=this
_.a=d
_.b=e
_.c=f
_.f=_.e=_.d=$},
...
awN:function awN(){},
awM:function awM(){},
cYG(d,e,f){var x,w,v,u,t,s=A.bO("qrCode")
try{if(f!==-1){s.shF(C.cBs(f,e))
v=s.aD()
u=D.bU.cO(d)
v.e.push(new C.QQ(u))
v.d=null}else{v=C.cBs(C.cYE(e,A.a([new C.QQ(D.bU.cO(d))],y.v)),e)
v.e.push(new C.QQ(D.bU.cO(d)))
v.d=null
s.shF(v)}v=s.aD()
...
return w},
d6H(){var x,w=new Uint8Array(256)
for(x=0;x<255;++x)w[$.aVr()[x]]=x
return w},
d9P(d){var x,w=d<<10>>>0
for(x=w;C.LO(x)-C.LO(1335)>=0;)x=(x^D.c.eS(1335,C.LO(x)-C.LO(1335)))>>>0
return((w|x)^21522)>>>0},
d9Q(d){var x,w=d<<12>>>0
for(x=w;C.LO(x)-C.LO(7973)>=0;)x=(x^D.c.eS(7973,C.LO(x)-C.LO(7973)))>>>0
return(w|x)>>>0},
LO(d){var x
for(x=0;d!==0;){++x
...
w.a=new A.aJ(x,y.z)
A0.fv(x,x,!0,x,new C.ch2(w,e,f,g),d,x,!0,!1,y.B)},
A(d){var x,w,v,u,t,s=this,r=null,q=y.p,p=A.a([A.c1(r,r,r,r,r,r,A.bq(Ao.jc,r,r,r),r,r,r,new C.chb(d),r,r,r,r,r)],q),o=E.bc(B.b3T,r)
o=M.ic(p,r,r,!0,r,r,1,!0,r,r,!1,r,!1,r,r,A7.ts(new C.chc(d)),r,!0,r,r,r,r,r,o,r,r,r,1,r)
x=A.a([B.a3I],q)
if(A.h1("entry_code",r))x.push(A.az(r,T.b_c(d,U.Je,A.r("Show my code",r),new C.chd(s,d)),D.k,r,r,r,r,r,r,S.zw,r,r,r))
...
x.push(A.az(r,Z.lp(!0,r,new C.che(s),w+1,r,r,Ad.dO,!1,D.G,!0),D.k,r,r,new A.bn(r,r,new A.eN(D.w,D.w,new A.b5(D.cM,1,D.B,-1),D.w),r,r,r,r,D.P),r,r,r,S.zw,r,r,r))}x.push(B.a3I)
w=A.r("Name",r)
v=s.d
u=r
if(v==null)v=u
...
if(A.h1("services",r)){w=E.bc(B.b4p,r)
v=s.d
u=v==null
t=(u?r:v.z)==null?r:new C.chf(s,d)
...
v.toString
v=A2.rf(A.aw(A.a([Al.Jq,Q.lD,A.W(v,r,r,r,r,r,r,r,N.lH,r,r,r,r,r),Q.lD],q),D.i,D.f,D.h,0,r),r)}x.push(new A.a3(Y.bj,A.am(A.a([w,A9.fF,A.az(H.ek,A.dg(!1,v,r,r,r,r,r,r,t,r,r),D.k,r,r,r,r,r,r,r,r,r,r)],q),D.bh,D.f,D.h,r,D.l),r))}x.push(V.a3)
q=!0
if(!A.j0())if(!A.i8())if(!P.bvs()){q=$.m7
q=q===!0}x.push(A.iw(W.ME(r,d,50,!0,A.r("Event management",r),new C.chg(s),D.p,250),q))
x.push(V.a3)
x.push(W.ME(D.ck,d,50,!0,A.r("Sign out",r),new C.chh(s),D.n,250))
x.push(A3.ef)
x.push(A.az(D.aF,A.dg(!1,E.bc(A.W(A.r("Change password",r),r,r,r,r,r,r,r,A.aC(r,r,r,r,r,r,r,r,r,r,r,18,r,r,r,r,r,!0,r,r,r,r,r,r,r,r),r,r,r,r,r),r),r,r,r,r,r,r,new C.chi(s,d),r,r),D.k,r,r,r,r,r,r,r,r,r,r))
x.push(Ap.ak)
x.push(A.az(D.aF,A.dg(!1,E.bc(A.W(A.r("Delete account",r),r,r,r,r,r,r,r,A.aC(r,r,r,r,r,r,r,r,r,r,r,18,r,r,r,r,r,!0,r,r,r,r,r,r,r,r),r,r,r,r,r),r),r,r,r,r,r,r,new C.chj(d),r,r),D.k,r,r,r,r,r,r,r,r,r,r))
return L.f2(o,r,new A.cy(D.aF,r,r,new A.cP(new A.a9(0,820,0,1/0),A8.dO(A.am(x,D.i,D.f,D.h,r,D.l),r,D.r,r,r,r,D.G),r),r),r,r,r,r,r)},
aT(){this.c6()
if($.dZ().gdD().d==null){var x=this.c
x.toString
F.k8(x,"login",y.X)}this.ba()},
X3(d,e){var x=null,w=A.a([],y.J),v=$.a8()
return new A.a3(Y.bj,I.h8(!0,D.aU,!1,x,!0,D.y,x,I.hC(),x,x,x,x,x,x,2,I.cv(x,x,x,B.aiY,x,x,x,x,!0,x,x,x,x,x,x,x,x,x,K.zV,x,x,x,x,x,x,x,x,x,x,B.b0t,e,x,x,x,x,x,x,x,x,d,!0,x,x,x,x,x,x,x,x,x,x,x,x,x),D.r,!0,x,!0,x,!1,new C.ahQ(!1,!0,!0,!0,x,x,w,v),H.aV,x,x,x,x,x,x,x,1,x,x,!1,"\u2022",x,x,x,x,x,!1,x,x,!0,x,!0,x,K.b6,x,x,D.aR,D.aL,x,x,x,x,x,x,x,!0,D.F,x,K.b9,x,x,x,x),x)},
...
bhz(){var x=this.c
x.toString
F.k8(x,"admin",y.X).aX(0,new C.ch_(this),y.H)},
ba(){var x=0,w=A.k(y.H),v=this,u
var $async$ba=A.f(function(d,e){if(d===1)return A.h(e,w)
while(true)switch(x){case 0:v.jt()
x=2
return A.c(A.Az(),$async$ba)
case 2:u=e
x=3
return A.c(A.CB("user_info",u,null),$async$ba)
case 3:x=4
return A.c(v.MY(u),$async$ba)
case 4:v.B(new C.chl(v,u))
return A.i(null,w)}})
...
MY(d){return this.bqc(d)},
bqc(d){var x=0,w=A.k(y.H),v,u
var $async$MY=A.f(function(e,f){if(e===1)return A.h(f,w)
while(true)switch(x){case 0:x=2
return A.c(Ac.mS("events",A.Bi(),y.l),$async$MY)
case 2:u=f
if(d!=null){v=d.ch
if(v!=null)J.ib(v,new C.ch5(u))}return A.i(null,w)}})
...
u[t]=(t&1)===0}},
bko(d,e){var x,w,v,u,t,s,r=C.d9P((this.c<<3|d)>>>0)
...
bkp(d){var x,w,v,u,t,s=C.d9Q(this.b)
...
Yl(d,e){return d===B.wg?D.b.gT(this.a):this.b.i(0,this.ajt(d,e))},
byK(d){return this.Yl(d,null)}}
C.a3a.prototype={
M(){return new C.aN1()}}
C.aN1.prototype={
A(d){var x=this,w=x.a
w=x.e=C.cYG(w.c,1,w.f)
x.d=w.a===B.Cf?w.b:null
return new A.hw(new C.c62(x),null)},
...
b0n(d,e,f){var x,w=null,v=this.a
v.toString
...
k=x.gd0(x)
a1=x.gb4(x)
a3.uU(x,D.M.OO(new A.R(k,a1),new A.a0(0,0,k,a1)),D.M.OO(a0,new A.a0(t,q,t+w,q+s)),g)}},
b94(d,e,f){var x,w=e+1
if(w>=f)return!1
x=this.y
x===$&&A.b()
return x.ke(w,d)},
b93(d,e,f){var x,w=d+1
if(w>=f)return!1
x=this.y
x===$&&A.b()
return x.ke(e,w)},
...
biR(d,e,f){var x=0.25*d.giJ()/e.gabZ()
...
var z=a.updateTypes([])
C.ch2.prototype={
$1(d){var x=this,w=null,v=A.c1(w,w,w,w,w,w,A.bq(A1.hK,D.p,w,w),w,w,w,new C.ch0(d),w,w,w,w,w),u=y.p,t=A.a([],u),s=x.a,r=x.b
t.push(new A.a3(Ae.dz,A.c1(w,w,w,w,w,w,A.bq(B.ali,A.C(d).ax.a===D.t?$.dF():D.p,w,w),w,w,w,new C.ch1(s,r),w,w,w,w,w),w))
return L.f2(M.ic(t,w,w,!0,D.E,w,1,w,w,0,!1,w,!1,w,w,v,w,!0,w,w,w,w,w,w,w,w,w,1,w),D.n,A.bS(new C.a4q(A.az(w,A.am(A.a([G.dm,A.W("["+x.c+"]",w,w,w,w,w,w,w,B.a4q,w,w,w,w,w),G.dm,new C.a3a(x.d,-1,250,w),G.dm,A.W("["+r+"]",w,w,w,w,w,w,w,B.a4q,w,w,w,w,w),G.dm],u),D.i,D.bq,D.W,w,D.l),D.k,D.n,w,w,w,w,w,w,w,w,w),s,w),w,w),w,w,w,w,w)},
$S:977}
C.ch0.prototype={
...
if(e===0)return A_.rj(!1,o,o,o,!0,o,o,!0,!1,o,o,o,o,!1,o,o,o,o,o,E.bc(A.W("Companions",o,o,o,o,o,o,o,A.aC(o,o,A.C(d).ax.a===D.t?$.dF():D.p,o,o,o,o,o,o,o,o,o,o,o,D.a4,o,o,!0,o,o,o,o,o,o,o,o),o,o,o,o,o),o),o,o)
x=this.a
w=x.d
if(w==null)v=o
else{w=w.ch
...
s=T.b_c(d,U.Je,A.r("Show Code",o),new C.ch8(x,d,v))
q=Ai.crd(v.e,d)
p=y.p
return new A.a3(Ab.e3,A.am(A.a([A6.hi,A.az(o,A4.Gz(A.a([B.aYn,new A.cP(B.a9d,Aj.cqy(A.bS(E.bc(A.W("Companion's events will appear here.",o,o,o,o,o,o,o,A.aC(o,o,Aq.wN(d),o,o,o,o,o,o,o,o,o,o,o,o,o,o,!0,o,o,o,o,o,o,o,o),o,o,o,o,o),o),o,o),q,0.3,o,new C.ch9(x,d),o,o),o),A5.a3J,A.am(A.a([A.dg(!1,E.bc(A.W("Delete companion",o,o,o,o,o,o,o,o,o,o,o,o,o),o),o,o,o,o,o,o,new C.cha(x,d,v),o,o)],p),D.i,D.bq,D.h,o,D.l)],p),o,D.i,!1,o,H.oq,r,t,s),D.k,o,o,new A.bn(w,o,o,u,o,o,o,D.P),o,o,o,o,o,o,o)],p),D.i,D.f,D.h,o,D.l),o)},
$S:58}
C.ch8.prototype={
$0(){var x=this.c
...
x=2
return A.c(F.k8(v.b,"event/"+d,y.X).aX(0,new C.ch6(u),y.H),$async$$1)
case 2:x=3
...
t.toString
x=5
return A.c(Am.aiz(J.v(t,"email")).aX(0,new C.ch7(u,s),y.P),$async$$0)
...
C.ch5.prototype={
$1(d){var x,w,v,u,t,s
for(x=d.c,w=x.length,v=this.a,u=d.d,t=0;t<x.length;x.length===w||(0,A.Q)(x),++t){s=A.ee(v,new C.ch3(x[t]))
if(s!=null)u.push(s)}D.b.I(d.e,new A.O(u,new C.ch4(),A.X(u).h("O<1,dD>")))},
$S:979}
C.ch3.prototype={
...
u.toString
x=y.N
return new Ag.dD(w,v,Ah.jR,A.y(["leftText",d.aah(),"rightText",d.j(0)],x,x),u,null,null)},
$S:66}
C.bKS.prototype={
$1(d){var x,w,v=this
...
v===$&&A.b()
if(v.a!==B.Cf)return w.b0n(d,e,v.c)
x=w.a.x
w=w.bgV(null,x)
return w},
$S:94}
...
v(A.F,[C.Ek,C.a3a,C.a4q])
v(A.K,[C.aS5,C.aN1,C.aOF])
v(A.bC,[C.ch2,C.ch9,C.ch6,C.ch7,C.ch_,C.ch5,C.ch3,C.ch4,C.bKS])
v(A.ck,[C.ch0,C.ch1,C.chb,C.chc,C.chd,C.ch8,C.cha,C.chf,C.chg,C.chh,C.chi,C.chj,C.chl,C.chk,C.bwZ,C.bwY])
v(A.dv,[C.che,C.c62])
u(C.ahQ,A.fy)
v(A.e4,[C.bh2,C.IU,C.Oq,C.bst,C.bss,C.a3d])
v(A.E,[C.aN0,C.QQ,C.a0h,C.bsu,C.bsr,C.awO,C.awQ,C.bqv,C.c4Q,C.awN,C.awM,C.a3c,C.bwX])
u(C.a39,C.aN0)
u(C.aca,A.a7)
u(C.a3b,A.nu)
u(C.ayF,C.aOF)
x(C.aN0,A.a1)
w(C.aOF,A.ex)})()
A.bl(b.typeUniverse,JSON.parse('{"Ek":{"F":[],"d":[]},"aS5":{"K":["Ek"]},"ahQ":{"fy":[],"aq":[]},"a39":{"a1":["x"],"A":["x"],"aS":["x"],"w":["x"],"a1.E":"x","w.E":"x"},"QQ":{"cBt":[]},"a0h":{"bk":[]},"a3a":{"F":[],"d":[]},"aN1":{"K":["a3a"]},"aca":{"a7":[],"d":[]},"a3b":{"aq":[]},"a4q":{"F":[],"d":[]},"ayF":{"K":["a4q"]}}'))
var y=(function rtii(){var x=A.z
return{l:x("dB"),L:x("bk"),I:x("U<ez?>"),x:x("OS"),J:x("q<fy>"),S:x("q<A<t>>"),Q:x("q<A<x?>>"),q:x("q<CH>"),v:x("q<cBt>"),y:x("q<awQ>"),s:x("q<e>"),p:x("q<d>"),t:x("q<t>"),z:x("aJ<K<F>>"),w:x("fr"),P:x("aB"),o:x("rs"),Z:x("CH"),A:x("a3L"),N:x("e"),U:x("ej"),E:x("aa2<cA>"),B:x("@"),b:x("ez?"),n:x("OS?"),T:x("A<t>?"),X:x("E?"),K:x("dR?"),u:x("x?"),H:x("~")}})();(function constants(){var x=a.makeConstList
...
B.zT=new C.Oq(0,"topLeft")
B.IG=new C.Oq(1,"topRight")
B.zU=new C.Oq(2,"bottomLeft")
B.ali=new A.aE(57857,"MaterialIcons",null,!1)
B.anx=new C.bh2(4,"png")
B.aoL=A.a(x([B.zT,B.IG,B.zU]),A.z("q<Oq>"))
...
B.a1Y=new C.IU(0,"finderPatternOuter")
B.a1Z=new C.IU(1,"finderPatternInner")
B.a2_=new C.IU(2,"finderPatternDot")
B.wg=new C.IU(3,"codePixel")
B.aTU=new C.IU(4,"codePixelEmpty")
...
x($,"dmR","aVr",()=>C.d6G())})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_370",e:"endPart",h:b})})($__dart_deferred_initializers__,"TqUhBft4mB0Px4yKXDacuIEYO88=");