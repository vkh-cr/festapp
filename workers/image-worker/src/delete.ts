...
import { extractBearerToken, checkEditorPermission, checkUnitEditorPermission, resolveSupabaseAuth } from './auth';
...
export async function handleDelete(
  ...
  // Validate key starts with images/ to prevent deleting non-image files
