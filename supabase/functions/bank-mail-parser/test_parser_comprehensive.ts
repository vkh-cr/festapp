...
Deno.test("Parse FIO Bank Email", () => {
  ...
  assertEquals(result.movementId, null);
  assertEquals(result.bankCommandId, "111122223333");
...
Deno.test("Parse Air Bank Email (Comprehensive)", () => {
  ...
  assertEquals(result.movementId, "148260288562");
...
Deno.test("Detect Provider", () => {
  ...
  assertEquals(
    detectProvider("CZ1230300000000000001234", null),
    "airbank_email",
  );
