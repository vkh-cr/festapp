 ...
 */
export async function getTicketOrderPaidTemplate(reqData: any, authorizationHeader: string) {
  ...
  if (isFullyPaid) {
    ...
    try {
      ...
      console.error(`Could not generate QR code for order ${orderId}:`, error.message);
    }
  }
