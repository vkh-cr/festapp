...
cYy(){return new C.Ee(null)},
Ee:function Ee(d){this.a=d},
aR2:function aR2(){this.c=this.a=this.d=null},
...
awK(d,e){var x,w,v=d.length,u=0
while(!0){if(!(u<v&&d[u]===0))break;++u}v-=u
x=new Uint8Array(v+e)
for(w=0;w<v;++w)x[w]=d[w+u]
return new C.bsY(x)},
bsY:function bsY(d){this.a=d},
cxF(d,e){var x=A.a([],y.v)
A.Qw(d,1,40,"typeNumber")
A.bfU(e,4,B.ap_,null,"errorCorrectLevel")
return new C.bsV(d,e,d*4+17,x)},
cUS(d,e){var x,w,v,u,t,s,r,q
for(x=y.t,w=1;w<40;++w){v=C.cxH(w,d)
u=new C.a3f(A.a([],x))
for(t=v.length,s=0,r=0;r<t;++r)s+=v[r].b
for(r=0;r<1;++r){q=e[r]
u.qc(0,4,4)
u.qc(0,q.b.length,C.cCx(4,w))
q.jt(0,u)}if(u.b<=s*8)break}return w},
cBQ(d,e,f){var x,w,v,u,t,s,r,q=C.cxH(d,e),p=new C.a3f(A.a([],y.t))
for(x=0;x<f.length;++x){w=f[x]
p.qc(0,4,4)
p.qc(0,w.b.length,C.cCx(4,d))
w.jt(0,p)}for(v=q.length,u=0,x=0;x<v;++x)u+=q[x].b
t=u*8
v=p.b
if(v>t)throw A.f(new C.a_I("Input too long. "+v+" > "+t))
if(v+4<=t)p.qc(0,0,4)
for(;D.c.ap(p.b,8)!==0;)p.aDR(!1)
for(s=0;!0;s=r){if(p.b>=t)break
r=s+1
p.qc(0,(s&1)===0?236:17,8)}return C.d2v(p,q)},
d2v(d,e){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h=y.T,g=A.bH(e.length,null,!1,h),f=A.bH(e.length,null,!1,h)
...
d2X(d){var x,w=y.t,v=C.awK(A.a([1],w),0)
for(x=0;x<d;++x)v=v.iv(0,C.awK(A.a([1,$.aUn()[D.c.ap(x,255)]],w),0))
return v},
...
_.d=null
_.e=g},
cUT(d){var x,w,v,u,t,s,r,q,p,o,n
for(x=y.Q,w=d.c,v=d.a,u=d.b,t=d.e,s=0,r=null,q=0;q<8;++q){p=new C.awJ(w,v,u,q,A.a([],x))
o=d.d
p.aoW(q,o==null?d.d=C.cBQ(v,u,t):o,!0)
n=C.d4d(p)
if(q===0||s>n){r=p
s=n}}t=r.d
x=new C.awJ(w,v,u,t,A.a([],x))
x.aoW(t,d.gbvL(),!1)
return x},
d4i(d,e,f){var x
...
d4d(d){var x,w,v,u,t,s,r,q,p,o,n,m,l,k=d.a
...
_.d=g
_.e=h},
cxH(d,e){var x,w,v,u,t,s,r=C.d3w(d,e),q=r.length/3|0,p=A.a([],y.y)
for(x=0;x<q;++x){w=x*3
v=r[w]
u=r[w+1]
t=r[w+2]
for(s=0;s<v;++s)p.push(new C.awL(u,t))}return p},
d3w(d,e){var x
...
awI:function awI(){},
awH:function awH(){},
cUU(d,e,f){var x,w,v,u,t,s=A.bM("qrCode")
try{if(f!==-1){s.shF(C.cxF(f,e))
v=s.aA()
u=D.bK.cz(d)
v.e.push(new C.Qs(u))
v.d=null}else{v=C.cxF(C.cUS(e,A.a([new C.Qs(D.bK.cz(d))],y.v)),e)
v.e.push(new C.Qs(D.bK.cz(d)))
v.d=null
s.shF(v)}v=s.aA()
return new C.a3i(B.C5,v,null)}catch(t){v=A.af(t)
if(v instanceof C.a_I){x=v
return new C.a3i(B.aUd,null,x)}else if(y.L.b(v)){w=v
return new C.a3i(B.aUe,null,w)}else throw t}},
...
_.c=_.a=null},
aO0:function aO0(){},
agb(d){var x=0,w=A.l(y.x),v,u,t
var $async$agb=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:x=3
return A.c(A.ye(d),$async$agb)
case 3:t=f
$.km.toString
x=5
return A.c(A.age(t,null),$async$agb)
case 5:x=4
return A.c(f.m2(),$async$agb)
case 4:u=f
v=u.gfm(u)
x=1
break
...
while(true)switch(x){case 0:x=2
return A.c(A.aua().vv(0,D.iU),$async$VS)
case 2:x=3
return A.c(C.auq(),$async$VS)
case 3:x=4
return A.c($.e1().gdH().EF(D.a3g),$async$VS)
case 4:D.lW.XA(0,"refresh")
$.mo=null
return A.j(null,w)}})
return A.k($async$VS,w)},
auq(){var x=0,w=A.l(y.H)
var $async$auq=A.h(function(d,e){if(d===1)return A.i(e,w)
while(true)switch(x){case 0:x=2
return A.c(A.a1C("user_info"),$async$auq)
case 2:x=3
return A.c(A.a1C("mySchedule"),$async$auq)
case 3:return A.j(null,w)}})
return A.k($async$auq,w)},
cE4(d){return d>=1?$.aUs()[d]:A.a5(A.ce("glog("+d+")",null))},
d2w(){var x,w=new Uint8Array(256)
for(x=0;x<8;++x)w[x]=D.c.eq(1,x)
for(x=8;x<256;++x)w[x]=w[x-4]^w[x-5]^w[x-6]^w[x-8]
return w},
d2x(){var x,w=new Uint8Array(256)
for(x=0;x<255;++x)w[$.aUn()[x]]=x
return w},
d5G(d){var x,w=d<<10>>>0
for(x=w;C.Lm(x)-C.Lm(1335)>=0;)x=(x^D.c.eQ(1335,C.Lm(x)-C.Lm(1335)))>>>0
return((w|x)^21522)>>>0},
d5H(d){var x,w=d<<12>>>0
...
A(d){var x,w,v,u,t,s=this,r=null,q=y.p,p=A.a([A.ch(r,r,r,r,r,A.bN(Ap.mH,r,r,r),r,r,r,new C.cdh(d),r,r,r,r,r)],q),o=E.bo(B.b4d,r)
o=M.i4(p,r,r,!0,r,r,1,!0,r,r,!1,r,!1,r,r,A6.tg(new C.cdi(d)),r,!0,r,r,r,r,r,o,r,r,r,1,r)
x=A.a([B.a3N],q)
if(A.jw("entry_code",r))x.push(A.aJ(r,R.aZ3(d,S.J7,A.w("Show my code",r),new C.cdj(s,d)),D.k,r,r,r,r,r,r,Q.zd,r,r,r))
...
x.push(A.aJ(r,A0.lf(!0,r,new C.cdk(s),w+1,r,r,Ad.dj,!1,D.F,!0),D.k,r,r,new A.bD(r,r,new A.eO(D.x,D.x,new A.b9(D.df,1,D.E,-1),D.x),r,r,r,r,D.Q),r,r,r,Q.zd,r,r,r))}x.push(B.a3N)
w=A.w("Name",r)
v=s.d
u=r
if(v==null)v=u
...
v.toString
v=J.u(v,"name")}}x.push(s.X5(w,v==null?"":v))
w=A.w("Surname",r)
v=s.d
u=r
if(v==null)v=u
...
v.toString
v=J.u(v,"surname")}}x.push(s.X5(w,v==null?"":v))
w=A.w("E-mail",r)
v=s.d
u=r
if(v==null)v=u
...
v.toString
v=J.u(v,"email")}}x.push(s.X5(w,v==null?"":v))
w=A.w("I am",r)
v=s.d
u=r
if(v==null)v=u
...
v.toString
v=J.u(v,"sex")}}x.push(s.X5(w,A9.cnz(v)))
v=E.bo(B.b4J,r)
w=s.d
u=w==null
...
w.toString
w=Z.r2(A.aH(A.a([Am.Ji,O.nD,A.Y(w,r,r,r,r,r,r,r,L.lC,r,r,r,r,r),O.nD],q),D.j,D.f,D.h,r),r)}x.push(new A.a6(X.bq,A.ax(A.a([v,A8.it,A.aJ(I.ej,A.de(!1,w,r,r,r,r,r,r,t,r,r),D.k,r,r,r,r,r,r,r,r,r,r)],q),D.bx,D.f,D.h,r,D.p),r))
x.push(T.ai)
q=!0
if(!A.iV())if(!A.i_())if(!Ab.bvT()){q=$.lZ
q=q===!0}x.push(A.ij(V.Mb(r,d,50,!0,A.w("Event management",r),new C.cdm(s),D.q,250),q))
x.push(T.ai)
x.push(V.Mb(D.cp,d,50,!0,A.w("Sign out",r),new C.cdn(s),D.m,250))
x.push(A1.fy)
x.push(A.aJ(D.aI,A.de(!1,E.bo(A.Y(A.w("Change password",r),r,r,r,r,r,r,r,A.aN(r,r,r,r,r,r,r,r,r,r,r,18,r,r,r,r,r,!0,r,r,r,r,r,r,r,r),r,r,r,r,r),r),r,r,r,r,r,r,new C.cdo(s,d),r,r),D.k,r,r,r,r,r,r,r,r,r,r))
x.push(Aq.aP)
x.push(A.aJ(D.aI,A.de(!1,E.bo(A.Y(A.w("Delete account",r),r,r,r,r,r,r,r,A.aN(r,r,r,r,r,r,r,r,r,r,r,18,r,r,r,r,r,!0,r,r,r,r,r,r,r,r),r,r,r,r,r),r),r,r,r,r,r,r,new C.cdp(d),r,r),D.k,r,r,r,r,r,r,r,r,r,r))
...
X5(d,e){var x=null,w=A.a([],y.J),v=$.ae()
return new A.a6(X.bq,H.i0(!0,D.b4,!1,x,!0,D.z,x,H.iK(),x,x,x,x,x,x,2,H.e8(x,x,x,B.aiL,x,x,x,x,!0,x,x,x,x,x,x,x,x,x,Ac.zC,x,x,x,x,x,x,x,x,x,x,B.b0O,e,x,x,x,x,x,x,x,x,d,!0,x,x,x,x,x,x,x,x,x,x,x,x,x),D.u,!0,x,!0,x,!1,new C.ahb(!1,!0,!0,!0,x,x,w,v),I.b7,x,x,x,x,x,x,x,1,x,x,!1,"\u2022",x,x,x,x,x,!1,x,x,!0,x,!0,x,U.bk,x,x,D.b1,D.aX,x,x,x,x,x,x,x,!0,D.P,x,U.bo,x,x,x,x),x)},
...
bi5(){var x=this.c
x.toString
F.kp(x,"admin",y.X).aQ(0,new C.cd5(this),y.H)},
...
while(true)switch(x){case 0:x=2
return A.c(A.oS("user_info",A.a70(),null,y.U),$async$jp)
case 2:u=e
v.N2(u)
v.B(new C.cdq(v,u))
return A.j(null,w)}})
...
case 2:u=f
if(d!=null){v=d.ay
if(v!=null)J.i2(v,new C.cdb(u))}return A.j(null,w)}})
...
qc(d,e,f){var x
for(x=0;x<f;++x)this.aDR((D.c.nW(e,f-x-1)&1)===1)},
aDR(d){var x=this,w=D.c.b7(x.b,8),v=x.a
...
jt(d,e){var x,w,v
for(x=this.b,w=x.length,v=0;v<w;++v)e.qc(0,x[v],8)},
$icxG:1}
C.a_I.prototype={
...
u=n[v]
t=r[x]
t=t>=1?$.aUs()[t]:A.a5(A.ce("glog("+t+")",null))
s=p[w]
s=s>=1?$.aUs()[s]:A.a5(A.ce("glog("+s+")",null))
n[v]=(u^$.aUn()[D.c.ap(t+s,255)])>>>0}return C.awK(n,0)},
aCi(d){var x,w,v,u=this.a,t=u.length,s=d.a,r=s.length
if(t-r<0)return this
x=C.cE4(u[0])-C.cE4(s[0])
w=new Uint8Array(t)
for(v=0;v<t;++v)w[v]=u[v]
for(v=0;v<r;++v){u=w[v]
t=s[v]
t=t>=1?$.aUs()[t]:A.a5(A.ce("glog("+t+")",null))
w[v]=(u^$.aUn()[D.c.ap(t+x,255)])>>>0}return C.awK(w,0).aCi(d)}}
C.bsV.prototype={
gbvL(){var x=this,w=x.d
return w==null?x.d=C.cBQ(x.a,x.b,x.e):w}}
C.awJ.prototype={
...
u[t]=(t&1)===0}},
bkW(d,e){var x,w,v,u,t,s,r=C.d5G((this.c<<3|d)>>>0)
...
bkX(d){var x,w,v,u,t,s=C.d5H(this.b)
...
return d.j(0)+":"+x},
bsj(d,e,f,g){if(f===B.w2)this.a.push(e)
else this.b.m(0,this.ajf(f,g),e)},
awK(d,e,f){return this.bsj(0,e,f,null)},
Yn(d,e){return d===B.w2?D.b.gP(this.a):this.b.i(0,this.ajf(d,e))},
byH(d){return this.Yn(d,null)}}
C.a3g.prototype={
N(){return new C.aMn()}}
C.aMn.prototype={
A(d){var x=this,w=x.a
w=x.e=C.cUU(w.c,1,w.f)
...
this.a.toString
x=u.a
w=new C.a3h(x,u.b,!0,d,v,B.abG,B.abF,u,new C.bpq(A.a([],y.q),A.H(y.N,y.Z)),v,v)
w.z=x
w.b9N()
this.a.toString
return new C.abD(e,D.C,D.mC,A.ir(v,v,!1,v,w,D.V),"qr code",v)},
b0e(d,e,f){var x,w=null,v=this.a
v.toString
x=A.aJ(w,w,D.k,w,w,w,w,w,w,w,w,w,w)
return new C.abD(v.x,D.C,D.mC,x,"qr code",w)}}
C.abD.prototype={
...
k=x.gcX(x)
a1=x.gb4(x)
a3.uR(x,D.J.OS(new A.P(k,a1),new A.a1(0,0,k,a1)),D.J.OS(a0,new A.a1(t,q,t+w,q+s)),g)}},
...
s=d===B.zB?new A.n(v,t):new A.n(t,v)}v=this.as
r=v.Yn(B.a26,d)
r.sfK(j)
r.saG(0,D.q)
q=v.Yn(B.a27,d)
...
C.awI.prototype={
gv(d){return(A.dN(B.aUc)^D.q.gv(0))>>>0},
k(d,e){var x
if(e==null)return!1
if(e instanceof C.awI){x=D.q.k(0,D.q)
return x}return!1}}
C.awH.prototype={
gv(d){return(A.dN(B.aUb)^D.q.gv(0))>>>0},
k(d,e){var x
if(e==null)return!1
if(e instanceof C.awH){x=D.q.k(0,D.q)
return x}return!1}}
C.a3i.prototype={}
C.a3j.prototype={
J(){return"QrValidationStatus."+this.b}}
C.bxm.prototype={
bsx(d){return A.ia(D.HD,new C.bxo(this,null),y.K)},
bsy(d,e){var x={}
x.a=e
return A.ia(d,new C.bxn(x,this),y.n)}}
C.a4v.prototype={
N(){return new C.ayy(null,null)}}
C.ayy.prototype={
Y(){this.aj()
this.d=this.a.d},
A(d){var x=this.d
...
var z=a.updateTypes([])
C.cd8.prototype={
$1(d){var x=this,w=null,v=A.ch(w,w,w,w,w,A.bN(A2.hE,D.q,w,w),w,w,w,new C.cd6(d),w,w,w,w,w),u=y.p,t=A.a([],u),s=x.a,r=x.b
t.push(new A.a6(Af.dz,A.ch(w,w,w,w,w,A.bN(B.al9,A.D(d).ax.a===D.v?$.et():D.q,w,w),w,w,w,new C.cd7(s,r),w,w,w,w,w),w))
return K.eW(M.i4(t,w,w,!0,D.C,w,1,w,w,0,!1,w,!1,w,w,v,w,!0,w,w,w,w,w,w,w,w,w,1,w),D.m,A.c7(new C.a4v(A.aJ(w,A.ax(A.a([G.dp,A.Y("["+x.c+"]",w,w,w,w,w,w,w,B.a4s,w,w,w,w,w),G.dp,new C.a3g(x.d,-1,250,w),G.dp,A.Y("["+r+"]",w,w,w,w,w,w,w,B.a4s,w,w,w,w,w),G.dp],u),D.j,D.bl,D.a1,w,D.p),D.k,D.m,w,w,w,w,w,w,w,w,w),s,w),w,w),w,w,w,w,w)},
$S:966}
C.cd6.prototype={
$0(){As.fD(this.a,!1).f.tY(null)},
$S:0}
C.cd7.prototype={
...
if(e===0)return A_.vQ(!1,o,o,o,!0,o,o,!0,!1,o,o,o,o,!1,o,o,o,o,o,E.bo(A.Y("Companions",o,o,o,o,o,o,o,A.aN(o,o,A.D(d).ax.a===D.v?$.et():D.q,o,o,o,o,o,o,o,o,o,o,o,D.a5,o,o,!0,o,o,o,o,o,o,o,o),o,o,o,o,o),o),o,o)
x=this.a
w=x.d
if(w==null)v=o
else{w=w.ay
...
s=R.aZ3(d,S.J7,A.w("Show Code",o),new C.cde(x,d,v))
q=Aj.cno(v.e,d)
p=y.p
return new A.a6(Aa.e3,A.ax(A.a([A5.hd,A.aJ(o,A3.anq(A.a([B.aYF,new A.cO(B.a92,Ak.cmK(A.c7(E.bo(A.Y("Companion's events will appear here.",o,o,o,o,o,o,o,A.aN(o,o,Ar.DZ(d),o,o,o,o,o,o,o,o,o,o,o,o,o,o,!0,o,o,o,o,o,o,o,o),o,o,o,o,o),o),o,o),q,0.3,o,new C.cdf(x,d),o,o),o),A4.a3O,A.ax(A.a([A.de(!1,E.bo(A.Y("Delete companion",o,o,o,o,o,o,o,o,o,o,o,o,o),o),o,o,o,o,o,o,new C.cdg(x,d,v),o,o)],p),D.j,D.bl,D.h,o,D.p)],p),o,D.j,!1,o,I.of,r,t,s),D.k,o,o,new A.bD(w,o,o,u,o,o,o,D.Q),o,o,o,o,o,o,o)],p),D.j,D.f,D.h,o,D.p),o)},
$S:69}
C.cde.prototype={
$0(){var x=this.c
...
aGZ(d){var x=0,w=A.l(y.P),v=this,u
var $async$$1=A.h(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:u=v.a
x=2
return A.c(F.kp(v.b,"event/"+d,y.X).aQ(0,new C.cdc(u),y.H),$async$$1)
case 2:x=3
...
t.toString
x=5
return A.c(An.ahV(J.u(t,"email")).aQ(0,new C.cdd(u,s),y.P),$async$$0)
...
v===$&&A.b()
if(v.a!==B.C5)return w.b0e(d,e,v.c)
x=w.a.x
w=w.bhs(null,x)
return w},
$S:90}
...
v(A.F,[C.Ee,C.a3g,C.a4v])
v(A.L,[C.aR2,C.aMn,C.aO0])
...
v(A.dh,[C.cdk,C.c3t])
u(C.ahb,A.fw)
v(A.dT,[C.bfH,C.IS,C.NW,C.bsX,C.bsW,C.a3j])
v(A.E,[C.aMm,C.Qs,C.a_I,C.bsY,C.bsV,C.awJ,C.awL,C.bpq,C.c2z,C.awI,C.awH,C.a3i,C.bxm])
u(C.a3f,C.aMm)
u(C.abD,A.a7)
u(C.a3h,A.ni)
u(C.ayy,C.aO0)
x(C.aMm,A.a0)
w(C.aO0,A.es)})()
A.bk(b.typeUniverse,JSON.parse('{"Ee":{"F":[],"d":[]},"aR2":{"L":["Ee"]},"ahb":{"fw":[],"ao":[]},"a3f":{"a0":["x"],"B":["x"],"aO":["x"],"v":["x"],"a0.E":"x","v.E":"x"},"Qs":{"cxG":[]},"a_I":{"b6":[]},"a3g":{"F":[],"d":[]},"aMn":{"L":["a3g"]},"abD":{"a7":[],"d":[]},"a3h":{"ao":[]},"a4v":{"F":[],"d":[]},"ayy":{"L":["a4v"]}}'))
var y=(function rtii(){var x=A.z
return{l:x("dw"),L:x("b6"),I:x("S<ew?>"),x:x("On"),J:x("q<fw>"),S:x("q<B<r>>"),Q:x("q<B<x?>>"),q:x("q<CA>"),v:x("q<cxG>"),y:x("q<awL>"),s:x("q<e>"),p:x("q<d>"),t:x("q<r>"),z:x("aL<L<F>>"),w:x("fo"),P:x("az"),o:x("rd"),Z:x("CA"),A:x("a3R"),N:x("e"),U:x("eh"),E:x("Td<cv>"),B:x("@"),b:x("ew?"),n:x("On?"),T:x("B<r>?"),X:x("E?"),K:x("d_?"),u:x("x?"),H:x("~")}})();(function constants(){var x=a.makeConstList
...
B.zA=new C.NW(0,"topLeft")
B.Ix=new C.NW(1,"topRight")
B.zB=new C.NW(2,"bottomLeft")
B.al9=new A.aE(57857,"MaterialIcons",null,!1)
B.anh=new C.bfH(4,"png")
B.aou=A.a(x([B.zA,B.Ix,B.zB]),A.z("q<NW>"))
...
B.a26=new C.IS(0,"finderPatternOuter")
B.a27=new C.IS(1,"finderPatternInner")
B.a28=new C.IS(2,"finderPatternDot")
B.w2=new C.IS(3,"codePixel")
B.aUa=new C.IS(4,"codePixelEmpty")
B.C5=new C.a3j(0,"valid")
B.aUd=new C.a3j(1,"contentTooLong")
B.aUe=new C.a3j(2,"error")
...
x($,"diU","aUn",()=>C.d2w())})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_361",e:"endPart",h:b})})($__dart_deferred_initializers__,"+vjAA1WAtN/10QR7Usrf18Y1Cg4=");