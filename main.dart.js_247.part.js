...
cKM(d){var x=J.a0(d)
return new B.jf(x.h(d,"x"),x.h(d,"y"),x.h(d,"id"),x.h(d,"group"),x.h(d,"order_product_ticket"),x.h(d,"type"),x.h(d,"state"),x.h(d,"title"),null,x.h(d,"product"),null)},
...
default:return"???"}},
doR(d){return d+";"+B.bBn(d)},
cYA(d,e,f,g,h,i,j,k,l,m,n){return new B.hB(h,d,n,l,m,f,j,k,g,e,i)},
cYB(d){var x=null,w="created_at",v="updated_at",u="data",t=J.a0(d),s=t.h(d,"id"),r=t.h(d,w)!=null?A.ej(t.h(d,w)):x,q=t.h(d,v)!=null?A.ej(t.h(d,v)):x,p=t.h(d,"price")!=null?A.le(J.as(t.h(d,"price"))):x,o=t.h(d,"currency_code"),n=t.h(d,"state"),m=t.h(d,u)!=null?J.v(t.h(d,u),"form"):x,l=t.h(d,u),k=t.h(d,"occasion"),j=t.h(d,"payment_info")
return B.cYA(r,o,l,m,s,t.h(d,"note_hidden"),k,j,p,n,q)},
...
bBo:function bBo(){},
d0b(d,e,f,g,h,i,j,k){return new B.hC(e,d,j,i,f,g)},
d0c(d){var x="created_at",w="updated_at",v=J.a0(d),u=v.h(d,"id"),t=v.h(d,x)!=null?A.ej(v.h(d,x)):null,s=v.h(d,w)!=null?A.ej(v.h(d,w)):null,r=v.h(d,"ticket_symbol"),q=v.h(d,"state"),p=v.h(d,"occasion")
return B.d0b(t,u,v.h(d,"note"),v.h(d,"note_hidden"),p,q,r,s)},
...
bR8:function bR8(){},
cVq(d){var x,w,v,u,t,s,r,q=y.w,p=A.H(q,y.q)
...
q.toString
r=new A.J(q,new B.biw(),A.U(q).i("J<1,h>")).bw(0," | ")}else r=""
t.m(0,s,new A.ha(new A.hq(),r))}return t},
biw:function biw(){},
bcb(d){return B.dht(d)},
dht(d){var x=0,w=A.l(y.v),v,u
var $async$bcb=A.f(function(e,f){if(e===1)return A.i(f,w)
while(true)switch(x){case 0:v=y.b
x=2
return A.d($.Cn().d0("delete_order",A.x(["order_id",d.a],y.w,v),v),$async$bcb)
case 2:u=f
v=J.a0(u)
if(!J.p(v.h(u,"code"),200))throw A.o(A.cO("Deleting order failed: "+A.n(v.h(u,"code"))+": "+A.n(v.h(u,"message"))))
return A.j(null,w)}})
return A.k($async$bcb,w)},
bct(d,e){return B.dhB(d,e)},
dhB(d,e){var x=0,w=A.l(y.v),v,u,t
var $async$bct=A.f(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.Cn().d0("update_order_note_hidden",A.x(["order_id",d,"new_note_hidden",e],y.w,v),v),$async$bct)
case 2:if(!u.p(t.v(g,"code"),200))throw A.o(A.cO("Saving of note has failed."))
return A.j(null,w)}})
return A.k($async$bct,w)},
bcL(d,e){return B.dhO(d,e)},
dhO(d,e){var x=0,w=A.l(y.v),v,u,t
var $async$bcL=A.f(function(f,g){if(f===1)return A.i(g,w)
while(true)switch(x){case 0:v=y.b
u=J
t=J
x=2
return A.d($.Ov().d0("update_ticket_note_hidden",A.x(["ticket_id",d,"new_note_hidden",e],y.w,v),v),$async$bcL)
case 2:if(!u.p(t.v(g,"code"),200))throw A.o(A.cO("Saving of note has failed."))
return A.j(null,w)}})
...
bCA(d){var x,w,v,u,t,s,r,q,p,o,n,m=this,l=null,k=m.as
if(k==null)x=l
else{k=k.ax
...
v.toString
w=C.jw(a0,v,w.x,0)}else w=""
w=A.aE(w)
v=i.ay
if((v==null?h:v.f)!=null){u=v.f
u.toString
v=C.jw(a0,u,v.x,0)}else v=""
v=A.aE(v)
u=i.ay
if((u==null?h:u.r)!=null){t=u.r
t.toString
u=C.jw(a0,t,u.x,0)}else u=""
u=A.aE(u)
t=i.ay
s=t==null
r=s?h:t.d
...
o=i.ax
o=A.aE(o!=null?new A.J(o,new B.bBo(),A.U(o).i("J<1,h>")).bw(0," | "):"")
n=A.aE(i.aL7())
m=i.z
m=A.aE(m==null?"":m)
l=A.aE("")
...
j=i.Q
j=j==null?h:j.ax
return A.lo(A.x(["id",d,"order_symbol",f,"price",e,"state",x,"amount",w,"paid",v,"returned",u,"variable_symbol",r,"deadline",t,"created_at",s,"data",q,"email",p,"ticket_products",o,"note",n,"note_hidden",m,"orders_history",l,"transactions",k,"forms",A.aE(j==null?"":j)],y.w,y.d),!1,y.b)},
...
s=A.aE(r?s.a30():"")
r=m.z
r=A.aE(r!=null?new A.J(r,new B.bR8(),A.U(r).i("J<1,h>")).bw(0," | "):"")
p=m.y
if(p!=null){o=p.z
o=o==null?l:o.b
if(o==null)o=""
...
p=A.aE(p)
o=m.x
n=A.x(["id",k,"created_at",x,"ticket_symbol",w,"state",v,"note",u,"note_hidden",t,"order_symbol",q,"data",s,"ticket_products",r,"ticketSpot",p,"price",A.aE(o!=null?C.jw(d,o,l,0):""),"ticketProductsEdit",A.aE("")],y.w,y.d)
k=m.Q.ax
n.H(0,B.cVq(k==null?A.a([],y.E):k))
return A.lo(n,!1,y.b)},
...
gbh(d){return this.a}}
var z=a.updateTypes(["y(nM)","y(hC)","m?(nM)","y(hB)","h(h)"])
B.b50.prototype={
...
x(B,"d5M","doR",4)})();(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.jf,A.I)
w(A.ce,[B.b50,B.b51,B.b52,B.b53,B.b54,B.b55,B.b5_,B.b56,B.b57,B.bBo,B.bR8,B.biw])
w(A.ic,[B.hB,B.hC])})()
A.ca(b.typeUniverse,JSON.parse('{"hB":{"ic":[]},"hC":{"ic":[]}}'))
var y={E:A.E("u<f2>"),q:A.E("C<f2>"),w:A.E("h"),d:A.E("ha"),b:A.E("@"),v:A.E("~")};(function constants(){var x=a.makeConstList
D.mY=A.a(x(["spot","food","others"]),A.E("u<h>"))})();(function lazyInitializers(){var x=a.lazyFinal
x($,"dMu","Ov",()=>$.hU().gmQ(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_247",e:"endPart",h:b})})($__dart_deferred_initializers__,"qg31Iv+iiUVOWkNOK2yW8ewVjIw=");