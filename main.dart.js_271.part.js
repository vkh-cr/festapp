...
x=1
break}u=G.cCG(y.P.a(s.i(r,"ticket")))
if(s.a3(r,"order")&&s.i(r,"order")!=null)u.Q=G.czT(s.i(r,"order"))
if(s.a3(r,"products")&&s.i(r,"products")!=null){t=J.c7(y.j.a(s.i(r,"products")),new B.b4Y(),y.K)
u.z=A.H(t,!0,t.$ti.h("a9.E"))}if(s.a3(r,"spot")&&s.i(r,"spot")!=null)u.y=G.cmW(s.i(r,"spot"))
v=u
x=1
break
...
B.Dy.prototype={
M(){return new B.acY(D.a2K,new X.d_(Z.aU,$.ae()),E.czu(F.Hx,A.a([C.m1],y.k)))}}
B.acY.prototype={
l(){this.x.l()
var x=this.r
x.U$=$.ae()
...
u.toString
u.c=v.c.hr(y.u).f.f[0].a.xR(0,"scanCode")}$.Ao().afG("https://unpkg.com/@zxing/library@0.21.3")
A.eh(v.a.c)
v.Nm()
return A.i(null,w)}})
...
if(r.e==null)return A.bX(new A.a3(F.HZ,H.bc(D.b4T,q),q),q,q)
x=r.f
if(x===D.Cu)w=O.j9
...
x=A.a([A.bX(A.am(v,C.i,C.f,C.h,q,C.l),q,q),L.ar,A.br(w,C.p,q,30),Y.a5],x)
if(r.f===D.Cu)x.push(A.dp(!1,H.bc(D.b4v,q),q,q,q,q,q,q,r.gaXJ(),q,q))
return new A.a3(I.aZ,A.am(x,C.i,C.f,C.h,q,C.l),q)},
A(d){var x=this,w=null,v=x.e==null?R.bG5(d):x.a0Y(x.f),u=A.c1(w,w,w,w,w,w,A.br(N.hL,C.cr,w,w),w,w,w,new B.c80(d),w,w,w,w,w),t=y.p
return M.f2(w,v,A.jn(!0,new A.cr(C.ae,w,C.ac,C.z,A.a([A.am(A.a([new A.a3(I.aZ,A.aw(A.a([u,A.bJ(A.W("",w,w,w,w,w,w,w,A.aB(w,w,C.cr,w,w,w,w,w,w,w,w,20,w,w,C.a3,w,w,!0,w,w,w,w,w,w,w,w),C.b6,w,w,w,w),1,w)],t),C.i,C.f,C.h,0,w),w),x.a8z(),A.bJ(E.czt(x.x,A0.Fy,new B.c81(x)),1,w)],t),C.i,C.f,C.h,w,C.l)],t),w),!0,C.U,!0,!0),w,w,w,w,w)},
vV(d){return this.aLv(d)},
aLv(d){var x=0,w=A.k(y.H),v,u=this,t,s,r
...
E.pU()}else{E.pU()
E.pU()
u.c.ad(y.q).f.agr(P.cBV(null,null,null,null,null,C.z,null,H.bc(A.W("Failed to confirm ticket",null,null,null,null,null,null,null,null,null,null,null,null,null),null),null,Q.HN,null,null,null,null,null,null,null,null,null))}case 1:return A.i(v,w)}})
...
case 3:x=this.c
x.toString
return A.C(x).ax.a===C.u?$.iP():$.qJ()}return K.lj}}
...
while(true)switch(x){case 0:s=E.cyE(d.a)
if(s==null){x=1
break}t=s.z
A.h7().$1(t)
x=3
...
x(B.acY.prototype,"gaXJ","T2",0)})();(function inheritance(){var x=a.inheritMany,w=a.inherit
x(A.bB,[B.b4Y,B.c8_,B.c81])
w(B.Rm,A.e4)
w(B.Dy,A.F)
w(B.acY,A.K)
...
return{k:x("q<jb>"),p:x("q<d>"),j:x("A<@>"),P:x("af<e,@>"),K:x("hr"),u:x("qn"),N:x("e"),q:x("ET"),y:x("x"),z:x("@"),C:x("hi?"),H:x("~")}})();(function constants(){D.Cu=new B.Rm(0,"valid")
...
D.b4T=new A.c0("Point the camera at the attendee's code for an entry verification.",null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_271",e:"endPart",h:b})})($__dart_deferred_initializers__,"jvj/+8rpGoSgA2hjcj1QDIKGGsc=");