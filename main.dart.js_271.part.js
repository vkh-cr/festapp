...
b51(d,e){var x=0,w=A.k(y.C),v,u,t,s,r
var $async$b51=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:s=y.z
x=3
return A.c($.M_().e3("scan_ticket",A.y(["scanned_id",d,"scanned_code",e],y.N,s),s),$async$b51)
case 3:r=g
s=J.a2(r)
if(!J.m(s.i(r,"code"),200)){v=null
x=1
break}u=G.cCN(y.P.a(s.i(r,"ticket")))
if(s.a3(r,"order")&&s.i(r,"order")!=null)u.Q=G.cA_(s.i(r,"order"))
if(s.a3(r,"products")&&s.i(r,"products")!=null){t=J.c7(y.j.a(s.i(r,"products")),new B.b52(),y.K)
u.z=A.H(t,!0,t.$ti.h("a9.E"))}if(s.a3(r,"spot")&&s.i(r,"spot")!=null)u.y=G.cn2(s.i(r,"spot"))
v=u
x=1
break
case 1:return A.i(v,w)}})
return A.j($async$b51,w)},
b56(d,e){var x=0,w=A.k(y.y),v,u,t,s
var $async$b56=A.f(function(f,g){if(f===1)return A.h(g,w)
while(true)switch(x){case 0:u=y.z
t=J
s=J
x=3
return A.c($.M_().e3("update_ticket_to_used",A.y(["ticket_id",d,"scan_code",e],y.N,u),u),$async$b56)
case 3:v=t.m(s.v(g,"code"),200)
x=1
break
case 1:return A.i(v,w)}})
return A.j($async$b56,w)},
b52:function b52(){},
cYQ(d,e){return new B.Dz(e,d)},
...
B.Dz.prototype={
M(){return new B.ad2(D.a2K,new X.d_(Z.aU,$.ae()),E.czB(F.Hx,A.a([C.m1],y.k)))}}
B.ad2.prototype={
l(){this.x.l()
var x=this.r
x.U$=$.ae()
...
return M.f2(w,v,A.jn(!0,new A.cr(C.ae,w,C.ac,C.z,A.a([A.am(A.a([new A.a3(I.aZ,A.aw(A.a([u,A.bJ(A.W("",w,w,w,w,w,w,w,A.aB(w,w,C.cr,w,w,w,w,w,w,w,w,20,w,w,C.a3,w,w,!0,w,w,w,w,w,w,w,w),C.b6,w,w,w,w),1,w)],t),C.i,C.f,C.h,0,w),w),x.a8B(),A.bJ(E.czA(x.x,A0.Fy,new B.c81(x)),1,w)],t),C.i,C.f,C.h,w,C.l)],t),w),!0,C.U,!0,!0),w,w,w,w,w)},
...
t.toString
x=3
return A.c(B.b56(s,t),$async$T4)
case 3:if(e){u.B(new B.c7Z(u))
E.pU()}else{E.pU()
E.pU()
u.c.ad(y.q).f.agt(P.cC1(null,null,null,null,null,C.z,null,H.bc(A.W("Failed to confirm ticket",null,null,null,null,null,null,null,null,null,null,null,null,null),null),null,Q.HN,null,null,null,null,null,null,null,null,null))}case 1:return A.i(v,w)}})
...
while(true)switch(x){case 0:s=E.cyK(d.a)
if(s==null){x=1
break}t=s.z
A.h7().$1(t)
x=3
...
return{k:x("q<jb>"),p:x("q<d>"),j:x("A<@>"),P:x("af<e,@>"),K:x("hr"),u:x("qn"),N:x("e"),q:x("EU"),y:x("x"),z:x("@"),C:x("hi?"),H:x("~")}})();(function constants(){D.Cu=new B.Rm(0,"valid")
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_271",e:"endPart",h:b})})($__dart_deferred_initializers__,"HIuZGbX3o0S6Yde5d6A5ZZsuxg4=");